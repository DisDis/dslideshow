...
core.List<api.Image> buildUnnamed6038() {
  var o = <api.Image>[];
  o.add(buildImage());
  o.add(buildImage());
  return o;
...
void checkUnnamed6038(core.List<api.Image> o) {
...
core.List<api.FeatureDescription> buildUnnamed6040() {
...
void checkUnnamed6040(core.List<api.FeatureDescription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ProductDetail> buildUnnamed6043() {
...
void checkUnnamed6043(core.List<api.ProductDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Attributes buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.additionalImageLink = buildUnnamed6038();
    o.ageGroup = 'foo';
    o.brand = 'foo';
    ...
    o.excludedDestination = buildUnnamed6039();
    o.featureDescription = buildUnnamed6040();
    o.flavor = 'foo';
    o.format = 'foo';
    o.gender = 'foo';
    o.gtin = buildUnnamed6041();
    o.imageLink = buildImage();
    o.includedDestination = buildUnnamed6042();
    o.itemGroupId = 'foo';
    o.material = 'foo';
    o.mpn = 'foo';
    o.pattern = 'foo';
    o.productDetail = buildUnnamed6043();
    o.productHighlight = buildUnnamed6044();
    o.productLine = 'foo';
    o.productName = 'foo';
    o.productPageUrl = 'foo';
    o.productType = buildUnnamed6045();
    o.releaseDate = 'foo';
    o.richProductContent = buildUnnamed6046();
    o.scent = 'foo';
    o.size = 'foo';
    o.sizeSystem = 'foo';
    o.sizeType = 'foo';
...
void checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed6038(o.additionalImageLink!);
    unittest.expect(
      o.ageGroup!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed6039(o.excludedDestination!);
    checkUnnamed6040(o.featureDescription!);
    unittest.expect(
      o.flavor!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed6041(o.gtin!);
    checkImage(o.imageLink! as api.Image);
    checkUnnamed6042(o.includedDestination!);
    unittest.expect(
      o.itemGroupId!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed6043(o.productDetail!);
    checkUnnamed6044(o.productHighlight!);
    unittest.expect(
      o.productLine!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed6045(o.productType!);
    unittest.expect(
      o.releaseDate!,
      unittest.equals('foo'),
    );
    checkUnnamed6046(o.richProductContent!);
    unittest.expect(
      o.scent!,
      unittest.equals('foo'),
    );
...
core.List<api.Product> buildUnnamed6048() {
  var o = <api.Product>[];
  o.add(buildProduct());
  o.add(buildProduct());
  return o;
...
void checkUnnamed6048(core.List<api.Product> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DestinationStatus> buildUnnamed6049() {
  var o = <api.DestinationStatus>[];
...
void checkUnnamed6050(core.List<api.Issue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Product buildProduct() {
  ...
  if (buildCounterProduct < 3) {
    ...
    o.destinationStatuses = buildUnnamed6049();
    o.issues = buildUnnamed6050();
    o.name = 'foo';
    o.parent = 'foo';
    o.productId = 'foo';
    o.targetCountry = 'foo';
...
void checkProduct(api.Product o) {
  ...
  if (buildCounterProduct < 3) {
    ...
    checkUnnamed6049(o.destinationStatuses!);
    checkUnnamed6050(o.issues!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('resource-AccountsProductsResource', () {
    ...
    unittest.test('method--get', () async {
      ...
      var arg_parent = 'foo';
      var arg_name = 'foo';
      var arg_include = buildUnnamed6051();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.ManufacturerCenterApi(mock).accounts.products;
      var arg_parent = 'foo';
      var arg_include = buildUnnamed6052();
      var arg_pageSize = 42;
