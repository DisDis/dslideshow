...
checkUnnamed4060(core.List<api.Statement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatement(o[0]);
  checkStatement(o[1]);
}
...
buildListResponse() {
  ...
  if (buildCounterListResponse < 3) {
    o.debugString = "foo";
    o.errorCode = buildUnnamed4059();
    o.maxAge = "foo";
    o.statements = buildUnnamed4060();
  }
  buildCounterListResponse--;
  return o;
}
...
checkListResponse(api.ListResponse o) {
  ...
  if (buildCounterListResponse < 3) {
    unittest.expect(o.debugString, unittest.equals('foo'));
    checkUnnamed4059(o.errorCode);
    unittest.expect(o.maxAge, unittest.equals('foo'));
    checkUnnamed4060(o.statements);
  }
  buildCounterListResponse--;
}
