...
core.List<api.Statement> buildUnnamed5202() {
  var o = <api.Statement>[];
...
void checkUnnamed5202(core.List<api.Statement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListResponse buildListResponse() {
  ...
  if (buildCounterListResponse < 3) {
    o.debugString = 'foo';
    o.errorCode = buildUnnamed5201();
    o.maxAge = 'foo';
    o.statements = buildUnnamed5202();
  }
  buildCounterListResponse--;
  return o;
}
...
void checkListResponse(api.ListResponse o) {
  ...
  if (buildCounterListResponse < 3) {
    ...
    checkUnnamed5201(o.errorCode!);
    unittest.expect(
      o.maxAge!,
      unittest.equals('foo'),
    );
    checkUnnamed5202(o.statements!);
  }
  buildCounterListResponse--;
}
