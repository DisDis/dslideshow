...
core.List<api.Account> buildUnnamed4832() {
  var o = <api.Account>[];
  o.add(buildAccount());
  o.add(buildAccount());
  return o;
...
void checkUnnamed4832(core.List<api.Account> o) {
...
api.Account buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    ...
    o.name = 'foo';
    o.premium = true;
    o.subAccounts = buildUnnamed4832();
    o.timezone = 'foo';
  }
  buildCounterAccount--;
  return o;
...
void checkAccount(api.Account o) {
  ...
  if (buildCounterAccount < 3) {
    ...
    checkUnnamed4832(o.subAccounts!);
    unittest.expect(
      o.timezone!,
      unittest.equals('foo'),
    );
...
core.List<api.Account> buildUnnamed4833() {
  var o = <api.Account>[];
  o.add(buildAccount());
  o.add(buildAccount());
  return o;
...
void checkUnnamed4833(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0] as api.Account);
  checkAccount(o[1] as api.Account);
}
...
core.List<api.AdClient> buildUnnamed4834() {
  var o = <api.AdClient>[];
  o.add(buildAdClient());
  o.add(buildAdClient());
  return o;
...
void checkUnnamed4834(core.List<api.AdClient> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AdUnit> buildUnnamed4835() {
  var o = <api.AdUnit>[];
  o.add(buildAdUnit());
  o.add(buildAdUnit());
  return o;
...
void checkUnnamed4835(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AdsenseReportsGenerateResponseHeaders> buildUnnamed4837() {
  var o = <api.AdsenseReportsGenerateResponseHeaders>[];
...
void checkUnnamed4837(core.List<api.AdsenseReportsGenerateResponseHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.List<core.String>> buildUnnamed4839() {
  var o = <core.List<core.String>>[];
  o.add(buildUnnamed4838());
  o.add(buildUnnamed4838());
  return o;
}

void checkUnnamed4839(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4838(o[0]);
  checkUnnamed4838(o[1]);
}
...
api.AdsenseReportsGenerateResponse buildAdsenseReportsGenerateResponse() {
  ...
  if (buildCounterAdsenseReportsGenerateResponse < 3) {
    o.averages = buildUnnamed4836();
    o.endDate = 'foo';
    o.headers = buildUnnamed4837();
    o.kind = 'foo';
    o.rows = buildUnnamed4839();
    o.startDate = 'foo';
    o.totalMatchedRows = 'foo';
    o.totals = buildUnnamed4840();
    o.warnings = buildUnnamed4841();
  }
  buildCounterAdsenseReportsGenerateResponse--;
  return o;
}
...
void checkAdsenseReportsGenerateResponse(api.AdsenseReportsGenerateResponse o) {
  buildCounterAdsenseReportsGenerateResponse++;
  if (buildCounterAdsenseReportsGenerateResponse < 3) {
    checkUnnamed4836(o.averages!);
    unittest.expect(
      o.endDate!,
      unittest.equals('foo'),
    );
    checkUnnamed4837(o.headers!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed4839(o.rows!);
    unittest.expect(
      o.startDate!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed4840(o.totals!);
    checkUnnamed4841(o.warnings!);
  }
  buildCounterAdsenseReportsGenerateResponse--;
}
...
core.List<api.Alert> buildUnnamed4842() {
  var o = <api.Alert>[];
  o.add(buildAlert());
  o.add(buildAlert());
  return o;
...
void checkUnnamed4842(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CustomChannel> buildUnnamed4843() {
  var o = <api.CustomChannel>[];
...
void checkUnnamed4843(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ReportingMetadataEntry> buildUnnamed4844() {
...
void checkUnnamed4844(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Payment> buildUnnamed4845() {
  var o = <api.Payment>[];
  o.add(buildPayment());
  o.add(buildPayment());
  return o;
...
void checkUnnamed4845(core.List<api.Payment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ReportingMetadataEntry buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed4846();
    o.compatibleMetrics = buildUnnamed4847();
    o.id = 'foo';
    o.kind = 'foo';
    o.requiredDimensions = buildUnnamed4848();
    o.requiredMetrics = buildUnnamed4849();
    o.supportedProducts = buildUnnamed4850();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
void checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed4846(o.compatibleDimensions!);
    checkUnnamed4847(o.compatibleMetrics!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed4848(o.requiredDimensions!);
    checkUnnamed4849(o.requiredMetrics!);
    checkUnnamed4850(o.supportedProducts!);
  }
  buildCounterReportingMetadataEntry--;
}
...
core.List<api.SavedAdStyle> buildUnnamed4851() {
  var o = <api.SavedAdStyle>[];
...
void checkUnnamed4851(core.List<api.SavedAdStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SavedReport> buildUnnamed4852() {
  var o = <api.SavedReport>[];
...
void checkUnnamed4852(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.UrlChannel> buildUnnamed4853() {
  var o = <api.UrlChannel>[];
...
void checkUnnamed4853(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('resource-AccountsReportsResource', () {
    unittest.test('method--generate', () async {
      ...
      var arg_dimension = buildUnnamed4854();
      var arg_filter = buildUnnamed4855();
      var arg_locale = 'foo';
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed4856();
      var arg_sort = buildUnnamed4857();
  ...
  unittest.group('resource-ReportsResource', () {
    unittest.test('method--generate', () async {
      ...
      var arg_startDate = 'foo';
      var arg_endDate = 'foo';
      var arg_accountId = buildUnnamed4858();
      var arg_currency = 'foo';
      var arg_dimension = buildUnnamed4859();
      var arg_filter = buildUnnamed4860();
      var arg_locale = 'foo';
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed4861();
      var arg_sort = buildUnnamed4862();
      var arg_startIndex = 42;
      var arg_useTimezoneReporting = true;
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
