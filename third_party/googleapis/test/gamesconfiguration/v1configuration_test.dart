...
core.List<api.AchievementConfiguration> buildUnnamed737() {
  var o = <api.AchievementConfiguration>[];
...
void checkUnnamed737(core.List<api.AchievementConfiguration> o) {
...
core.List<api.LeaderboardConfiguration> buildUnnamed738() {
  var o = <api.LeaderboardConfiguration>[];
...
void checkUnnamed738(core.List<api.LeaderboardConfiguration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LocalizedString> buildUnnamed739() {
  var o = <api.LocalizedString>[];
...
void checkUnnamed739(core.List<api.LocalizedString> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LocalizedStringBundle buildLocalizedStringBundle() {
  ...
  if (buildCounterLocalizedStringBundle < 3) {
    o.kind = 'foo';
    o.translations = buildUnnamed739();
  }
  buildCounterLocalizedStringBundle--;
  return o;
}
...
void checkLocalizedStringBundle(api.LocalizedStringBundle o) {
  ...
  if (buildCounterLocalizedStringBundle < 3) {
    ...
    checkUnnamed739(o.translations!);
  }
  buildCounterLocalizedStringBundle--;
}
