...
checkUnnamed1017(core.List<api.AccountBidderLocation> o) {
...
buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    o.bidderLocation = buildUnnamed1017();
...
checkAccount(api.Account o) {
  buildCounterAccount++;
  if (buildCounterAccount < 3) {
    checkUnnamed1017(o.bidderLocation);
...
checkUnnamed1018(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0]);
  checkAccount(o[1]);
}
...
checkUnnamed1020(core.List<api.BillingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1025(core.List<api.CreativeCorrections> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1027(core.List<api.CreativeDisapprovalReasons> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1028(core.List<api.CreativeFilteringReasonsReasons> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCreativeNativeAd() {
  ...
  if (buildCounterCreativeNativeAd < 3) {
    ...
    o.impressionTrackingUrl = buildUnnamed1030();
...
checkCreativeNativeAd(api.CreativeNativeAd o) {
  ...
  if (buildCounterCreativeNativeAd < 3) {
    ...
    checkUnnamed1030(o.impressionTrackingUrl);
...
checkUnnamed1031(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
checkUnnamed1032(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
buildCreative() {
  ...
  if (buildCounterCreative < 3) {
    o.HTMLSnippet = "foo";
    o.accountId = 42;
    o.advertiserId = buildUnnamed1021();
    o.advertiserName = "foo";
    o.agencyId = "foo";
    o.apiUploadTimestamp = core.DateTime.parse("2002-02-27T14:01:02");
    o.attribute = buildUnnamed1022();
    o.buyerCreativeId = "foo";
    o.clickThroughUrl = buildUnnamed1023();
    o.corrections = buildUnnamed1025();
    o.disapprovalReasons = buildUnnamed1027();
    o.filteringReasons = buildCreativeFilteringReasons();
    o.height = 42;
    o.impressionTrackingUrl = buildUnnamed1029();
    o.kind = "foo";
    o.nativeAd = buildCreativeNativeAd();
    o.productCategories = buildUnnamed1031();
    o.restrictedCategories = buildUnnamed1032();
    o.sensitiveCategories = buildUnnamed1033();
    o.status = "foo";
    o.vendorType = buildUnnamed1034();
    o.version = 42;
    o.videoURL = "foo";
    o.width = 42;
  }
...
checkCreative(api.Creative o) {
  ...
  if (buildCounterCreative < 3) {
    ...
    unittest.expect(o.accountId, unittest.equals(42));
    checkUnnamed1021(o.advertiserId);
    unittest.expect(o.advertiserName, unittest.equals('foo'));
    unittest.expect(o.agencyId, unittest.equals('foo'));
    unittest.expect(o.apiUploadTimestamp,
        unittest.equals(core.DateTime.parse("2002-02-27T14:01:02")));
    checkUnnamed1022(o.attribute);
    unittest.expect(o.buyerCreativeId, unittest.equals('foo'));
    checkUnnamed1023(o.clickThroughUrl);
    checkUnnamed1025(o.corrections);
    checkUnnamed1027(o.disapprovalReasons);
    checkCreativeFilteringReasons(o.filteringReasons);
    unittest.expect(o.height, unittest.equals(42));
    checkUnnamed1029(o.impressionTrackingUrl);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkCreativeNativeAd(o.nativeAd);
    checkUnnamed1031(o.productCategories);
    checkUnnamed1032(o.restrictedCategories);
    checkUnnamed1033(o.sensitiveCategories);
    unittest.expect(o.status, unittest.equals('foo'));
    checkUnnamed1034(o.vendorType);
...
checkUnnamed1035(core.List<api.Creative> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCreative(o[0]);
  checkCreative(o[1]);
}
...
checkUnnamed1036(core.List<api.DirectDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDirectDeal(o[0]);
  checkDirectDeal(o[1]);
}
...
buildDirectDealsList() {
  ...
  if (buildCounterDirectDealsList < 3) {
    o.directDeals = buildUnnamed1036();
    o.kind = "foo";
  }
  buildCounterDirectDealsList--;
  return o;
...
checkDirectDealsList(api.DirectDealsList o) {
  buildCounterDirectDealsList++;
  if (buildCounterDirectDealsList < 3) {
    checkUnnamed1036(o.directDeals);
    unittest.expect(o.kind, unittest.equals('foo'));
  }
  buildCounterDirectDealsList--;
}
...
checkUnnamed1037(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPerformanceReport() {
  ...
  if (buildCounterPerformanceReport < 3) {
    ...
    o.calloutStatusRate = buildUnnamed1037();
    o.cookieMatcherStatusRate = buildUnnamed1038();
    o.creativeStatusRate = buildUnnamed1039();
    o.filteredBidRate = 42.0;
    o.hostedMatchStatusRate = buildUnnamed1040();
...
checkPerformanceReport(api.PerformanceReport o) {
  ...
  if (buildCounterPerformanceReport < 3) {
    ...
    checkUnnamed1037(o.calloutStatusRate);
    checkUnnamed1038(o.cookieMatcherStatusRate);
    checkUnnamed1039(o.creativeStatusRate);
    unittest.expect(o.filteredBidRate, unittest.equals(42.0));
    checkUnnamed1040(o.hostedMatchStatusRate);
...
checkUnnamed1041(core.List<api.PerformanceReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPerformanceReportList() {
  ...
  if (buildCounterPerformanceReportList < 3) {
    o.kind = "foo";
    o.performanceReport = buildUnnamed1041();
  }
  buildCounterPerformanceReportList--;
  return o;
}
...
checkPerformanceReportList(api.PerformanceReportList o) {
  ...
  if (buildCounterPerformanceReportList < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1041(o.performanceReport);
  }
  buildCounterPerformanceReportList--;
}
...
checkUnnamed1043(core.List<api.PretargetingConfigDimensions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1046(core.List<api.PretargetingConfigExcludedPlacements> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1054(core.List<api.PretargetingConfigPlacements> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPretargetingConfig() {
  ...
  if (buildCounterPretargetingConfig < 3) {
    ...
    o.configId = "foo";
    o.configName = "foo";
    o.creativeType = buildUnnamed1042();
    o.dimensions = buildUnnamed1043();
    o.excludedContentLabels = buildUnnamed1044();
    o.excludedGeoCriteriaIds = buildUnnamed1045();
    o.excludedPlacements = buildUnnamed1046();
    o.excludedUserLists = buildUnnamed1047();
    o.excludedVerticals = buildUnnamed1048();
    o.geoCriteriaIds = buildUnnamed1049();
    o.isActive = true;
    o.kind = "foo";
    o.languages = buildUnnamed1050();
    o.mobileCarriers = buildUnnamed1051();
    o.mobileDevices = buildUnnamed1052();
    o.mobileOperatingSystemVersions = buildUnnamed1053();
    o.placements = buildUnnamed1054();
    o.platforms = buildUnnamed1055();
    o.supportedCreativeAttributes = buildUnnamed1056();
    o.userLists = buildUnnamed1057();
    o.vendorTypes = buildUnnamed1058();
    o.verticals = buildUnnamed1059();
  }
  buildCounterPretargetingConfig--;
  return o;
}
...
checkPretargetingConfig(api.PretargetingConfig o) {
  ...
  if (buildCounterPretargetingConfig < 3) {
    ...
    checkUnnamed1042(o.creativeType);
    checkUnnamed1043(o.dimensions);
    checkUnnamed1044(o.excludedContentLabels);
    checkUnnamed1045(o.excludedGeoCriteriaIds);
    checkUnnamed1046(o.excludedPlacements);
    checkUnnamed1047(o.excludedUserLists);
    checkUnnamed1048(o.excludedVerticals);
    checkUnnamed1049(o.geoCriteriaIds);
    unittest.expect(o.isActive, unittest.isTrue);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1050(o.languages);
    checkUnnamed1051(o.mobileCarriers);
    checkUnnamed1052(o.mobileDevices);
    checkUnnamed1053(o.mobileOperatingSystemVersions);
    checkUnnamed1054(o.placements);
    checkUnnamed1055(o.platforms);
    checkUnnamed1056(o.supportedCreativeAttributes);
    checkUnnamed1057(o.userLists);
    checkUnnamed1058(o.vendorTypes);
    checkUnnamed1059(o.verticals);
  }
  buildCounterPretargetingConfig--;
}
...
checkUnnamed1060(core.List<api.PretargetingConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1061(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
main() {
  ...
  unittest.group("resource-CreativesResourceApi", () {
    ...
    unittest.test("method--list", () {
      var mock = new HttpServerMock();
      api.CreativesResourceApi res = new api.AdexchangebuyerApi(mock).creatives;
      var arg_accountId = buildUnnamed1061();
      var arg_buyerCreativeId = buildUnnamed1062();
