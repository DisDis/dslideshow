...
core.List<api.AccountBidderLocation> buildUnnamed901() {
  var o = <api.AccountBidderLocation>[];
...
void checkUnnamed901(core.List<api.AccountBidderLocation> o) {
...
api.Account buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    o.bidderLocation = buildUnnamed901();
...
void checkAccount(api.Account o) {
  buildCounterAccount++;
  if (buildCounterAccount < 3) {
    checkUnnamed901(o.bidderLocation!);
    unittest.expect(
      o.cookieMatchingNid!,
      unittest.equals('foo'),
    );
...
core.List<api.Account> buildUnnamed902() {
  var o = <api.Account>[];
  o.add(buildAccount());
  o.add(buildAccount());
  return o;
...
void checkUnnamed902(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkUnnamed903(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.BillingInfo> buildUnnamed904() {
  var o = <api.BillingInfo>[];
...
void checkUnnamed904(core.List<api.BillingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed905() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed905(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.CreativeAdTechnologyProviders buildCreativeAdTechnologyProviders() {
  ...
  if (buildCounterCreativeAdTechnologyProviders < 3) {
    o.detectedProviderIds = buildUnnamed905();
...
void checkCreativeAdTechnologyProviders(api.CreativeAdTechnologyProviders o) {
  buildCounterCreativeAdTechnologyProviders++;
  if (buildCounterCreativeAdTechnologyProviders < 3) {
    checkUnnamed905(o.detectedProviderIds!);
    unittest.expect(o.hasUnidentifiedProvider!, unittest.isTrue);
  }
  buildCounterCreativeAdTechnologyProviders--;
}

core.List<core.String> buildUnnamed906() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed906(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.int> buildUnnamed907() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed907(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.String> buildUnnamed908() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed908(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.CreativeCorrections> buildUnnamed910() {
  var o = <api.CreativeCorrections>[];
...
void checkUnnamed910(core.List<api.CreativeCorrections> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CreativeDisapprovalReasons> buildUnnamed912() {
  var o = <api.CreativeDisapprovalReasons>[];
...
void checkUnnamed912(core.List<api.CreativeDisapprovalReasons> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CreativeFilteringReasonsReasons> buildUnnamed913() {
  var o = <api.CreativeFilteringReasonsReasons>[];
...
void checkUnnamed913(core.List<api.CreativeFilteringReasonsReasons> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CreativeNativeAd buildCreativeNativeAd() {
  ...
  if (buildCounterCreativeNativeAd < 3) {
    ...
    o.impressionTrackingUrl = buildUnnamed915();
...
void checkCreativeNativeAd(api.CreativeNativeAd o) {
  ...
  if (buildCounterCreativeNativeAd < 3) {
    ...
    checkUnnamed915(o.impressionTrackingUrl!);
...
core.List<core.int> buildUnnamed916() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed916(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.int> buildUnnamed917() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed917(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.int> buildUnnamed918() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed918(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.int> buildUnnamed919() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed919(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.Creative buildCreative() {
  ...
  if (buildCounterCreative < 3) {
    ...
    o.advertiserId = buildUnnamed906();
    o.advertiserName = 'foo';
    o.agencyId = 'foo';
    o.apiUploadTimestamp = core.DateTime.parse("2002-02-27T14:01:02");
    o.attribute = buildUnnamed907();
    o.buyerCreativeId = 'foo';
    o.clickThroughUrl = buildUnnamed908();
    o.corrections = buildUnnamed910();
    o.disapprovalReasons = buildUnnamed912();
    o.filteringReasons = buildCreativeFilteringReasons();
    o.height = 42;
    o.impressionTrackingUrl = buildUnnamed914();
    o.kind = 'foo';
    o.nativeAd = buildCreativeNativeAd();
    o.productCategories = buildUnnamed916();
    o.restrictedCategories = buildUnnamed917();
    o.sensitiveCategories = buildUnnamed918();
    o.status = 'foo';
    o.vendorType = buildUnnamed919();
    o.version = 42;
    o.videoURL = 'foo';
    o.width = 42;
  }
...
void checkCreative(api.Creative o) {
  ...
  if (buildCounterCreative < 3) {
    ...
    checkUnnamed906(o.advertiserId!);
    unittest.expect(
      o.advertiserName!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed907(o.attribute!);
    unittest.expect(
      o.buyerCreativeId!,
      unittest.equals('foo'),
    );
    checkUnnamed908(o.clickThroughUrl!);
    checkUnnamed910(o.corrections!);
    checkUnnamed912(o.disapprovalReasons!);
    ...
    checkUnnamed914(o.impressionTrackingUrl!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkCreativeNativeAd(o.nativeAd! as api.CreativeNativeAd);
    checkUnnamed916(o.productCategories!);
    checkUnnamed917(o.restrictedCategories!);
    checkUnnamed918(o.sensitiveCategories!);
    unittest.expect(
      o.status!,
      unittest.equals('foo'),
    );
    checkUnnamed919(o.vendorType!);
    unittest.expect(
      o.version!,
      unittest.equals(42),
    );
...
core.List<api.Creative> buildUnnamed920() {
  var o = <api.Creative>[];
  o.add(buildCreative());
  o.add(buildCreative());
  return o;
...
void checkUnnamed920(core.List<api.Creative> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DirectDeal> buildUnnamed921() {
  var o = <api.DirectDeal>[];
...
void checkUnnamed921(core.List<api.DirectDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Object> buildUnnamed922() {
  var o = <core.Object>[];
  o.add({
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed922(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Object> buildUnnamed923() {
  var o = <core.Object>[];
  o.add({
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed923(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Object> buildUnnamed924() {
  var o = <core.Object>[];
  o.add({
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed924(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Object> buildUnnamed925() {
  var o = <core.Object>[];
  o.add({
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed925(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PerformanceReport buildPerformanceReport() {
  ...
  if (buildCounterPerformanceReport < 3) {
    ...
    o.calloutStatusRate = buildUnnamed922();
    o.cookieMatcherStatusRate = buildUnnamed923();
    o.creativeStatusRate = buildUnnamed924();
    o.filteredBidRate = 42.0;
    o.hostedMatchStatusRate = buildUnnamed925();
...
void checkPerformanceReport(api.PerformanceReport o) {
  ...
  if (buildCounterPerformanceReport < 3) {
    ...
    checkUnnamed922(o.calloutStatusRate!);
    checkUnnamed923(o.cookieMatcherStatusRate!);
    checkUnnamed924(o.creativeStatusRate!);
    unittest.expect(
      o.filteredBidRate!,
      unittest.equals(42.0),
    );
    checkUnnamed925(o.hostedMatchStatusRate!);
    unittest.expect(
...
core.List<api.PerformanceReport> buildUnnamed926() {
  var o = <api.PerformanceReport>[];
...
void checkUnnamed926(core.List<api.PerformanceReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PerformanceReportList buildPerformanceReportList() {
  ...
  if (buildCounterPerformanceReportList < 3) {
    o.kind = 'foo';
    o.performanceReport = buildUnnamed926();
  }
  buildCounterPerformanceReportList--;
  return o;
}
...
void checkPerformanceReportList(api.PerformanceReportList o) {
  ...
  if (buildCounterPerformanceReportList < 3) {
    ...
    checkUnnamed926(o.performanceReport!);
  }
  buildCounterPerformanceReportList--;
}
...
void checkUnnamed927(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.PretargetingConfigDimensions> buildUnnamed928() {
  var o = <api.PretargetingConfigDimensions>[];
...
void checkUnnamed928(core.List<api.PretargetingConfigDimensions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed930() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed930(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.PretargetingConfigExcludedPlacements> buildUnnamed931() {
  var o = <api.PretargetingConfigExcludedPlacements>[];
...
void checkUnnamed931(core.List<api.PretargetingConfigExcludedPlacements> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed933() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed933(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed934() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed934(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed936() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed936(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed937() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed937(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed938() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed938(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.PretargetingConfigPlacements> buildUnnamed939() {
  var o = <api.PretargetingConfigPlacements>[];
...
void checkUnnamed939(core.List<api.PretargetingConfigPlacements> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed940() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed940(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed941() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed941(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed942() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed942(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed943() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed943(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed944() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed944(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.PretargetingConfig buildPretargetingConfig() {
  ...
  if (buildCounterPretargetingConfig < 3) {
    ...
    o.configId = 'foo';
    o.configName = 'foo';
    o.creativeType = buildUnnamed927();
    o.dimensions = buildUnnamed928();
    o.excludedContentLabels = buildUnnamed929();
    o.excludedGeoCriteriaIds = buildUnnamed930();
    o.excludedPlacements = buildUnnamed931();
    o.excludedUserLists = buildUnnamed932();
    o.excludedVerticals = buildUnnamed933();
    o.geoCriteriaIds = buildUnnamed934();
    o.isActive = true;
    o.kind = 'foo';
    o.languages = buildUnnamed935();
    o.maximumQps = 'foo';
    o.mobileCarriers = buildUnnamed936();
    o.mobileDevices = buildUnnamed937();
    o.mobileOperatingSystemVersions = buildUnnamed938();
    o.placements = buildUnnamed939();
    o.platforms = buildUnnamed940();
    o.supportedCreativeAttributes = buildUnnamed941();
    o.userLists = buildUnnamed942();
    o.vendorTypes = buildUnnamed943();
    o.verticals = buildUnnamed944();
  }
  buildCounterPretargetingConfig--;
  return o;
}
...
void checkPretargetingConfig(api.PretargetingConfig o) {
  ...
  if (buildCounterPretargetingConfig < 3) {
    ...
    checkUnnamed927(o.creativeType!);
    checkUnnamed928(o.dimensions!);
    checkUnnamed929(o.excludedContentLabels!);
    checkUnnamed930(o.excludedGeoCriteriaIds!);
    checkUnnamed931(o.excludedPlacements!);
    checkUnnamed932(o.excludedUserLists!);
    checkUnnamed933(o.excludedVerticals!);
    checkUnnamed934(o.geoCriteriaIds!);
    unittest.expect(o.isActive!, unittest.isTrue);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed935(o.languages!);
    unittest.expect(
      o.maximumQps!,
      unittest.equals('foo'),
    );
    checkUnnamed936(o.mobileCarriers!);
    checkUnnamed937(o.mobileDevices!);
    checkUnnamed938(o.mobileOperatingSystemVersions!);
    checkUnnamed939(o.placements!);
    checkUnnamed940(o.platforms!);
    checkUnnamed941(o.supportedCreativeAttributes!);
    checkUnnamed942(o.userLists!);
    checkUnnamed943(o.vendorTypes!);
    checkUnnamed944(o.verticals!);
  }
  buildCounterPretargetingConfig--;
}

core.List<api.PretargetingConfig> buildUnnamed945() {
  var o = <api.PretargetingConfig>[];
...
void checkUnnamed945(core.List<api.PretargetingConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.int> buildUnnamed946() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed946(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.String> buildUnnamed947() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed947(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
void main() {
  ...
  unittest.group('resource-CreativesResource', () {
    ...
    unittest.test('method--list', () async {
      var mock = HttpServerMock();
      var res = api.AdExchangeBuyerApi(mock).creatives;
      var arg_accountId = buildUnnamed946();
      var arg_buyerCreativeId = buildUnnamed947();
