...
checkUnnamed2217(core.List<api.GroupItem> o) {
...
checkUnnamed2218(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
checkUnnamed2219(core.List<api.ResultTableColumnHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildResultTable() {
  ...
  if (buildCounterResultTable < 3) {
    o.columnHeaders = buildUnnamed2219();
    o.kind = "foo";
    o.rows = buildUnnamed2221();
  }
  buildCounterResultTable--;
  return o;
}
...
checkResultTable(api.ResultTable o) {
  buildCounterResultTable++;
  if (buildCounterResultTable < 3) {
    checkUnnamed2219(o.columnHeaders);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed2221(o.rows);
  }
  buildCounterResultTable--;
}
