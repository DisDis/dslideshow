...
core.List<api.Bin> buildUnnamed6877() {
  var o = <api.Bin>[];
  o.add(buildBin());
  o.add(buildBin());
  return o;
...
void checkUnnamed6877(core.List<api.Bin> o) {
...
core.Map<core.String, api.Metric> buildUnnamed6879() {
...
void checkUnnamed6879(core.Map<core.String, api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
