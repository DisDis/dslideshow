...
core.Map<core.String, api.AttributeValue> buildUnnamed2335() {
...
void checkUnnamed2335(core.Map<core.String, api.AttributeValue> o) {
...
api.Attributes buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.attributeMap = buildUnnamed2335();
...
void checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed2335(o.attributeMap!);
    unittest.expect(
...
core.List<api.Span> buildUnnamed2336() {
  var o = <api.Span>[];
  o.add(buildSpan());
  o.add(buildSpan());
  return o;
...
void checkUnnamed2336(core.List<api.Span> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Link> buildUnnamed2337() {
  var o = <api.Link>[];
  o.add(buildLink());
  o.add(buildLink());
  return o;
...
void checkUnnamed2337(core.List<api.Link> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.StackFrame> buildUnnamed2338() {
  var o = <api.StackFrame>[];
...
void checkUnnamed2338(core.List<api.StackFrame> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed2339() {
...
void checkUnnamed2339(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed2340() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed2339());
  o.add(buildUnnamed2339());
  return o;
}

void checkUnnamed2340(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2339(o[0]);
  checkUnnamed2339(o[1]);
}
...
core.List<api.TimeEvent> buildUnnamed2341() {
  var o = <api.TimeEvent>[];
...
void checkUnnamed2341(core.List<api.TimeEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
