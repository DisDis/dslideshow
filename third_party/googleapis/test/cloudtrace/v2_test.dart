...
checkUnnamed3156(core.Map<core.String, api.AttributeValue> o) {
...
buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.attributeMap = buildUnnamed3156();
...
checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed3156(o.attributeMap);
...
checkUnnamed3157(core.List<api.Span> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpan(o[0]);
  checkSpan(o[1]);
}
...
checkUnnamed3158(core.List<api.Link> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLink(o[0]);
  checkLink(o[1]);
}
...
checkUnnamed3159(core.List<api.StackFrame> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStackFrame(o[0]);
  checkStackFrame(o[1]);
}
...
checkUnnamed3162(core.List<api.TimeEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeEvent(o[0]);
  checkTimeEvent(o[1]);
}
