...
core.List<api.Method> buildUnnamed981() {
  var o = <api.Method>[];
  o.add(buildMethod());
  o.add(buildMethod());
  return o;
...
void checkUnnamed981(core.List<api.Method> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMethod(o[0] as api.Method);
  checkMethod(o[1] as api.Method);
}

core.List<api.Mixin> buildUnnamed982() {
  var o = <api.Mixin>[];
  o.add(buildMixin());
  o.add(buildMixin());
  return o;
...
void checkUnnamed982(core.List<api.Mixin> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMixin(o[0] as api.Mixin);
  checkMixin(o[1] as api.Mixin);
}

core.List<api.Option> buildUnnamed983() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed983(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Api buildApi() {
  ...
  if (buildCounterApi < 3) {
    o.methods = buildUnnamed981();
    o.mixins = buildUnnamed982();
    o.name = 'foo';
    o.options = buildUnnamed983();
...
void checkApi(api.Api o) {
  buildCounterApi++;
  if (buildCounterApi < 3) {
    checkUnnamed981(o.methods!);
    checkUnnamed982(o.mixins!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed983(o.options!);
...
core.List<api.JwtLocation> buildUnnamed984() {
...
void checkUnnamed984(core.List<api.JwtLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuthProvider buildAuthProvider() {
  ...
  if (buildCounterAuthProvider < 3) {
    ...
    o.issuer = 'foo';
    o.jwksUri = 'foo';
    o.jwtLocations = buildUnnamed984();
  }
  buildCounterAuthProvider--;
  return o;
}
...
void checkAuthProvider(api.AuthProvider o) {
  ...
  if (buildCounterAuthProvider < 3) {
    ...
    checkUnnamed984(o.jwtLocations!);
  }
  buildCounterAuthProvider--;
}
...
core.List<api.AuthProvider> buildUnnamed985() {
  var o = <api.AuthProvider>[];
...
void checkUnnamed985(core.List<api.AuthProvider> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuthProvider(o[0] as api.AuthProvider);
  checkAuthProvider(o[1] as api.AuthProvider);
}

core.List<api.AuthenticationRule> buildUnnamed986() {
...
void checkUnnamed986(core.List<api.AuthenticationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Authentication buildAuthentication() {
  ...
  if (buildCounterAuthentication < 3) {
    o.providers = buildUnnamed985();
    o.rules = buildUnnamed986();
  }
  buildCounterAuthentication--;
  return o;
}
...
void checkAuthentication(api.Authentication o) {
  buildCounterAuthentication++;
  if (buildCounterAuthentication < 3) {
    checkUnnamed985(o.providers!);
    checkUnnamed986(o.rules!);
  }
  buildCounterAuthentication--;
}

core.List<api.AuthRequirement> buildUnnamed987() {
  var o = <api.AuthRequirement>[];
...
void checkUnnamed987(core.List<api.AuthRequirement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuthenticationRule buildAuthenticationRule() {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    o.requirements = buildUnnamed987();
    o.selector = 'foo';
  }
  buildCounterAuthenticationRule--;
  return o;
...
void checkAuthenticationRule(api.AuthenticationRule o) {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    checkUnnamed987(o.requirements!);
    unittest.expect(
      o.selector!,
      unittest.equals('foo'),
    );
...
core.List<api.BackendRule> buildUnnamed988() {
...
void checkUnnamed988(core.List<api.BackendRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.BillingDestination> buildUnnamed989() {
...
void checkUnnamed989(core.List<api.BillingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Billing buildBilling() {
  ...
  if (buildCounterBilling < 3) {
    o.consumerDestinations = buildUnnamed989();
  }
  buildCounterBilling--;
  return o;
}
...
void checkBilling(api.Billing o) {
  buildCounterBilling++;
  if (buildCounterBilling < 3) {
    checkUnnamed989(o.consumerDestinations!);
  }
  buildCounterBilling--;
}
...
core.List<core.String> buildUnnamed990() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed990(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.ContextRule> buildUnnamed991() {
...
void checkUnnamed991(core.List<api.ContextRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed993() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed993(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed994() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed994(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed995() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed995(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.ContextRule buildContextRule() {
  ...
  if (buildCounterContextRule < 3) {
    o.allowedRequestExtensions = buildUnnamed992();
    o.allowedResponseExtensions = buildUnnamed993();
    o.provided = buildUnnamed994();
    o.requested = buildUnnamed995();
    o.selector = 'foo';
  }
  buildCounterContextRule--;
  return o;
...
void checkContextRule(api.ContextRule o) {
  buildCounterContextRule++;
  if (buildCounterContextRule < 3) {
    checkUnnamed992(o.allowedRequestExtensions!);
    checkUnnamed993(o.allowedResponseExtensions!);
    checkUnnamed994(o.provided!);
    checkUnnamed995(o.requested!);
    unittest.expect(
      o.selector!,
      unittest.equals('foo'),
    );
...
core.List<api.CustomErrorRule> buildUnnamed996() {
...
void checkUnnamed997(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.CustomError buildCustomError() {
  ...
  if (buildCounterCustomError < 3) {
    o.rules = buildUnnamed996();
    o.types = buildUnnamed997();
  }
  buildCounterCustomError--;
  return o;
}
...
void checkCustomError(api.CustomError o) {
  buildCounterCustomError++;
  if (buildCounterCustomError < 3) {
    checkUnnamed996(o.rules!);
    checkUnnamed997(o.types!);
  }
  buildCounterCustomError--;
}
...
core.List<api.Page> buildUnnamed998() {
  var o = <api.Page>[];
  o.add(buildPage());
  o.add(buildPage());
  return o;
...
void checkUnnamed998(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0] as api.Page);
  checkPage(o[1] as api.Page);
}

core.List<api.DocumentationRule> buildUnnamed999() {
...
void checkUnnamed999(core.List<api.DocumentationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Documentation buildDocumentation() {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    o.overview = 'foo';
    o.pages = buildUnnamed998();
    o.rules = buildUnnamed999();
...
void checkDocumentation(api.Documentation o) {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    checkUnnamed998(o.pages!);
    checkUnnamed999(o.rules!);
    unittest.expect(
      o.serviceRootUrl!,
      unittest.equals('foo'),
    );
...
core.List<core.String> buildUnnamed1000() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1000(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.EnumValue> buildUnnamed1001() {
  var o = <api.EnumValue>[];
...
void checkUnnamed1001(core.List<api.EnumValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnumValue(o[0] as api.EnumValue);
  checkEnumValue(o[1] as api.EnumValue);
}

core.List<api.Option> buildUnnamed1002() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed1002(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
api.Enum buildEnum() {
  ...
  if (buildCounterEnum < 3) {
    o.enumvalue = buildUnnamed1001();
    o.name = 'foo';
    o.options = buildUnnamed1002();
    o.sourceContext = buildSourceContext();
    o.syntax = 'foo';
  }
  buildCounterEnum--;
...
void checkEnum(api.Enum o) {
  buildCounterEnum++;
  if (buildCounterEnum < 3) {
    checkUnnamed1001(o.enumvalue!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed1002(o.options!);
    checkSourceContext(o.sourceContext! as api.SourceContext);
    unittest.expect(
      o.syntax!,
      unittest.equals('foo'),
...
core.List<api.Option> buildUnnamed1003() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed1003(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
void checkEnumValue(api.EnumValue o) {
  ...
  if (buildCounterEnumValue < 3) {
    ...
    checkUnnamed1003(o.options!);
  }
  buildCounterEnumValue--;
}

core.List<api.Option> buildUnnamed1004() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed1004(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
core.List<api.HttpRule> buildUnnamed1005() {
  var o = <api.HttpRule>[];
  o.add(buildHttpRule());
  o.add(buildHttpRule());
  return o;
...
void checkUnnamed1005(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkHttp(api.Http o) {
  ...
  if (buildCounterHttp < 3) {
    ...
    checkUnnamed1005(o.rules!);
  }
  buildCounterHttp--;
}

core.List<api.HttpRule> buildUnnamed1006() {
  var o = <api.HttpRule>[];
  o.add(buildHttpRule());
  o.add(buildHttpRule());
  return o;
...
void checkUnnamed1006(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0] as api.HttpRule);
  checkHttpRule(o[1] as api.HttpRule);
}
...
api.HttpRule buildHttpRule() {
  ...
  if (buildCounterHttpRule < 3) {
    o.additionalBindings = buildUnnamed1006();
    o.body = 'foo';
...
void checkHttpRule(api.HttpRule o) {
  buildCounterHttpRule++;
  if (buildCounterHttpRule < 3) {
    checkUnnamed1006(o.additionalBindings!);
    unittest.expect(
      o.body!,
      unittest.equals('foo'),
    );
...
core.List<api.Operation> buildUnnamed1007() {
  var o = <api.Operation>[];
...
void checkUnnamed1007(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed1007(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.TenancyUnit> buildUnnamed1008() {
...
void checkUnnamed1008(core.List<api.TenancyUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListTenancyUnitsResponse buildListTenancyUnitsResponse() {
  ...
  if (buildCounterListTenancyUnitsResponse < 3) {
    o.nextPageToken = 'foo';
    o.tenancyUnits = buildUnnamed1008();
  }
  buildCounterListTenancyUnitsResponse--;
  return o;
}
...
void checkListTenancyUnitsResponse(api.ListTenancyUnitsResponse o) {
  ...
  if (buildCounterListTenancyUnitsResponse < 3) {
    ...
    checkUnnamed1008(o.tenancyUnits!);
  }
  buildCounterListTenancyUnitsResponse--;
}

core.List<api.LabelDescriptor> buildUnnamed1009() {
  var o = <api.LabelDescriptor>[];
...
void checkUnnamed1009(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LoggingDestination> buildUnnamed1010() {
...
void checkUnnamed1011(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoggingDestination(o[0] as api.LoggingDestination);
  checkLoggingDestination(o[1] as api.LoggingDestination);
}
...
api.Logging buildLogging() {
  ...
  if (buildCounterLogging < 3) {
    o.consumerDestinations = buildUnnamed1010();
    o.producerDestinations = buildUnnamed1011();
  }
  buildCounterLogging--;
  return o;
}
...
void checkLogging(api.Logging o) {
  buildCounterLogging++;
  if (buildCounterLogging < 3) {
    checkUnnamed1010(o.consumerDestinations!);
    checkUnnamed1011(o.producerDestinations!);
  }
  buildCounterLogging--;
}
...
core.List<api.Option> buildUnnamed1013() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed1013(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
core.List<api.LabelDescriptor> buildUnnamed1014() {
  var o = <api.LabelDescriptor>[];
  o.add(buildLabelDescriptor());
  o.add(buildLabelDescriptor());
  return o;
...
void checkUnnamed1014(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0] as api.LabelDescriptor);
  checkLabelDescriptor(o[1] as api.LabelDescriptor);
}

core.List<core.String> buildUnnamed1015() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1015(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.MetricDescriptor buildMetricDescriptor() {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    o.metricKind = 'foo';
    o.monitoredResourceTypes = buildUnnamed1015();
    o.name = 'foo';
    o.type = 'foo';
    o.unit = 'foo';
    o.valueType = 'foo';
...
void checkMetricDescriptor(api.MetricDescriptor o) {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    checkUnnamed1015(o.monitoredResourceTypes!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed1016() {
...
void checkUnnamed1016(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.MetricRule buildMetricRule() {
  ...
  if (buildCounterMetricRule < 3) {
    o.metricCosts = buildUnnamed1016();
    o.selector = 'foo';
  }
  buildCounterMetricRule--;
  return o;
...
void checkMetricRule(api.MetricRule o) {
  buildCounterMetricRule++;
  if (buildCounterMetricRule < 3) {
    checkUnnamed1016(o.metricCosts!);
    unittest.expect(
      o.selector!,
      unittest.equals('foo'),
    );
...
core.List<api.LabelDescriptor> buildUnnamed1017() {
  var o = <api.LabelDescriptor>[];
  o.add(buildLabelDescriptor());
  o.add(buildLabelDescriptor());
  return o;
...
void checkUnnamed1017(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0] as api.LabelDescriptor);
  checkLabelDescriptor(o[1] as api.LabelDescriptor);
}
...
core.List<api.MonitoringDestination> buildUnnamed1018() {
...
void checkUnnamed1019(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoringDestination(o[0] as api.MonitoringDestination);
  checkMonitoringDestination(o[1] as api.MonitoringDestination);
}
...
api.Monitoring buildMonitoring() {
  ...
  if (buildCounterMonitoring < 3) {
    o.consumerDestinations = buildUnnamed1018();
    o.producerDestinations = buildUnnamed1019();
  }
  buildCounterMonitoring--;
  return o;
}
...
void checkMonitoring(api.Monitoring o) {
  buildCounterMonitoring++;
  if (buildCounterMonitoring < 3) {
    checkUnnamed1018(o.consumerDestinations!);
    checkUnnamed1019(o.producerDestinations!);
  }
  buildCounterMonitoring--;
}

core.List<core.String> buildUnnamed1020() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1020(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.Map<core.String, core.Object> buildUnnamed1021() {
...
void checkUnnamed1021(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed1022() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed1022(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed1021();
    o.name = 'foo';
    o.response = buildUnnamed1022();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed1021(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed1022(o.response!);
  }
  buildCounterOperation--;
}

core.Map<core.String, core.Object> buildUnnamed1023() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed1023(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Page> buildUnnamed1024() {
  var o = <api.Page>[];
  o.add(buildPage());
  o.add(buildPage());
  return o;
...
void checkUnnamed1024(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0] as api.Page);
  checkPage(o[1] as api.Page);
}
...
void checkPage(api.Page o) {
  ...
  if (buildCounterPage < 3) {
    ...
    checkUnnamed1024(o.subpages!);
  }
  buildCounterPage--;
}

core.List<core.String> buildUnnamed1025() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1025(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.QuotaLimit> buildUnnamed1026() {
...
void checkUnnamed1026(core.List<api.QuotaLimit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaLimit(o[0] as api.QuotaLimit);
  checkQuotaLimit(o[1] as api.QuotaLimit);
}

core.List<api.MetricRule> buildUnnamed1027() {
  var o = <api.MetricRule>[];
...
void checkUnnamed1027(core.List<api.MetricRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Quota buildQuota() {
  ...
  if (buildCounterQuota < 3) {
    o.limits = buildUnnamed1026();
    o.metricRules = buildUnnamed1027();
  }
  buildCounterQuota--;
  return o;
}
...
void checkQuota(api.Quota o) {
  buildCounterQuota++;
  if (buildCounterQuota < 3) {
    checkUnnamed1026(o.limits!);
    checkUnnamed1027(o.metricRules!);
  }
  buildCounterQuota--;
}

core.Map<core.String, core.String> buildUnnamed1028() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1028(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.TenancyUnit> buildUnnamed1029() {
  var o = <api.TenancyUnit>[];
  o.add(buildTenancyUnit());
  o.add(buildTenancyUnit());
  return o;
...
void checkUnnamed1029(core.List<api.TenancyUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTenancyUnit(o[0] as api.TenancyUnit);
  checkTenancyUnit(o[1] as api.TenancyUnit);
}
...
api.SearchTenancyUnitsResponse buildSearchTenancyUnitsResponse() {
  ...
  if (buildCounterSearchTenancyUnitsResponse < 3) {
    o.nextPageToken = 'foo';
    o.tenancyUnits = buildUnnamed1029();
  }
  buildCounterSearchTenancyUnitsResponse--;
  return o;
}
...
void checkSearchTenancyUnitsResponse(api.SearchTenancyUnitsResponse o) {
  ...
  if (buildCounterSearchTenancyUnitsResponse < 3) {
    ...
    checkUnnamed1029(o.tenancyUnits!);
  }
  buildCounterSearchTenancyUnitsResponse--;
}

core.List<api.Api> buildUnnamed1030() {
  var o = <api.Api>[];
  o.add(buildApi());
  o.add(buildApi());
  return o;
...
void checkUnnamed1030(core.List<api.Api> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApi(o[0] as api.Api);
  checkApi(o[1] as api.Api);
}

core.List<api.Endpoint> buildUnnamed1031() {
  var o = <api.Endpoint>[];
  o.add(buildEndpoint());
  o.add(buildEndpoint());
  return o;
...
void checkUnnamed1031(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0] as api.Endpoint);
  checkEndpoint(o[1] as api.Endpoint);
}

core.List<api.Enum> buildUnnamed1032() {
  var o = <api.Enum>[];
  o.add(buildEnum());
  o.add(buildEnum());
  return o;
...
void checkUnnamed1032(core.List<api.Enum> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnum(o[0] as api.Enum);
  checkEnum(o[1] as api.Enum);
}

core.List<api.LogDescriptor> buildUnnamed1033() {
  var o = <api.LogDescriptor>[];
...
void checkUnnamed1033(core.List<api.LogDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogDescriptor(o[0] as api.LogDescriptor);
  checkLogDescriptor(o[1] as api.LogDescriptor);
}

core.List<api.MetricDescriptor> buildUnnamed1034() {
  var o = <api.MetricDescriptor>[];
...
void checkUnnamed1034(core.List<api.MetricDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricDescriptor(o[0] as api.MetricDescriptor);
  checkMetricDescriptor(o[1] as api.MetricDescriptor);
}

core.List<api.MonitoredResourceDescriptor> buildUnnamed1035() {
  var o = <api.MonitoredResourceDescriptor>[];
...
void checkUnnamed1035(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Type> buildUnnamed1036() {
  var o = <api.Type>[];
  o.add(buildType());
  o.add(buildType());
  return o;
...
void checkUnnamed1036(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0] as api.Type);
  checkType(o[1] as api.Type);
}

core.List<api.Type> buildUnnamed1037() {
  var o = <api.Type>[];
  o.add(buildType());
  o.add(buildType());
  return o;
...
void checkUnnamed1037(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0] as api.Type);
  checkType(o[1] as api.Type);
}
...
api.Service buildService() {
  ...
  if (buildCounterService < 3) {
    ...
    o.endpoints = buildUnnamed1031();
    o.enums = buildUnnamed1032();
    o.http = buildHttp();
    o.id = 'foo';
    o.logging = buildLogging();
    o.logs = buildUnnamed1033();
    o.metrics = buildUnnamed1034();
    o.monitoredResources = buildUnnamed1035();
    ...
    o.systemTypes = buildUnnamed1036();
    o.title = 'foo';
    o.types = buildUnnamed1037();
    o.usage = buildUsage();
  }
  buildCounterService--;
  return o;
...
void checkService(api.Service o) {
  ...
  if (buildCounterService < 3) {
    ...
    checkUnnamed1031(o.endpoints!);
    checkUnnamed1032(o.enums!);
    ...
    checkUnnamed1033(o.logs!);
    checkUnnamed1034(o.metrics!);
    checkUnnamed1035(o.monitoredResources!);
    ...
    checkUnnamed1036(o.systemTypes!);
    unittest.expect(
      o.title!,
      unittest.equals('foo'),
    );
    checkUnnamed1037(o.types!);
    checkUsage(o.usage! as api.Usage);
  }
  buildCounterService--;
}

core.List<core.String> buildUnnamed1038() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1038(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.ServiceAccountConfig buildServiceAccountConfig() {
  ...
  if (buildCounterServiceAccountConfig < 3) {
    o.accountId = 'foo';
    o.tenantProjectRoles = buildUnnamed1038();
  }
  buildCounterServiceAccountConfig--;
  return o;
}
...
void checkServiceAccountConfig(api.ServiceAccountConfig o) {
  ...
  if (buildCounterServiceAccountConfig < 3) {
    ...
    checkUnnamed1038(o.tenantProjectRoles!);
  }
  buildCounterServiceAccountConfig--;
}
...
core.Map<core.String, core.Object> buildUnnamed1039() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed1039(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed1040() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed1039());
  o.add(buildUnnamed1039());
  return o;
}

void checkUnnamed1040(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1039(o[0]);
  checkUnnamed1039(o[1]);
}
...
api.SourceInfo buildSourceInfo() {
  ...
  if (buildCounterSourceInfo < 3) {
    o.sourceFiles = buildUnnamed1040();
  }
  buildCounterSourceInfo--;
  return o;
}
...
void checkSourceInfo(api.SourceInfo o) {
  buildCounterSourceInfo++;
  if (buildCounterSourceInfo < 3) {
    checkUnnamed1040(o.sourceFiles!);
  }
  buildCounterSourceInfo--;
}

core.Map<core.String, core.Object> buildUnnamed1041() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed1041(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed1042() {
  var o = <core.Map<core.String, core.Object>>[];
...
void checkUnnamed1042(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SystemParameter> buildUnnamed1043() {
  var o = <api.SystemParameter>[];
...
void checkUnnamed1043(core.List<api.SystemParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SystemParameterRule> buildUnnamed1044() {
  var o = <api.SystemParameterRule>[];
...
void checkUnnamed1044(core.List<api.SystemParameterRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSystemParameters(api.SystemParameters o) {
  buildCounterSystemParameters++;
  if (buildCounterSystemParameters < 3) {
    checkUnnamed1044(o.rules!);
  }
  buildCounterSystemParameters--;
}

core.List<api.TenantResource> buildUnnamed1045() {
...
void checkUnnamed1045(core.List<api.TenantResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TenancyUnit buildTenancyUnit() {
  ...
  if (buildCounterTenancyUnit < 3) {
    ...
    o.name = 'foo';
    o.service = 'foo';
    o.tenantResources = buildUnnamed1045();
  }
  buildCounterTenancyUnit--;
  return o;
}
...
void checkTenancyUnit(api.TenancyUnit o) {
  ...
  if (buildCounterTenancyUnit < 3) {
    ...
    checkUnnamed1045(o.tenantResources!);
  }
  buildCounterTenancyUnit--;
}

core.Map<core.String, core.String> buildUnnamed1046() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1046(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed1047() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1047(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.TenantProjectConfig buildTenantProjectConfig() {
  ...
  if (buildCounterTenantProjectConfig < 3) {
    ...
    o.folder = 'foo';
    o.labels = buildUnnamed1046();
    o.serviceAccountConfig = buildServiceAccountConfig();
    o.services = buildUnnamed1047();
...
void checkUnnamed1048(core.List<api.PolicyBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TenantProjectPolicy buildTenantProjectPolicy() {
  ...
  if (buildCounterTenantProjectPolicy < 3) {
    o.policyBindings = buildUnnamed1048();
  }
  buildCounterTenantProjectPolicy--;
  return o;
}
...
void checkTenantProjectPolicy(api.TenantProjectPolicy o) {
  buildCounterTenantProjectPolicy++;
  if (buildCounterTenantProjectPolicy < 3) {
    checkUnnamed1048(o.policyBindings!);
  }
  buildCounterTenantProjectPolicy--;
}
...
core.List<api.Field> buildUnnamed1049() {
  var o = <api.Field>[];
  o.add(buildField());
  o.add(buildField());
  return o;
...
void checkUnnamed1049(core.List<api.Field> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkUnnamed1050(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.Option> buildUnnamed1051() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed1051(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
core.List<core.String> buildUnnamed1052() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1052(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.UsageRule> buildUnnamed1053() {
  var o = <api.UsageRule>[];
...
void checkUnnamed1053(core.List<api.UsageRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Usage buildUsage() {
  ...
  if (buildCounterUsage < 3) {
    ...
    o.requirements = buildUnnamed1052();
...
void checkUsage(api.Usage o) {
  ...
  if (buildCounterUsage < 3) {
    ...
    checkUnnamed1052(o.requirements!);
...
core.List<core.String> buildUnnamed1054() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1054(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
void checkV1AddVisibilityLabelsResponse(api.V1AddVisibilityLabelsResponse o) {
  buildCounterV1AddVisibilityLabelsResponse++;
  if (buildCounterV1AddVisibilityLabelsResponse < 3) {
    checkUnnamed1054(o.labels!);
  }
  buildCounterV1AddVisibilityLabelsResponse--;
}

core.List<api.V1Beta1QuotaOverride> buildUnnamed1055() {
...
void checkUnnamed1055(core.List<api.V1Beta1QuotaOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.V1Beta1QuotaOverride> buildUnnamed1056() {
  var o = <api.V1Beta1QuotaOverride>[];
  o.add(buildV1Beta1QuotaOverride());
  o.add(buildV1Beta1QuotaOverride());
  return o;
...
void checkUnnamed1056(core.List<api.V1Beta1QuotaOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkV1Beta1QuotaOverride(o[0] as api.V1Beta1QuotaOverride);
  checkV1Beta1QuotaOverride(o[1] as api.V1Beta1QuotaOverride);
}
...
void checkV1Beta1ImportProducerOverridesResponse(
  ...
  buildCounterV1Beta1ImportProducerOverridesResponse++;
  if (buildCounterV1Beta1ImportProducerOverridesResponse < 3) {
    checkUnnamed1056(o.overrides!);
  }
  buildCounterV1Beta1ImportProducerOverridesResponse--;
}

core.List<api.V1Beta1ProducerQuotaPolicy> buildUnnamed1057() {
...
void checkUnnamed1057(core.List<api.V1Beta1ProducerQuotaPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkV1Beta1ImportProducerQuotaPoliciesResponse(
  ...
  buildCounterV1Beta1ImportProducerQuotaPoliciesResponse++;
  if (buildCounterV1Beta1ImportProducerQuotaPoliciesResponse < 3) {
    checkUnnamed1057(o.policies!);
  }
  buildCounterV1Beta1ImportProducerQuotaPoliciesResponse--;
}

core.Map<core.String, core.String> buildUnnamed1058() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1058(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed1059() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1059(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed1060() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1060(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
