...
core.List<api.GoogleCloudBillingBudgetsV1ThresholdRule> buildUnnamed972() {
...
api.GoogleCloudBillingBudgetsV1Budget buildGoogleCloudBillingBudgetsV1Budget() {
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1Budget < 3) {
    ...
    o.thresholdRules = buildUnnamed972();
  }
  buildCounterGoogleCloudBillingBudgetsV1Budget--;
  return o;
}
...
void checkGoogleCloudBillingBudgetsV1Budget(
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1Budget < 3) {
    ...
    checkUnnamed972(o.thresholdRules!);
  }
  buildCounterGoogleCloudBillingBudgetsV1Budget--;
}
...
core.List<core.String> buildUnnamed973() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed973(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.Object> buildUnnamed974() {
  var o = <core.Object>[];
  o.add({
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed974(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.List<core.Object>> buildUnnamed975() {
...
void checkUnnamed975(core.Map<core.String, core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed974(o['x']!);
  checkUnnamed974(o['y']!);
}

core.List<core.String> buildUnnamed976() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed976(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.GoogleCloudBillingBudgetsV1Filter buildGoogleCloudBillingBudgetsV1Filter() {
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1Filter < 3) {
    ...
    o.creditTypes = buildUnnamed973();
    o.creditTypesTreatment = 'foo';
    o.customPeriod = buildGoogleCloudBillingBudgetsV1CustomPeriod();
    o.labels = buildUnnamed975();
    o.projects = buildUnnamed976();
    o.services = buildUnnamed977();
    o.subaccounts = buildUnnamed978();
  }
  buildCounterGoogleCloudBillingBudgetsV1Filter--;
  return o;
}
...
void checkGoogleCloudBillingBudgetsV1Filter(
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1Filter < 3) {
    ...
    checkUnnamed975(o.labels!);
    checkUnnamed976(o.projects!);
    checkUnnamed977(o.services!);
    checkUnnamed978(o.subaccounts!);
  }
  buildCounterGoogleCloudBillingBudgetsV1Filter--;
}
...
core.List<api.GoogleCloudBillingBudgetsV1Budget> buildUnnamed979() {
  var o = <api.GoogleCloudBillingBudgetsV1Budget>[];
...
void checkUnnamed979(core.List<api.GoogleCloudBillingBudgetsV1Budget> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed980() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed980(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.GoogleCloudBillingBudgetsV1NotificationsRule
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1NotificationsRule < 3) {
    ...
    o.monitoringNotificationChannels = buildUnnamed980();
    o.pubsubTopic = 'foo';
    o.schemaVersion = 'foo';
  }
  buildCounterGoogleCloudBillingBudgetsV1NotificationsRule--;
...
void checkGoogleCloudBillingBudgetsV1NotificationsRule(
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1NotificationsRule < 3) {
    ...
    checkUnnamed980(o.monitoringNotificationChannels!);
    unittest.expect(
      o.pubsubTopic!,
      unittest.equals('foo'),
    );
