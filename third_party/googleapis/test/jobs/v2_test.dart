...
checkUnnamed637(core.List<api.CompanyInfoSource> o) {
...
checkUnnamed639(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCompany() {
  ...
  if (buildCounterCompany < 3) {
    ...
    o.companyInfoSources = buildUnnamed637();
    o.companySize = "foo";
    ...
    o.hqLocation = "foo";
    o.imageUrl = "foo";
    o.keywordSearchableCustomAttributes = buildUnnamed638();
    o.keywordSearchableCustomFields = buildUnnamed639();
    o.name = "foo";
...
checkCompany(api.Company o) {
  ...
  if (buildCounterCompany < 3) {
    ...
    checkUnnamed637(o.companyInfoSources);
    ...
    checkUnnamed638(o.keywordSearchableCustomAttributes);
    checkUnnamed639(o.keywordSearchableCustomFields);
...
checkUnnamed641(core.List<api.CompensationEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed642(core.List<api.CompletionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCompleteQueryResponse() {
  ...
  if (buildCounterCompleteQueryResponse < 3) {
    o.completionResults = buildUnnamed642();
...
checkCompleteQueryResponse(api.CompleteQueryResponse o) {
  buildCounterCompleteQueryResponse++;
  if (buildCounterCompleteQueryResponse < 3) {
    checkUnnamed642(o.completionResults);
...
checkUnnamed643(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCustomAttributeHistogramResult() {
  ...
  if (buildCounterCustomAttributeHistogramResult < 3) {
    ...
    o.stringValueHistogramResult = buildUnnamed643();
  }
  buildCounterCustomAttributeHistogramResult--;
  return o;
}
...
checkCustomAttributeHistogramResult(api.CustomAttributeHistogramResult o) {
  ...
  if (buildCounterCustomAttributeHistogramResult < 3) {
    ...
    checkUnnamed643(o.stringValueHistogramResult);
  }
  buildCounterCustomAttributeHistogramResult--;
}
...
buildExtendedCompensationFilter() {
  ...
  if (buildCounterExtendedCompensationFilter < 3) {
    ...
    o.compensationUnits = buildUnnamed646();
    o.currency = "foo";
...
checkExtendedCompensationFilter(api.ExtendedCompensationFilter o) {
  ...
  if (buildCounterExtendedCompensationFilter < 3) {
    ...
    checkUnnamed646(o.compensationUnits);
...
checkUnnamed647(core.List<api.ExtendedCompensationInfoCompensationEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed649(core.List<api.HistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed650(core.List<api.CompensationHistogramRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed651(core.List<api.CustomAttributeHistogramRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildHistogramFacets() {
  ...
  if (buildCounterHistogramFacets < 3) {
    o.compensationHistogramFacets = buildUnnamed650();
    o.customAttributeHistogramFacets = buildUnnamed651();
    o.simpleHistogramFacets = buildUnnamed652();
  }
  buildCounterHistogramFacets--;
  return o;
}
...
checkHistogramFacets(api.HistogramFacets o) {
  buildCounterHistogramFacets++;
  if (buildCounterHistogramFacets < 3) {
    checkUnnamed650(o.compensationHistogramFacets);
    checkUnnamed651(o.customAttributeHistogramFacets);
    checkUnnamed652(o.simpleHistogramFacets);
  }
  buildCounterHistogramFacets--;
}
...
checkUnnamed653(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals(42));
  unittest.expect(o["y"], unittest.equals(42));
}
...
checkUnnamed654(core.List<api.CompensationHistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed655(core.List<api.CustomAttributeHistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed656(core.List<api.HistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHistogramResult(o[0]);
  checkHistogramResult(o[1]);
}
...
buildHistogramResults() {
  ...
  if (buildCounterHistogramResults < 3) {
    o.compensationHistogramResults = buildUnnamed654();
    o.customAttributeHistogramResults = buildUnnamed655();
    o.simpleHistogramResults = buildUnnamed656();
  }
  buildCounterHistogramResults--;
  return o;
}
...
checkHistogramResults(api.HistogramResults o) {
  buildCounterHistogramResults++;
  if (buildCounterHistogramResults < 3) {
    checkUnnamed654(o.compensationHistogramResults);
    checkUnnamed655(o.customAttributeHistogramResults);
    checkUnnamed656(o.simpleHistogramResults);
  }
  buildCounterHistogramResults--;
}
...
checkUnnamed660(core.Map<core.String, api.CustomAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed663(core.Map<core.String, api.CustomField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed664(core.List<api.JobLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed666(core.Map<core.String, api.CustomField> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomField(o["x"]);
  checkCustomField(o["y"]);
}
...
buildJob() {
  ...
  if (buildCounterJob < 3) {
    o.applicationEmailList = buildUnnamed657();
    o.applicationInstruction = "foo";
    o.applicationUrls = buildUnnamed658();
    o.benefits = buildUnnamed659();
    o.companyDisplayName = "foo";
    o.companyName = "foo";
    o.companyTitle = "foo";
    o.compensationInfo = buildCompensationInfo();
    o.createTime = "foo";
    o.customAttributes = buildUnnamed660();
    o.department = "foo";
    o.description = "foo";
    o.distributorCompanyId = "foo";
    o.educationLevels = buildUnnamed661();
    o.employmentTypes = buildUnnamed662();
    o.endDate = buildDate();
    o.expireTime = "foo";
    o.expiryDate = buildDate();
    o.extendedCompensationInfo = buildExtendedCompensationInfo();
    o.filterableCustomFields = buildUnnamed663();
    o.incentives = "foo";
    o.jobLocations = buildUnnamed664();
    o.jobTitle = "foo";
    o.languageCode = "foo";
    o.level = "foo";
    o.locations = buildUnnamed665();
    o.name = "foo";
    o.promotionValue = 42;
    ...
    o.unindexedCustomFields = buildUnnamed666();
    o.updateTime = "foo";
    o.visibility = "foo";
  }
  buildCounterJob--;
...
checkJob(api.Job o) {
  buildCounterJob++;
  if (buildCounterJob < 3) {
    checkUnnamed657(o.applicationEmailList);
    unittest.expect(o.applicationInstruction, unittest.equals('foo'));
    checkUnnamed658(o.applicationUrls);
    checkUnnamed659(o.benefits);
    ...
    checkUnnamed666(o.unindexedCustomFields);
...
checkUnnamed670(core.Map<core.String, api.CustomFieldFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed673(core.List<api.LocationFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildJobFilters() {
  ...
  if (buildCounterJobFilters < 3) {
    o.categories = buildUnnamed667();
    o.commuteFilter = buildCommutePreference();
    o.companyNames = buildUnnamed668();
    o.companyTitles = buildUnnamed669();
    o.compensationFilter = buildCompensationFilter();
    o.customAttributeFilter = "foo";
    o.customFieldFilters = buildUnnamed670();
    o.disableSpellCheck = true;
    o.employmentTypes = buildUnnamed671();
    o.extendedCompensationFilter = buildExtendedCompensationFilter();
    o.languageCodes = buildUnnamed672();
    o.locationFilters = buildUnnamed673();
...
checkUnnamed679(core.List<api.LocationFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocationFilter(o[0]);
  checkLocationFilter(o[1]);
}
...
buildJobQuery() {
  ...
  if (buildCounterJobQuery < 3) {
    o.categories = buildUnnamed674();
    o.commuteFilter = buildCommutePreference();
    o.companyDisplayNames = buildUnnamed675();
    o.companyNames = buildUnnamed676();
    o.compensationFilter = buildCompensationFilter();
    o.customAttributeFilter = "foo";
    o.disableSpellCheck = true;
    o.employmentTypes = buildUnnamed677();
    o.languageCodes = buildUnnamed678();
    o.locationFilters = buildUnnamed679();
    o.publishDateRange = "foo";
    o.query = "foo";
  }
  buildCounterJobQuery--;
...
checkJobQuery(api.JobQuery o) {
  buildCounterJobQuery++;
  if (buildCounterJobQuery < 3) {
    checkUnnamed674(o.categories);
    checkCommutePreference(o.commuteFilter);
    checkUnnamed675(o.companyDisplayNames);
    checkUnnamed676(o.companyNames);
    checkCompensationFilter(o.compensationFilter);
    unittest.expect(o.customAttributeFilter, unittest.equals('foo'));
    unittest.expect(o.disableSpellCheck, unittest.isTrue);
    checkUnnamed677(o.employmentTypes);
    checkUnnamed678(o.languageCodes);
    checkUnnamed679(o.locationFilters);
    unittest.expect(o.publishDateRange, unittest.equals('foo'));
    unittest.expect(o.query, unittest.equals('foo'));
  }
  buildCounterJobQuery--;
...
checkUnnamed680(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
checkUnnamed681(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
checkUnnamed682(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
checkUnnamed683(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNumericBucketingOption() {
  ...
  if (buildCounterNumericBucketingOption < 3) {
    o.bucketBounds = buildUnnamed683();
...
checkNumericBucketingOption(api.NumericBucketingOption o) {
  buildCounterNumericBucketingOption++;
  if (buildCounterNumericBucketingOption < 3) {
    checkUnnamed683(o.bucketBounds);
...
checkUnnamed684(core.List<api.BucketizedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPostalAddress() {
  ...
  if (buildCounterPostalAddress < 3) {
    o.addressLines = buildUnnamed685();
...
checkPostalAddress(api.PostalAddress o) {
  buildCounterPostalAddress++;
  if (buildCounterPostalAddress < 3) {
    checkUnnamed685(o.addressLines);
...
checkUnnamed687(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
buildResponseMetadata() {
  ...
  if (buildCounterResponseMetadata < 3) {
    o.experimentIdList = buildUnnamed687();
    o.mode = "foo";
    o.requestId = "foo";
  }
  buildCounterResponseMetadata--;
...
checkResponseMetadata(api.ResponseMetadata o) {
  buildCounterResponseMetadata++;
  if (buildCounterResponseMetadata < 3) {
    checkUnnamed687(o.experimentIdList);
...
checkUnnamed688(core.List<api.JobLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJobLocation(o[0]);
  checkJobLocation(o[1]);
}
...
checkUnnamed689(core.List<api.MatchingJob> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSearchJobsResponse() {
  ...
  if (buildCounterSearchJobsResponse < 3) {
    ...
    o.appliedJobLocationFilters = buildUnnamed688();
    o.estimatedTotalSize = "foo";
    o.histogramResults = buildHistogramResults();
    o.jobView = "foo";
    o.matchingJobs = buildUnnamed689();
    o.metadata = buildResponseMetadata();
    o.nextPageToken = "foo";
