...
buildActivity() {
  ...
  if (buildCounterActivity < 3) {
    ...
    o.singleEvents = buildUnnamed991();
  }
  buildCounterActivity--;
  return o;
}
...
checkActivity(api.Activity o) {
  ...
  if (buildCounterActivity < 3) {
    ...
    checkUnnamed991(o.singleEvents);
  }
  buildCounterActivity--;
}
...
checkUnnamed993(core.List<api.PermissionChange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildEvent() {
  ...
  if (buildCounterEvent < 3) {
    o.additionalEventTypes = buildUnnamed992();
    o.eventTimeMillis = "foo";
    o.fromUserDeletion = true;
    o.move = buildMove();
    o.permissionChanges = buildUnnamed993();
...
checkUnnamed994(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed995(core.List<api.Parent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParent(o[0]);
  checkParent(o[1]);
}
...
checkUnnamed996(core.List<api.Parent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParent(o[0]);
  checkParent(o[1]);
}
...
buildMove() {
  ...
  if (buildCounterMove < 3) {
    o.addedParents = buildUnnamed995();
    o.removedParents = buildUnnamed996();
  }
  buildCounterMove--;
  return o;
}
...
checkMove(api.Move o) {
  buildCounterMove++;
  if (buildCounterMove < 3) {
    checkUnnamed995(o.addedParents);
    checkUnnamed996(o.removedParents);
  }
  buildCounterMove--;
}
...
checkUnnamed997(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
buildPermissionChange() {
  ...
  if (buildCounterPermissionChange < 3) {
    o.addedPermissions = buildUnnamed997();
    o.removedPermissions = buildUnnamed998();
  }
  buildCounterPermissionChange--;
  return o;
}
...
checkPermissionChange(api.PermissionChange o) {
  buildCounterPermissionChange++;
  if (buildCounterPermissionChange < 3) {
    checkUnnamed997(o.addedPermissions);
    checkUnnamed998(o.removedPermissions);
  }
  buildCounterPermissionChange--;
}
