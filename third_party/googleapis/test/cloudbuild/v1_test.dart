...
void checkArtifactObjects(api.ArtifactObjects o) {
  ...
  if (buildCounterArtifactObjects < 3) {
    ...
    checkUnnamed2610(o.paths!);
    checkTimeSpan(o.timing! as api.TimeSpan);
  }
  buildCounterArtifactObjects--;
}

core.List<api.FileHashes> buildUnnamed2611() {
...
void checkUnnamed2611(core.List<api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Secret> buildUnnamed2614() {
  var o = <api.Secret>[];
  o.add(buildSecret());
  o.add(buildSecret());
  return o;
...
void checkUnnamed2614(core.List<api.Secret> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSecret(o[0] as api.Secret);
  checkSecret(o[1] as api.Secret);
}

core.List<api.BuildStep> buildUnnamed2615() {
  var o = <api.BuildStep>[];
...
void checkUnnamed2615(core.List<api.BuildStep> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.TimeSpan> buildUnnamed2618() {
...
void checkUnnamed2618(core.Map<core.String, api.TimeSpan> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Build buildBuild() {
  ...
  if (buildCounterBuild < 3) {
    ...
    o.status = 'foo';
    o.statusDetail = 'foo';
    o.steps = buildUnnamed2615();
    o.substitutions = buildUnnamed2616();
    o.tags = buildUnnamed2617();
    o.timeout = 'foo';
    o.timing = buildUnnamed2618();
  }
  buildCounterBuild--;
  return o;
}
...
void checkBuild(api.Build o) {
  ...
  if (buildCounterBuild < 3) {
    ...
    checkUnnamed2615(o.steps!);
    checkUnnamed2616(o.substitutions!);
    checkUnnamed2617(o.tags!);
    unittest.expect(
      o.timeout!,
      unittest.equals('foo'),
    );
    checkUnnamed2618(o.timing!);
  }
  buildCounterBuild--;
}
...
core.List<api.Volume> buildUnnamed2622() {
  var o = <api.Volume>[];
  o.add(buildVolume());
  o.add(buildVolume());
  return o;
...
void checkUnnamed2622(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BuildOptions buildBuildOptions() {
  ...
  if (buildCounterBuildOptions < 3) {
    ...
    o.env = buildUnnamed2619();
    o.logStreamingOption = 'foo';
    o.logging = 'foo';
    o.machineType = 'foo';
    o.requestedVerifyOption = 'foo';
    o.secretEnv = buildUnnamed2620();
    o.sourceProvenanceHash = buildUnnamed2621();
    o.substitutionOption = 'foo';
    o.volumes = buildUnnamed2622();
    o.workerPool = 'foo';
  }
  buildCounterBuildOptions--;
  return o;
...
void checkBuildOptions(api.BuildOptions o) {
  ...
  if (buildCounterBuildOptions < 3) {
    ...
    checkUnnamed2620(o.secretEnv!);
    checkUnnamed2621(o.sourceProvenanceHash!);
    unittest.expect(
      o.substitutionOption!,
      unittest.equals('foo'),
    );
    checkUnnamed2622(o.volumes!);
    unittest.expect(
      o.workerPool!,
      unittest.equals('foo'),
    );
...
core.List<api.Volume> buildUnnamed2626() {
  var o = <api.Volume>[];
  o.add(buildVolume());
  o.add(buildVolume());
  return o;
...
void checkUnnamed2626(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0] as api.Volume);
  checkVolume(o[1] as api.Volume);
}
...
api.BuildStep buildBuildStep() {
  ...
  if (buildCounterBuildStep < 3) {
    o.args = buildUnnamed2623();
    o.dir = 'foo';
    o.entrypoint = 'foo';
    o.env = buildUnnamed2624();
    o.id = 'foo';
    o.name = 'foo';
    o.pullTiming = buildTimeSpan();
    o.secretEnv = buildUnnamed2625();
    o.status = 'foo';
    o.timeout = 'foo';
    o.timing = buildTimeSpan();
    o.volumes = buildUnnamed2626();
    o.waitFor = buildUnnamed2627();
  }
  buildCounterBuildStep--;
  return o;
}
...
void checkBuildStep(api.BuildStep o) {
  ...
  if (buildCounterBuildStep < 3) {
    ...
    checkTimeSpan(o.timing! as api.TimeSpan);
    checkUnnamed2626(o.volumes!);
    checkUnnamed2627(o.waitFor!);
  }
  buildCounterBuildStep--;
}
...
core.List<core.String> buildUnnamed2629() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed2629(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed2630() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed2630(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.BuildTrigger buildBuildTrigger() {
  ...
  if (buildCounterBuildTrigger < 3) {
    ...
    o.id = 'foo';
    o.ignoredFiles = buildUnnamed2628();
    o.includedFiles = buildUnnamed2629();
    o.name = 'foo';
    o.substitutions = buildUnnamed2630();
    o.tags = buildUnnamed2631();
...
void checkBuildTrigger(api.BuildTrigger o) {
  ...
  if (buildCounterBuildTrigger < 3) {
    ...
    checkUnnamed2628(o.ignoredFiles!);
    checkUnnamed2629(o.includedFiles!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed2630(o.substitutions!);
    checkUnnamed2631(o.tags!);
...
core.List<api.Hash> buildUnnamed2632() {
  var o = <api.Hash>[];
  o.add(buildHash());
  o.add(buildHash());
  return o;
...
void checkUnnamed2632(core.List<api.Hash> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkHttpBody(api.HttpBody o) {
  ...
  if (buildCounterHttpBody < 3) {
    ...
    checkUnnamed2634(o.extensions!);
  }
  buildCounterHttpBody--;
}

core.Map<core.String, core.String> buildUnnamed2635() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed2635(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.BuildTrigger> buildUnnamed2636() {
  var o = <api.BuildTrigger>[];
...
void checkUnnamed2636(core.List<api.BuildTrigger> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListBuildTriggersResponse(api.ListBuildTriggersResponse o) {
  ...
  if (buildCounterListBuildTriggersResponse < 3) {
    ...
    checkUnnamed2636(o.triggers!);
  }
  buildCounterListBuildTriggersResponse--;
}

core.List<api.Build> buildUnnamed2637() {
  var o = <api.Build>[];
  o.add(buildBuild());
  o.add(buildBuild());
  return o;
...
void checkUnnamed2637(core.List<api.Build> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed2638() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2638(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Notification buildNotification() {
  ...
  if (buildCounterNotification < 3) {
    ...
    o.structDelivery = buildUnnamed2638();
  }
  buildCounterNotification--;
  return o;
}
...
void checkNotification(api.Notification o) {
  ...
  if (buildCounterNotification < 3) {
    ...
    checkUnnamed2638(o.structDelivery!);
  }
  buildCounterNotification--;
}
...
core.List<api.NotifierSecret> buildUnnamed2639() {
  var o = <api.NotifierSecret>[];
...
void checkUnnamed2639(core.List<api.NotifierSecret> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkNotifierSpec(api.NotifierSpec o) {
  ...
  if (buildCounterNotifierSpec < 3) {
    ...
    checkUnnamed2639(o.secrets!);
  }
  buildCounterNotifierSpec--;
}

core.Map<core.String, core.Object> buildUnnamed2640() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2640(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed2641() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2641(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed2642() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed2642(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.RepoSource buildRepoSource() {
  ...
  if (buildCounterRepoSource < 3) {
    ...
    o.projectId = 'foo';
    o.repoName = 'foo';
    o.substitutions = buildUnnamed2642();
    o.tagName = 'foo';
  }
  buildCounterRepoSource--;
  return o;
...
void checkRepoSource(api.RepoSource o) {
  ...
  if (buildCounterRepoSource < 3) {
    ...
    checkUnnamed2642(o.substitutions!);
    unittest.expect(
      o.tagName!,
      unittest.equals('foo'),
    );
...
core.List<api.BuiltImage> buildUnnamed2645() {
  var o = <api.BuiltImage>[];
...
void checkUnnamed2645(core.List<api.BuiltImage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Results buildResults() {
  ...
  if (buildCounterResults < 3) {
    ...
    o.buildStepImages = buildUnnamed2643();
    o.buildStepOutputs = buildUnnamed2644();
    o.images = buildUnnamed2645();
    o.numArtifacts = 'foo';
  }
  buildCounterResults--;
  return o;
...
void checkResults(api.Results o) {
  ...
  if (buildCounterResults < 3) {
    ...
    checkUnnamed2643(o.buildStepImages!);
    checkUnnamed2644(o.buildStepOutputs!);
    checkUnnamed2645(o.images!);
    unittest.expect(
      o.numArtifacts!,
      unittest.equals('foo'),
    );
...
api.SMTPDelivery buildSMTPDelivery() {
  ...
  if (buildCounterSMTPDelivery < 3) {
    ...
    o.port = 'foo';
    o.recipientAddresses = buildUnnamed2646();
    o.senderAddress = 'foo';
    o.server = 'foo';
  }
  buildCounterSMTPDelivery--;
...
void checkSMTPDelivery(api.SMTPDelivery o) {
  ...
  if (buildCounterSMTPDelivery < 3) {
    ...
    checkUnnamed2646(o.recipientAddresses!);
    unittest.expect(
      o.senderAddress!,
      unittest.equals('foo'),
    );
...
core.List<api.InlineSecret> buildUnnamed2648() {
  var o = <api.InlineSecret>[];
...
void checkUnnamed2648(core.List<api.InlineSecret> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInlineSecret(o[0] as api.InlineSecret);
  checkInlineSecret(o[1] as api.InlineSecret);
}

core.List<api.SecretManagerSecret> buildUnnamed2649() {
  var o = <api.SecretManagerSecret>[];
...
void checkUnnamed2649(core.List<api.SecretManagerSecret> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Secrets buildSecrets() {
  ...
  if (buildCounterSecrets < 3) {
    o.inline = buildUnnamed2648();
    o.secretManager = buildUnnamed2649();
  }
  buildCounterSecrets--;
  return o;
}
...
void checkSecrets(api.Secrets o) {
  buildCounterSecrets++;
  if (buildCounterSecrets < 3) {
    checkUnnamed2648(o.inline!);
    checkUnnamed2649(o.secretManager!);
  }
  buildCounterSecrets--;
}
...
core.Map<core.String, api.FileHashes> buildUnnamed2650() {
...
void checkUnnamed2650(core.Map<core.String, api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed2651() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2651(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed2652() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed2651());
  o.add(buildUnnamed2651());
  return o;
}

void checkUnnamed2652(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2651(o[0]);
  checkUnnamed2651(o[1]);
}
