...
checkUnnamed3301(core.List<api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileHashes(o[0]);
  checkFileHashes(o[1]);
}
...
checkUnnamed3304(core.List<api.Secret> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSecret(o[0]);
  checkSecret(o[1]);
}
...
checkUnnamed3305(core.List<api.BuildStep> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildStep(o[0]);
  checkBuildStep(o[1]);
}
...
checkUnnamed3308(core.Map<core.String, api.TimeSpan> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeSpan(o["x"]);
  checkTimeSpan(o["y"]);
}
...
buildBuild() {
  ...
  if (buildCounterBuild < 3) {
    ...
    o.finishTime = "foo";
    o.id = "foo";
    o.images = buildUnnamed3303();
    o.logUrl = "foo";
    o.logsBucket = "foo";
    o.options = buildBuildOptions();
    o.projectId = "foo";
    o.results = buildResults();
    o.secrets = buildUnnamed3304();
    o.source = buildSource();
    o.sourceProvenance = buildSourceProvenance();
    o.startTime = "foo";
    o.status = "foo";
    o.statusDetail = "foo";
    o.steps = buildUnnamed3305();
    o.substitutions = buildUnnamed3306();
    o.tags = buildUnnamed3307();
    o.timeout = "foo";
    o.timing = buildUnnamed3308();
  }
  buildCounterBuild--;
  return o;
}
...
checkBuild(api.Build o) {
  ...
  if (buildCounterBuild < 3) {
    ...
    checkUnnamed3304(o.secrets);
    checkSource(o.source);
    checkSourceProvenance(o.sourceProvenance);
    unittest.expect(o.startTime, unittest.equals('foo'));
    unittest.expect(o.status, unittest.equals('foo'));
    unittest.expect(o.statusDetail, unittest.equals('foo'));
    checkUnnamed3305(o.steps);
    checkUnnamed3306(o.substitutions);
    checkUnnamed3307(o.tags);
    unittest.expect(o.timeout, unittest.equals('foo'));
    checkUnnamed3308(o.timing);
  }
  buildCounterBuild--;
}
...
buildBuildOptions() {
  ...
  if (buildCounterBuildOptions < 3) {
    o.diskSizeGb = "foo";
    o.env = buildUnnamed3309();
    o.logStreamingOption = "foo";
    o.logging = "foo";
    o.machineType = "foo";
    o.requestedVerifyOption = "foo";
    o.secretEnv = buildUnnamed3310();
    o.sourceProvenanceHash = buildUnnamed3311();
...
checkBuildOptions(api.BuildOptions o) {
  ...
  if (buildCounterBuildOptions < 3) {
    ...
    checkUnnamed3310(o.secretEnv);
    checkUnnamed3311(o.sourceProvenanceHash);
...
buildBuildStep() {
  ...
  if (buildCounterBuildStep < 3) {
    ...
    o.dir = "foo";
    o.entrypoint = "foo";
    o.env = buildUnnamed3314();
    o.id = "foo";
    o.name = "foo";
    o.pullTiming = buildTimeSpan();
    o.secretEnv = buildUnnamed3315();
    o.status = "foo";
    o.timeout = "foo";
    o.timing = buildTimeSpan();
    o.volumes = buildUnnamed3316();
    o.waitFor = buildUnnamed3317();
  }
  buildCounterBuildStep--;
  return o;
}
...
checkBuildStep(api.BuildStep o) {
  ...
  if (buildCounterBuildStep < 3) {
    ...
    checkUnnamed3314(o.env);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    checkTimeSpan(o.pullTiming);
    checkUnnamed3315(o.secretEnv);
    unittest.expect(o.status, unittest.equals('foo'));
    unittest.expect(o.timeout, unittest.equals('foo'));
    checkTimeSpan(o.timing);
    checkUnnamed3316(o.volumes);
    checkUnnamed3317(o.waitFor);
  }
  buildCounterBuildStep--;
}
...
buildBuildTrigger() {
  ...
  if (buildCounterBuildTrigger < 3) {
    ...
    o.filename = "foo";
    o.id = "foo";
    o.ignoredFiles = buildUnnamed3318();
    o.includedFiles = buildUnnamed3319();
    o.substitutions = buildUnnamed3320();
...
checkBuildTrigger(api.BuildTrigger o) {
  ...
  if (buildCounterBuildTrigger < 3) {
    ...
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed3318(o.ignoredFiles);
    checkUnnamed3319(o.includedFiles);
    checkUnnamed3320(o.substitutions);
...
checkUnnamed3321(core.List<api.Hash> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHash(o[0]);
  checkHash(o[1]);
}
...
checkUnnamed3322(core.List<api.BuildTrigger> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3323(core.List<api.Build> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuild(o[0]);
  checkBuild(o[1]);
}
...
checkUnnamed3324(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed3329(core.List<api.BuiltImage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuiltImage(o[0]);
  checkBuiltImage(o[1]);
}
...
buildResults() {
  ...
  if (buildCounterResults < 3) {
    ...
    o.buildStepImages = buildUnnamed3327();
    o.buildStepOutputs = buildUnnamed3328();
    o.images = buildUnnamed3329();
    o.numArtifacts = "foo";
  }
  buildCounterResults--;
  return o;
...
checkResults(api.Results o) {
  ...
  if (buildCounterResults < 3) {
    ...
    checkUnnamed3327(o.buildStepImages);
    checkUnnamed3328(o.buildStepOutputs);
    checkUnnamed3329(o.images);
...
checkUnnamed3330(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed3331(core.Map<core.String, api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileHashes(o["x"]);
  checkFileHashes(o["y"]);
}
