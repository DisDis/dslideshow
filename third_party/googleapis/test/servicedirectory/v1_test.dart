...
api.Endpoint buildEndpoint() {
  ...
  if (buildCounterEndpoint < 3) {
    o.address = 'foo';
    o.annotations = buildUnnamed2873();
    o.name = 'foo';
    o.port = 42;
  }
  buildCounterEndpoint--;
...
void checkEndpoint(api.Endpoint o) {
  ...
  if (buildCounterEndpoint < 3) {
    ...
    checkUnnamed2873(o.annotations!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.Endpoint> buildUnnamed2874() {
  var o = <api.Endpoint>[];
  o.add(buildEndpoint());
  o.add(buildEndpoint());
  return o;
...
void checkUnnamed2874(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Location> buildUnnamed2875() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed2875(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Namespace> buildUnnamed2876() {
  var o = <api.Namespace>[];
...
void checkUnnamed2876(core.List<api.Namespace> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Service> buildUnnamed2877() {
  var o = <api.Service>[];
  o.add(buildService());
  o.add(buildService());
  return o;
...
void checkUnnamed2877(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed2879() {
...
void checkUnnamed2879(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Binding> buildUnnamed2881() {
  var o = <api.Binding>[];
  o.add(buildBinding());
  o.add(buildBinding());
  return o;
...
void checkUnnamed2881(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Endpoint> buildUnnamed2883() {
  var o = <api.Endpoint>[];
  o.add(buildEndpoint());
  o.add(buildEndpoint());
  return o;
...
void checkUnnamed2883(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0] as api.Endpoint);
  checkEndpoint(o[1] as api.Endpoint);
}
...
api.Service buildService() {
  ...
  if (buildCounterService < 3) {
    o.annotations = buildUnnamed2882();
    o.endpoints = buildUnnamed2883();
    o.name = 'foo';
  }
  buildCounterService--;
  return o;
...
void checkService(api.Service o) {
  buildCounterService++;
  if (buildCounterService < 3) {
    checkUnnamed2882(o.annotations!);
    checkUnnamed2883(o.endpoints!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
