...
core.List<api.Operation> buildUnnamed5900() {
  var o = <api.Operation>[];
...
void checkUnnamed5900(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed5901();
    o.name = 'foo';
    o.response = buildUnnamed5902();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed5901(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed5902(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed5904() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed5903());
  o.add(buildUnnamed5903());
  return o;
}

void checkUnnamed5904(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5903(o[0]);
  checkUnnamed5903(o[1]);
}
