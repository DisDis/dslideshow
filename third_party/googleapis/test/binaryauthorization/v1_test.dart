...
api.AdmissionRule buildAdmissionRule() {
  ...
  if (buildCounterAdmissionRule < 3) {
    ...
    o.requireAttestationsBy = buildUnnamed2817();
  }
  buildCounterAdmissionRule--;
  return o;
}
...
void checkAdmissionRule(api.AdmissionRule o) {
  ...
  if (buildCounterAdmissionRule < 3) {
    ...
    checkUnnamed2817(o.requireAttestationsBy!);
  }
  buildCounterAdmissionRule--;
}
...
core.List<api.Jwt> buildUnnamed2818() {
  var o = <api.Jwt>[];
  o.add(buildJwt());
  o.add(buildJwt());
  return o;
...
void checkUnnamed2818(core.List<api.Jwt> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJwt(o[0] as api.Jwt);
  checkJwt(o[1] as api.Jwt);
}

core.List<api.Signature> buildUnnamed2819() {
  var o = <api.Signature>[];
...
void checkUnnamed2819(core.List<api.Signature> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AttestationOccurrence buildAttestationOccurrence() {
  ...
  if (buildCounterAttestationOccurrence < 3) {
    o.jwts = buildUnnamed2818();
    o.serializedPayload = 'foo';
    o.signatures = buildUnnamed2819();
  }
  buildCounterAttestationOccurrence--;
  return o;
}
...
void checkAttestationOccurrence(api.AttestationOccurrence o) {
  buildCounterAttestationOccurrence++;
  if (buildCounterAttestationOccurrence < 3) {
    checkUnnamed2818(o.jwts!);
    unittest.expect(
      o.serializedPayload!,
      unittest.equals('foo'),
    );
    checkUnnamed2819(o.signatures!);
  }
  buildCounterAttestationOccurrence--;
}
...
core.List<api.Binding> buildUnnamed2821() {
  var o = <api.Binding>[];
  o.add(buildBinding());
  o.add(buildBinding());
  return o;
...
void checkUnnamed2821(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Attestor> buildUnnamed2822() {
  var o = <api.Attestor>[];
  o.add(buildAttestor());
  o.add(buildAttestor());
  return o;
...
void checkUnnamed2822(core.List<api.Attestor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AdmissionWhitelistPattern> buildUnnamed2823() {
  var o = <api.AdmissionWhitelistPattern>[];
...
void checkUnnamed2823(core.List<api.AdmissionWhitelistPattern> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.AdmissionRule> buildUnnamed2824() {
...
void checkUnnamed2824(core.Map<core.String, api.AdmissionRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdmissionRule(o['x']! as api.AdmissionRule);
  checkAdmissionRule(o['y']! as api.AdmissionRule);
}

core.Map<core.String, api.AdmissionRule> buildUnnamed2825() {
  var o = <core.String, api.AdmissionRule>{};
  o['x'] = buildAdmissionRule();
  o['y'] = buildAdmissionRule();
  return o;
...
void checkUnnamed2825(core.Map<core.String, api.AdmissionRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdmissionRule(o['x']! as api.AdmissionRule);
  checkAdmissionRule(o['y']! as api.AdmissionRule);
}

core.Map<core.String, api.AdmissionRule> buildUnnamed2826() {
  var o = <core.String, api.AdmissionRule>{};
  o['x'] = buildAdmissionRule();
  o['y'] = buildAdmissionRule();
  return o;
...
void checkUnnamed2826(core.Map<core.String, api.AdmissionRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdmissionRule(o['x']! as api.AdmissionRule);
  checkAdmissionRule(o['y']! as api.AdmissionRule);
}

core.Map<core.String, api.AdmissionRule> buildUnnamed2827() {
  var o = <core.String, api.AdmissionRule>{};
  o['x'] = buildAdmissionRule();
  o['y'] = buildAdmissionRule();
  return o;
...
void checkUnnamed2827(core.Map<core.String, api.AdmissionRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdmissionRule(o['x']! as api.AdmissionRule);
  checkAdmissionRule(o['y']! as api.AdmissionRule);
}
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.admissionWhitelistPatterns = buildUnnamed2823();
    o.clusterAdmissionRules = buildUnnamed2824();
    o.defaultAdmissionRule = buildAdmissionRule();
    o.description = 'foo';
    o.globalPolicyEvaluationMode = 'foo';
    o.istioServiceIdentityAdmissionRules = buildUnnamed2825();
    o.kubernetesNamespaceAdmissionRules = buildUnnamed2826();
    o.kubernetesServiceAccountAdmissionRules = buildUnnamed2827();
    o.name = 'foo';
    o.updateTime = 'foo';
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed2823(o.admissionWhitelistPatterns!);
    checkUnnamed2824(o.clusterAdmissionRules!);
    ...
    checkUnnamed2825(o.istioServiceIdentityAdmissionRules!);
    checkUnnamed2826(o.kubernetesNamespaceAdmissionRules!);
    checkUnnamed2827(o.kubernetesServiceAccountAdmissionRules!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
api.TestIamPermissionsRequest buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed2828();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
void checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed2828(o.permissions!);
  }
  buildCounterTestIamPermissionsRequest--;
}
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed2829();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed2829(o.permissions!);
  }
  buildCounterTestIamPermissionsResponse--;
}

core.List<api.AttestorPublicKey> buildUnnamed2830() {
  var o = <api.AttestorPublicKey>[];
...
void checkUnnamed2830(core.List<api.AttestorPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
