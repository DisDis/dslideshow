...
checkUnnamed3246(core.List<api.User> o) {
...
buildComment() {
  ...
  if (buildCounterComment < 3) {
    ...
    o.mentionedUsers = buildUnnamed3246();
    o.post = buildPost();
...
checkComment(api.Comment o) {
  ...
  if (buildCounterComment < 3) {
    ...
    checkUnnamed3246(o.mentionedUsers);
    checkPost(o.post);
...
checkUnnamed3247(core.List<api.Action> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAction(o[0]);
  checkAction(o[1]);
}
...
checkUnnamed3248(core.List<api.Actor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActor(o[0]);
  checkActor(o[1]);
}
...
checkUnnamed3249(core.List<api.Target> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTarget(o[0]);
  checkTarget(o[1]);
}
...
buildDriveActivity() {
  ...
  if (buildCounterDriveActivity < 3) {
    o.actions = buildUnnamed3247();
    o.actors = buildUnnamed3248();
    o.primaryActionDetail = buildActionDetail();
    o.targets = buildUnnamed3249();
    o.timeRange = buildTimeRange();
    o.timestamp = "foo";
  }
  buildCounterDriveActivity--;
...
checkDriveActivity(api.DriveActivity o) {
  buildCounterDriveActivity++;
  if (buildCounterDriveActivity < 3) {
    checkUnnamed3247(o.actions);
    checkUnnamed3248(o.actors);
    checkActionDetail(o.primaryActionDetail);
    checkUnnamed3249(o.targets);
    checkTimeRange(o.timeRange);
    unittest.expect(o.timestamp, unittest.equals('foo'));
  }
  buildCounterDriveActivity--;
...
checkUnnamed3250(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3251(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetReference(o[0]);
  checkTargetReference(o[1]);
}
...
buildMove() {
  ...
  if (buildCounterMove < 3) {
    o.addedParents = buildUnnamed3250();
    o.removedParents = buildUnnamed3251();
  }
  buildCounterMove--;
  return o;
}
...
checkMove(api.Move o) {
  buildCounterMove++;
  if (buildCounterMove < 3) {
    checkUnnamed3250(o.addedParents);
    checkUnnamed3251(o.removedParents);
  }
  buildCounterMove--;
}
...
checkUnnamed3252(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
checkUnnamed3253(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
buildPermissionChange() {
  ...
  if (buildCounterPermissionChange < 3) {
    o.addedPermissions = buildUnnamed3252();
    o.removedPermissions = buildUnnamed3253();
  }
  buildCounterPermissionChange--;
  return o;
}
...
checkPermissionChange(api.PermissionChange o) {
  buildCounterPermissionChange++;
  if (buildCounterPermissionChange < 3) {
    checkUnnamed3252(o.addedPermissions);
    checkUnnamed3253(o.removedPermissions);
  }
  buildCounterPermissionChange--;
}
...
checkUnnamed3254(core.List<api.DriveActivity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3255(core.List<api.RestrictionChange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSettingsChange() {
  ...
  if (buildCounterSettingsChange < 3) {
    o.restrictionChanges = buildUnnamed3255();
  }
  buildCounterSettingsChange--;
  return o;
}
...
checkSettingsChange(api.SettingsChange o) {
  buildCounterSettingsChange++;
  if (buildCounterSettingsChange < 3) {
    checkUnnamed3255(o.restrictionChanges);
  }
  buildCounterSettingsChange--;
}
