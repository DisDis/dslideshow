...
core.List<api.User> buildUnnamed5258() {
  var o = <api.User>[];
  o.add(buildUser());
  o.add(buildUser());
  return o;
...
void checkUnnamed5258(core.List<api.User> o) {
...
api.Comment buildComment() {
  ...
  if (buildCounterComment < 3) {
    ...
    o.mentionedUsers = buildUnnamed5258();
    o.post = buildPost();
...
void checkComment(api.Comment o) {
  ...
  if (buildCounterComment < 3) {
    ...
    checkUnnamed5258(o.mentionedUsers!);
...
core.List<api.Action> buildUnnamed5259() {
  var o = <api.Action>[];
  o.add(buildAction());
  o.add(buildAction());
  return o;
...
void checkUnnamed5259(core.List<api.Action> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAction(o[0] as api.Action);
  checkAction(o[1] as api.Action);
}

core.List<api.Actor> buildUnnamed5260() {
  var o = <api.Actor>[];
  o.add(buildActor());
  o.add(buildActor());
  return o;
...
void checkUnnamed5260(core.List<api.Actor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActor(o[0] as api.Actor);
  checkActor(o[1] as api.Actor);
}

core.List<api.Target> buildUnnamed5261() {
  var o = <api.Target>[];
  o.add(buildTarget());
  o.add(buildTarget());
  return o;
...
void checkUnnamed5261(core.List<api.Target> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DriveActivity buildDriveActivity() {
  ...
  if (buildCounterDriveActivity < 3) {
    o.actions = buildUnnamed5259();
    o.actors = buildUnnamed5260();
    o.primaryActionDetail = buildActionDetail();
    o.targets = buildUnnamed5261();
    o.timeRange = buildTimeRange();
    o.timestamp = 'foo';
  }
  buildCounterDriveActivity--;
...
void checkDriveActivity(api.DriveActivity o) {
  buildCounterDriveActivity++;
  if (buildCounterDriveActivity < 3) {
    checkUnnamed5259(o.actions!);
    checkUnnamed5260(o.actors!);
    checkActionDetail(o.primaryActionDetail! as api.ActionDetail);
    checkUnnamed5261(o.targets!);
    checkTimeRange(o.timeRange! as api.TimeRange);
    unittest.expect(
      o.timestamp!,
      unittest.equals('foo'),
...
core.List<api.TargetReference> buildUnnamed5262() {
...
void checkUnnamed5262(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetReference(o[0] as api.TargetReference);
  checkTargetReference(o[1] as api.TargetReference);
}

core.List<api.TargetReference> buildUnnamed5263() {
  var o = <api.TargetReference>[];
  o.add(buildTargetReference());
  o.add(buildTargetReference());
  return o;
...
void checkUnnamed5263(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetReference(o[0] as api.TargetReference);
  checkTargetReference(o[1] as api.TargetReference);
}
...
api.Move buildMove() {
  ...
  if (buildCounterMove < 3) {
    o.addedParents = buildUnnamed5262();
    o.removedParents = buildUnnamed5263();
  }
  buildCounterMove--;
  return o;
}
...
void checkMove(api.Move o) {
  buildCounterMove++;
  if (buildCounterMove < 3) {
    checkUnnamed5262(o.addedParents!);
    checkUnnamed5263(o.removedParents!);
  }
  buildCounterMove--;
}
...
core.List<api.Permission> buildUnnamed5264() {
  var o = <api.Permission>[];
...
void checkUnnamed5264(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0] as api.Permission);
  checkPermission(o[1] as api.Permission);
}

core.List<api.Permission> buildUnnamed5265() {
  var o = <api.Permission>[];
  o.add(buildPermission());
  o.add(buildPermission());
  return o;
...
void checkUnnamed5265(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0] as api.Permission);
  checkPermission(o[1] as api.Permission);
}
...
api.PermissionChange buildPermissionChange() {
  ...
  if (buildCounterPermissionChange < 3) {
    o.addedPermissions = buildUnnamed5264();
    o.removedPermissions = buildUnnamed5265();
  }
  buildCounterPermissionChange--;
  return o;
}
...
void checkPermissionChange(api.PermissionChange o) {
  buildCounterPermissionChange++;
  if (buildCounterPermissionChange < 3) {
    checkUnnamed5264(o.addedPermissions!);
    checkUnnamed5265(o.removedPermissions!);
  }
  buildCounterPermissionChange--;
}
...
core.List<api.DriveActivity> buildUnnamed5266() {
  var o = <api.DriveActivity>[];
...
void checkUnnamed5266(core.List<api.DriveActivity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.RestrictionChange> buildUnnamed5267() {
  var o = <api.RestrictionChange>[];
...
void checkUnnamed5267(core.List<api.RestrictionChange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SettingsChange buildSettingsChange() {
  ...
  if (buildCounterSettingsChange < 3) {
    o.restrictionChanges = buildUnnamed5267();
  }
  buildCounterSettingsChange--;
  return o;
}
...
void checkSettingsChange(api.SettingsChange o) {
  buildCounterSettingsChange++;
  if (buildCounterSettingsChange < 3) {
    checkUnnamed5267(o.restrictionChanges!);
  }
  buildCounterSettingsChange--;
}
