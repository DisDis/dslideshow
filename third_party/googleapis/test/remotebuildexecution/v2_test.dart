...
core.List<api.BuildBazelRemoteExecutionV2OutputDirectory> buildUnnamed1869() {
...
core.List<api.BuildBazelRemoteExecutionV2OutputSymlink> buildUnnamed1870() {
...
core.List<api.BuildBazelRemoteExecutionV2OutputSymlink> buildUnnamed1871() {
  var o = <api.BuildBazelRemoteExecutionV2OutputSymlink>[];
  o.add(buildBuildBazelRemoteExecutionV2OutputSymlink());
  o.add(buildBuildBazelRemoteExecutionV2OutputSymlink());
  return o;
...
core.List<api.BuildBazelRemoteExecutionV2OutputFile> buildUnnamed1872() {
...
void checkUnnamed1872(core.List<api.BuildBazelRemoteExecutionV2OutputFile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.BuildBazelRemoteExecutionV2OutputSymlink> buildUnnamed1873() {
  var o = <api.BuildBazelRemoteExecutionV2OutputSymlink>[];
  o.add(buildBuildBazelRemoteExecutionV2OutputSymlink());
  o.add(buildBuildBazelRemoteExecutionV2OutputSymlink());
  return o;
...
api.BuildBazelRemoteExecutionV2ActionResult
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ActionResult < 3) {
    ...
    o.exitCode = 42;
    o.outputDirectories = buildUnnamed1869();
    o.outputDirectorySymlinks = buildUnnamed1870();
    o.outputFileSymlinks = buildUnnamed1871();
    o.outputFiles = buildUnnamed1872();
    o.outputSymlinks = buildUnnamed1873();
...
void checkBuildBazelRemoteExecutionV2ActionResult(
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ActionResult < 3) {
    ...
    checkUnnamed1869(o.outputDirectories!);
    checkUnnamed1870(o.outputDirectorySymlinks!);
    checkUnnamed1871(o.outputFileSymlinks!);
    checkUnnamed1872(o.outputFiles!);
    checkUnnamed1873(o.outputSymlinks!);
    checkBuildBazelRemoteExecutionV2Digest(
...
core.List<api.BuildBazelRemoteExecutionV2Digest> buildUnnamed1874() {
...
void checkUnnamed1874(core.List<api.BuildBazelRemoteExecutionV2Digest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildBazelRemoteExecutionV2Digest(
...
api.BuildBazelRemoteExecutionV2CacheCapabilities
  ...
  if (buildCounterBuildBazelRemoteExecutionV2CacheCapabilities < 3) {
    ...
    o.digestFunction = buildUnnamed1878();
...
void checkBuildBazelRemoteExecutionV2CacheCapabilities(
  ...
  if (buildCounterBuildBazelRemoteExecutionV2CacheCapabilities < 3) {
    ...
    checkUnnamed1878(o.digestFunction!);
    unittest.expect(
...
api.BuildBazelRemoteExecutionV2Command
  ...
  if (buildCounterBuildBazelRemoteExecutionV2Command < 3) {
    o.arguments = buildUnnamed1879();
    o.environmentVariables = buildUnnamed1880();
    o.outputDirectories = buildUnnamed1881();
    o.outputFiles = buildUnnamed1882();
    o.outputNodeProperties = buildUnnamed1883();
    o.outputPaths = buildUnnamed1884();
    o.platform = buildBuildBazelRemoteExecutionV2Platform();
...
void checkBuildBazelRemoteExecutionV2Command(
  ...
  buildCounterBuildBazelRemoteExecutionV2Command++;
  if (buildCounterBuildBazelRemoteExecutionV2Command < 3) {
    checkUnnamed1879(o.arguments!);
    checkUnnamed1880(o.environmentVariables!);
    checkUnnamed1881(o.outputDirectories!);
    checkUnnamed1882(o.outputFiles!);
    checkUnnamed1883(o.outputNodeProperties!);
    checkUnnamed1884(o.outputPaths!);
    checkBuildBazelRemoteExecutionV2Platform(
        o.platform! as api.BuildBazelRemoteExecutionV2Platform);
    unittest.expect(
      o.workingDirectory!,
...
core.List<api.BuildBazelRemoteExecutionV2DirectoryNode> buildUnnamed1885() {
...
core.List<api.BuildBazelRemoteExecutionV2FileNode> buildUnnamed1886() {
...
void checkUnnamed1886(core.List<api.BuildBazelRemoteExecutionV2FileNode> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.BuildBazelRemoteExecutionV2SymlinkNode> buildUnnamed1887() {
...
void checkUnnamed1887(core.List<api.BuildBazelRemoteExecutionV2SymlinkNode> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BuildBazelRemoteExecutionV2Directory
  ...
  if (buildCounterBuildBazelRemoteExecutionV2Directory < 3) {
    o.directories = buildUnnamed1885();
    o.files = buildUnnamed1886();
    o.nodeProperties = buildBuildBazelRemoteExecutionV2NodeProperties();
    o.symlinks = buildUnnamed1887();
  }
  buildCounterBuildBazelRemoteExecutionV2Directory--;
  return o;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed1890() {
...
void checkUnnamed1890(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BuildBazelRemoteExecutionV2ExecutedActionMetadata
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ExecutedActionMetadata < 3) {
    o.auxiliaryMetadata = buildUnnamed1890();
...
void checkBuildBazelRemoteExecutionV2ExecutedActionMetadata(
  ...
  buildCounterBuildBazelRemoteExecutionV2ExecutedActionMetadata++;
  if (buildCounterBuildBazelRemoteExecutionV2ExecutedActionMetadata < 3) {
    checkUnnamed1890(o.auxiliaryMetadata!);
    unittest.expect(
...
api.BuildBazelRemoteExecutionV2ExecutionCapabilities
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ExecutionCapabilities < 3) {
    ...
    o.executionPriorityCapabilities =
        buildBuildBazelRemoteExecutionV2PriorityCapabilities();
    o.supportedNodeProperties = buildUnnamed1891();
  }
  buildCounterBuildBazelRemoteExecutionV2ExecutionCapabilities--;
  return o;
}
...
void checkBuildBazelRemoteExecutionV2ExecutionCapabilities(
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ExecutionCapabilities < 3) {
    ...
    checkBuildBazelRemoteExecutionV2PriorityCapabilities(
        o.executionPriorityCapabilities!
            as api.BuildBazelRemoteExecutionV2PriorityCapabilities);
    checkUnnamed1891(o.supportedNodeProperties!);
  }
  buildCounterBuildBazelRemoteExecutionV2ExecutionCapabilities--;
}
...
core.List<api.BuildBazelRemoteExecutionV2Digest> buildUnnamed1892() {
  var o = <api.BuildBazelRemoteExecutionV2Digest>[];
  o.add(buildBuildBazelRemoteExecutionV2Digest());
  o.add(buildBuildBazelRemoteExecutionV2Digest());
  return o;
...
void checkUnnamed1892(core.List<api.BuildBazelRemoteExecutionV2Digest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildBazelRemoteExecutionV2Digest(
      o[0] as api.BuildBazelRemoteExecutionV2Digest);
  checkBuildBazelRemoteExecutionV2Digest(
...
api.BuildBazelRemoteExecutionV2FindMissingBlobsRequest
  ...
  if (buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest < 3) {
    o.blobDigests = buildUnnamed1892();
  }
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest--;
  return o;
}
...
void checkBuildBazelRemoteExecutionV2FindMissingBlobsRequest(
  ...
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest++;
  if (buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest < 3) {
    checkUnnamed1892(o.blobDigests!);
  }
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest--;
}

core.List<api.BuildBazelRemoteExecutionV2Digest> buildUnnamed1893() {
  var o = <api.BuildBazelRemoteExecutionV2Digest>[];
  o.add(buildBuildBazelRemoteExecutionV2Digest());
  o.add(buildBuildBazelRemoteExecutionV2Digest());
  return o;
...
void checkUnnamed1893(core.List<api.BuildBazelRemoteExecutionV2Digest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildBazelRemoteExecutionV2Digest(
      o[0] as api.BuildBazelRemoteExecutionV2Digest);
  checkBuildBazelRemoteExecutionV2Digest(
...
api.BuildBazelRemoteExecutionV2FindMissingBlobsResponse
  ...
  if (buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse < 3) {
    o.missingBlobDigests = buildUnnamed1893();
  }
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse--;
  return o;
}
...
void checkBuildBazelRemoteExecutionV2FindMissingBlobsResponse(
  ...
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse++;
  if (buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse < 3) {
    checkUnnamed1893(o.missingBlobDigests!);
  }
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse--;
}

core.List<api.BuildBazelRemoteExecutionV2Directory> buildUnnamed1894() {
  var o = <api.BuildBazelRemoteExecutionV2Directory>[];
...
void checkUnnamed1894(core.List<api.BuildBazelRemoteExecutionV2Directory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BuildBazelRemoteExecutionV2GetTreeResponse
  ...
  if (buildCounterBuildBazelRemoteExecutionV2GetTreeResponse < 3) {
    o.directories = buildUnnamed1894();
    o.nextPageToken = 'foo';
  }
  buildCounterBuildBazelRemoteExecutionV2GetTreeResponse--;
  return o;
...
void checkBuildBazelRemoteExecutionV2GetTreeResponse(
  ...
  buildCounterBuildBazelRemoteExecutionV2GetTreeResponse++;
  if (buildCounterBuildBazelRemoteExecutionV2GetTreeResponse < 3) {
    checkUnnamed1894(o.directories!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.BuildBazelRemoteExecutionV2NodeProperty> buildUnnamed1895() {
...
core.List<api.BuildBazelRemoteExecutionV2PlatformProperty> buildUnnamed1896() {
...
core.List<api.BuildBazelRemoteExecutionV2Directory> buildUnnamed1898() {
  var o = <api.BuildBazelRemoteExecutionV2Directory>[];
  o.add(buildBuildBazelRemoteExecutionV2Directory());
  o.add(buildBuildBazelRemoteExecutionV2Directory());
  return o;
...
void checkUnnamed1898(core.List<api.BuildBazelRemoteExecutionV2Directory> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildBazelRemoteExecutionV2Directory(
      o[0] as api.BuildBazelRemoteExecutionV2Directory);
  checkBuildBazelRemoteExecutionV2Directory(
...
api.GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature
  ...
  if (buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature <
      3) {
    o.allowedValues = buildUnnamed1899();
    o.policy = 'foo';
  }
  buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature--;
  return o;
...
void checkGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature(
  ...
  if (buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature <
      3) {
    checkUnnamed1899(o.allowedValues!);
    unittest.expect(
      o.policy!,
      unittest.equals('foo'),
    );
...
api.GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse
  ...
  if (buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse <
      3) {
    o.workerPools = buildUnnamed1901();
  }
  buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse--;
  return o;
}
...
void checkGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse(
  ...
  if (buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse <
      3) {
    checkUnnamed1901(o.workerPools!);
  }
  buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse--;
}
...
core.Map<core.String, core.String> buildUnnamed1902() {
...
void checkUnnamed1902(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<core.Map<core.String, core.Object>> buildUnnamed1904() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed1903());
  o.add(buildUnnamed1903());
  return o;
}

void checkUnnamed1904(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1903(o[0]);
  checkUnnamed1903(o[1]);
}
...
core.List<api.GoogleDevtoolsRemoteworkersV1test2Digest> buildUnnamed1907() {
...
core.List<api.GoogleDevtoolsRemoteworkersV1test2Blob> buildUnnamed1908() {
  var o = <api.GoogleDevtoolsRemoteworkersV1test2Blob>[];
...
void checkUnnamed1908(core.List<api.GoogleDevtoolsRemoteworkersV1test2Blob> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs
  ...
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs < 3) {
    o.arguments = buildUnnamed1905();
    o.environmentVariables = buildUnnamed1906();
    o.files = buildUnnamed1907();
    o.inlineBlobs = buildUnnamed1908();
    o.workingDirectory = 'foo';
  }
  buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs--;
  return o;
...
void checkGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs(
  ...
  buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs++;
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs < 3) {
    checkUnnamed1905(o.arguments!);
    checkUnnamed1906(o.environmentVariables!);
    checkUnnamed1907(o.files!);
    checkUnnamed1908(o.inlineBlobs!);
    unittest.expect(
      o.workingDirectory!,
      unittest.equals('foo'),
    );
...
api.GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs
  ...
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs < 3) {
    o.directories = buildUnnamed1909();
    o.files = buildUnnamed1910();
...
void checkGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs(
  ...
  buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs++;
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs < 3) {
    checkUnnamed1909(o.directories!);
    checkUnnamed1910(o.files!);
    unittest.expect(
      o.stderrDestination!,
      unittest.equals('foo'),
    );
...
api.GoogleDevtoolsRemoteworkersV1test2Directory
  ...
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2Directory < 3) {
    o.directories = buildUnnamed1911();
    o.files = buildUnnamed1912();
  }
  buildCounterGoogleDevtoolsRemoteworkersV1test2Directory--;
  return o;
}
...
void checkGoogleDevtoolsRemoteworkersV1test2Directory(
  ...
  buildCounterGoogleDevtoolsRemoteworkersV1test2Directory++;
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2Directory < 3) {
    checkUnnamed1911(o.directories!);
    checkUnnamed1912(o.files!);
  }
  buildCounterGoogleDevtoolsRemoteworkersV1test2Directory--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed1916() {
  var o = <core.Map<core.String, core.Object>>[];
...
void checkUnnamed1916(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('resource-ActionResultsResource', () {
    unittest.test('method--get', () async {
      ...
      var arg_inlineOutputFiles = buildUnnamed1917();
