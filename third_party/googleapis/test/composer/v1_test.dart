...
core.Map<core.String, core.String> buildUnnamed3490() {
...
void checkUnnamed3490(core.Map<core.String, core.String> o) {
...
api.ImageVersion buildImageVersion() {
  ...
  if (buildCounterImageVersion < 3) {
    ...
    o.supportedPythonVersions = buildUnnamed3491();
...
void checkImageVersion(api.ImageVersion o) {
  ...
  if (buildCounterImageVersion < 3) {
    ...
    checkUnnamed3491(o.supportedPythonVersions!);
    unittest.expect(o.upgradeDisabled!, unittest.isTrue);
  }
  buildCounterImageVersion--;
}

core.List<api.Environment> buildUnnamed3492() {
  var o = <api.Environment>[];
...
void checkUnnamed3492(core.List<api.Environment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListEnvironmentsResponse buildListEnvironmentsResponse() {
  ...
  if (buildCounterListEnvironmentsResponse < 3) {
    o.environments = buildUnnamed3492();
    o.nextPageToken = 'foo';
  }
  buildCounterListEnvironmentsResponse--;
  return o;
...
void checkListEnvironmentsResponse(api.ListEnvironmentsResponse o) {
  buildCounterListEnvironmentsResponse++;
  if (buildCounterListEnvironmentsResponse < 3) {
    checkUnnamed3492(o.environments!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.ImageVersion> buildUnnamed3493() {
  var o = <api.ImageVersion>[];
...
void checkUnnamed3493(core.List<api.ImageVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListImageVersionsResponse buildListImageVersionsResponse() {
  ...
  if (buildCounterListImageVersionsResponse < 3) {
    o.imageVersions = buildUnnamed3493();
    o.nextPageToken = 'foo';
  }
  buildCounterListImageVersionsResponse--;
  return o;
...
void checkListImageVersionsResponse(api.ListImageVersionsResponse o) {
  buildCounterListImageVersionsResponse++;
  if (buildCounterListImageVersionsResponse < 3) {
    checkUnnamed3493(o.imageVersions!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Operation> buildUnnamed3494() {
  var o = <api.Operation>[];
...
void checkUnnamed3494(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NodeConfig buildNodeConfig() {
  ...
  if (buildCounterNodeConfig < 3) {
    ...
    o.machineType = 'foo';
    o.network = 'foo';
    o.oauthScopes = buildUnnamed3495();
    o.serviceAccount = 'foo';
    o.subnetwork = 'foo';
    o.tags = buildUnnamed3496();
  }
  buildCounterNodeConfig--;
  return o;
}
...
void checkNodeConfig(api.NodeConfig o) {
  ...
  if (buildCounterNodeConfig < 3) {
    ...
    checkUnnamed3495(o.oauthScopes!);
    unittest.expect(
      o.serviceAccount!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed3496(o.tags!);
  }
  buildCounterNodeConfig--;
}

core.Map<core.String, core.Object> buildUnnamed3497() {
...
void checkUnnamed3497(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed3498() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed3498(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed3497();
    o.name = 'foo';
    o.response = buildUnnamed3498();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed3497(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed3498(o.response!);
  }
  buildCounterOperation--;
}
...
core.Map<core.String, core.String> buildUnnamed3501() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed3501(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.SoftwareConfig buildSoftwareConfig() {
  ...
  if (buildCounterSoftwareConfig < 3) {
    o.airflowConfigOverrides = buildUnnamed3499();
    o.envVariables = buildUnnamed3500();
    o.imageVersion = 'foo';
    o.pypiPackages = buildUnnamed3501();
    o.pythonVersion = 'foo';
  }
  buildCounterSoftwareConfig--;
  return o;
...
void checkSoftwareConfig(api.SoftwareConfig o) {
  buildCounterSoftwareConfig++;
  if (buildCounterSoftwareConfig < 3) {
    checkUnnamed3499(o.airflowConfigOverrides!);
    checkUnnamed3500(o.envVariables!);
    unittest.expect(
      o.imageVersion!,
      unittest.equals('foo'),
    );
    checkUnnamed3501(o.pypiPackages!);
    unittest.expect(
      o.pythonVersion!,
      unittest.equals('foo'),
    );
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3503() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed3502());
  o.add(buildUnnamed3502());
  return o;
}

void checkUnnamed3503(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3502(o[0]);
  checkUnnamed3502(o[1]);
}
...
core.List<api.AllowedIpRange> buildUnnamed3504() {
  var o = <api.AllowedIpRange>[];
...
void checkUnnamed3504(core.List<api.AllowedIpRange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.WebServerNetworkAccessControl buildWebServerNetworkAccessControl() {
  ...
  if (buildCounterWebServerNetworkAccessControl < 3) {
    o.allowedIpRanges = buildUnnamed3504();
  }
  buildCounterWebServerNetworkAccessControl--;
  return o;
}
...
void checkWebServerNetworkAccessControl(api.WebServerNetworkAccessControl o) {
  buildCounterWebServerNetworkAccessControl++;
  if (buildCounterWebServerNetworkAccessControl < 3) {
    checkUnnamed3504(o.allowedIpRanges!);
  }
  buildCounterWebServerNetworkAccessControl--;
}
