...
checkUnnamed1002(core.Map<core.String, core.String> o) {
...
buildImageVersion() {
  ...
  if (buildCounterImageVersion < 3) {
    ...
    o.isDefault = true;
    o.supportedPythonVersions = buildUnnamed1003();
  }
  buildCounterImageVersion--;
  return o;
}
...
checkImageVersion(api.ImageVersion o) {
  ...
  if (buildCounterImageVersion < 3) {
    ...
    checkUnnamed1003(o.supportedPythonVersions);
  }
  buildCounterImageVersion--;
}
...
checkUnnamed1004(core.List<api.Environment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListEnvironmentsResponse() {
  ...
  if (buildCounterListEnvironmentsResponse < 3) {
    o.environments = buildUnnamed1004();
    o.nextPageToken = "foo";
  }
  buildCounterListEnvironmentsResponse--;
  return o;
...
checkListEnvironmentsResponse(api.ListEnvironmentsResponse o) {
  buildCounterListEnvironmentsResponse++;
  if (buildCounterListEnvironmentsResponse < 3) {
    checkUnnamed1004(o.environments);
...
checkUnnamed1005(core.List<api.ImageVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListImageVersionsResponse() {
  ...
  if (buildCounterListImageVersionsResponse < 3) {
    o.imageVersions = buildUnnamed1005();
    o.nextPageToken = "foo";
  }
  buildCounterListImageVersionsResponse--;
  return o;
...
checkListImageVersionsResponse(api.ListImageVersionsResponse o) {
  buildCounterListImageVersionsResponse++;
  if (buildCounterListImageVersionsResponse < 3) {
    checkUnnamed1005(o.imageVersions);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListImageVersionsResponse--;
}
...
checkUnnamed1006(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
buildNodeConfig() {
  ...
  if (buildCounterNodeConfig < 3) {
    ...
    o.machineType = "foo";
    o.network = "foo";
    o.oauthScopes = buildUnnamed1007();
...
checkNodeConfig(api.NodeConfig o) {
  ...
  if (buildCounterNodeConfig < 3) {
    ...
    checkUnnamed1007(o.oauthScopes);
...
checkUnnamed1009(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1010(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed1009();
    o.name = "foo";
    o.response = buildUnnamed1010();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed1009(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1010(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed1013(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildSoftwareConfig() {
  ...
  if (buildCounterSoftwareConfig < 3) {
    o.airflowConfigOverrides = buildUnnamed1011();
    o.envVariables = buildUnnamed1012();
    o.imageVersion = "foo";
    o.pypiPackages = buildUnnamed1013();
    o.pythonVersion = "foo";
  }
  buildCounterSoftwareConfig--;
  return o;
...
checkSoftwareConfig(api.SoftwareConfig o) {
  buildCounterSoftwareConfig++;
  if (buildCounterSoftwareConfig < 3) {
    checkUnnamed1011(o.airflowConfigOverrides);
    checkUnnamed1012(o.envVariables);
    unittest.expect(o.imageVersion, unittest.equals('foo'));
    checkUnnamed1013(o.pypiPackages);
...
checkUnnamed1014(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1015() {
  ...
  o.add(buildUnnamed1014());
  o.add(buildUnnamed1014());
  return o;
}

checkUnnamed1015(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1014(o[0]);
  checkUnnamed1014(o[1]);
}
