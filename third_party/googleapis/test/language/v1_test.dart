...
core.List<api.Entity> buildUnnamed2067() {
  var o = <api.Entity>[];
  o.add(buildEntity());
  o.add(buildEntity());
  return o;
...
void checkUnnamed2067(core.List<api.Entity> o) {
...
core.List<api.Entity> buildUnnamed2068() {
  var o = <api.Entity>[];
  o.add(buildEntity());
  o.add(buildEntity());
  return o;
...
void checkUnnamed2068(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0] as api.Entity);
  checkEntity(o[1] as api.Entity);
}
...
core.List<api.Sentence> buildUnnamed2069() {
  var o = <api.Sentence>[];
  o.add(buildSentence());
  o.add(buildSentence());
  return o;
...
void checkUnnamed2069(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Sentence> buildUnnamed2070() {
  var o = <api.Sentence>[];
  o.add(buildSentence());
  o.add(buildSentence());
  return o;
...
void checkUnnamed2070(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0] as api.Sentence);
  checkSentence(o[1] as api.Sentence);
}

core.List<api.Token> buildUnnamed2071() {
  var o = <api.Token>[];
  o.add(buildToken());
  o.add(buildToken());
  return o;
...
void checkUnnamed2071(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AnalyzeSyntaxResponse buildAnalyzeSyntaxResponse() {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    o.language = 'foo';
    o.sentences = buildUnnamed2070();
    o.tokens = buildUnnamed2071();
  }
  buildCounterAnalyzeSyntaxResponse--;
  return o;
}
...
void checkAnalyzeSyntaxResponse(api.AnalyzeSyntaxResponse o) {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    ...
    checkUnnamed2070(o.sentences!);
    checkUnnamed2071(o.tokens!);
  }
  buildCounterAnalyzeSyntaxResponse--;
}
...
core.List<api.ClassificationCategory> buildUnnamed2072() {
...
void checkUnnamed2072(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Entity> buildUnnamed2073() {
  var o = <api.Entity>[];
  o.add(buildEntity());
  o.add(buildEntity());
  return o;
...
void checkUnnamed2073(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0] as api.Entity);
  checkEntity(o[1] as api.Entity);
}

core.List<api.Sentence> buildUnnamed2074() {
  var o = <api.Sentence>[];
  o.add(buildSentence());
  o.add(buildSentence());
  return o;
...
void checkUnnamed2074(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0] as api.Sentence);
  checkSentence(o[1] as api.Sentence);
}
...
api.AnnotateTextResponse buildAnnotateTextResponse() {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    ...
    o.documentSentiment = buildSentiment();
    o.entities = buildUnnamed2073();
    o.language = 'foo';
    o.sentences = buildUnnamed2074();
    o.tokens = buildUnnamed2075();
  }
  buildCounterAnnotateTextResponse--;
  return o;
}
...
void checkAnnotateTextResponse(api.AnnotateTextResponse o) {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    ...
    checkSentiment(o.documentSentiment! as api.Sentiment);
    checkUnnamed2073(o.entities!);
    unittest.expect(
      o.language!,
      unittest.equals('foo'),
    );
    checkUnnamed2074(o.sentences!);
    checkUnnamed2075(o.tokens!);
  }
  buildCounterAnnotateTextResponse--;
}
...
core.List<api.ClassificationCategory> buildUnnamed2076() {
  var o = <api.ClassificationCategory>[];
  o.add(buildClassificationCategory());
  o.add(buildClassificationCategory());
  return o;
...
void checkUnnamed2076(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClassificationCategory(o[0] as api.ClassificationCategory);
  checkClassificationCategory(o[1] as api.ClassificationCategory);
}
...
core.List<api.EntityMention> buildUnnamed2077() {
...
void checkUnnamed2077(core.List<api.EntityMention> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntityMention(o[0] as api.EntityMention);
  checkEntityMention(o[1] as api.EntityMention);
}

core.Map<core.String, core.String> buildUnnamed2078() {
...
void checkUnnamed2078(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.Object> buildUnnamed2079() {
...
void checkUnnamed2079(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed2080() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed2079());
  o.add(buildUnnamed2079());
  return o;
}

void checkUnnamed2080(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2079(o[0]);
  checkUnnamed2079(o[1]);
}
