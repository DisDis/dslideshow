...
checkUnnamed3165(core.List<api.MobileFriendlyIssue> o) {
...
checkUnnamed3166(core.List<api.ResourceIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRunMobileFriendlyTestResponse() {
  ...
  if (buildCounterRunMobileFriendlyTestResponse < 3) {
    ...
    o.mobileFriendlyIssues = buildUnnamed3165();
    o.resourceIssues = buildUnnamed3166();
...
checkRunMobileFriendlyTestResponse(api.RunMobileFriendlyTestResponse o) {
  ...
  if (buildCounterRunMobileFriendlyTestResponse < 3) {
    ...
    checkUnnamed3165(o.mobileFriendlyIssues);
    checkUnnamed3166(o.resourceIssues);
