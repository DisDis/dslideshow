...
core.List<core.double> buildUnnamed4489() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed4489(core.List<core.double> o) {
...
core.List<api.LogBucket> buildUnnamed4490() {
  var o = <api.LogBucket>[];
...
void checkUnnamed4490(core.List<api.LogBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LogExclusion> buildUnnamed4491() {
...
void checkUnnamed4491(core.List<api.LogExclusion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Location> buildUnnamed4492() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed4492(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListLogEntriesRequest buildListLogEntriesRequest() {
  ...
  if (buildCounterListLogEntriesRequest < 3) {
    ...
    o.pageSize = 42;
    o.pageToken = 'foo';
    o.projectIds = buildUnnamed4493();
    o.resourceNames = buildUnnamed4494();
  }
  buildCounterListLogEntriesRequest--;
  return o;
}
...
void checkListLogEntriesRequest(api.ListLogEntriesRequest o) {
  ...
  if (buildCounterListLogEntriesRequest < 3) {
    ...
    checkUnnamed4493(o.projectIds!);
    checkUnnamed4494(o.resourceNames!);
  }
  buildCounterListLogEntriesRequest--;
}

core.List<api.LogEntry> buildUnnamed4495() {
  var o = <api.LogEntry>[];
  o.add(buildLogEntry());
  o.add(buildLogEntry());
  return o;
...
void checkUnnamed4495(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LogMetric> buildUnnamed4496() {
  var o = <api.LogMetric>[];
...
void checkUnnamed4496(core.List<api.LogMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MonitoredResourceDescriptor> buildUnnamed4498() {
...
void checkUnnamed4498(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMonitoredResourceDescriptorsResponse
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    o.nextPageToken = 'foo';
    o.resourceDescriptors = buildUnnamed4498();
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
  return o;
}
...
void checkListMonitoredResourceDescriptorsResponse(
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    ...
    checkUnnamed4498(o.resourceDescriptors!);
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
}

core.List<api.LogSink> buildUnnamed4499() {
  var o = <api.LogSink>[];
  o.add(buildLogSink());
  o.add(buildLogSink());
  return o;
...
void checkUnnamed4499(core.List<api.LogSink> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListSinksResponse(api.ListSinksResponse o) {
  ...
  if (buildCounterListSinksResponse < 3) {
    ...
    checkUnnamed4499(o.sinks!);
  }
  buildCounterListSinksResponse--;
}

core.List<api.LogView> buildUnnamed4500() {
  var o = <api.LogView>[];
  o.add(buildLogView());
  o.add(buildLogView());
  return o;
...
void checkUnnamed4500(core.List<api.LogView> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListViewsResponse(api.ListViewsResponse o) {
  ...
  if (buildCounterListViewsResponse < 3) {
    ...
    checkUnnamed4500(o.views!);
  }
  buildCounterListViewsResponse--;
}

core.Map<core.String, core.String> buildUnnamed4501() {
...
void checkUnnamed4501(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.Object> buildUnnamed4503() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed4503(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed4504() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4504(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
void checkLogEntry(api.LogEntry o) {
  ...
  if (buildCounterLogEntry < 3) {
    ...
    checkUnnamed4503(o.jsonPayload!);
    ...
    checkUnnamed4505(o.protoPayload!);
    unittest.expect(
      o.receiveTimestamp!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed4506() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4506(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.LogMetric buildLogMetric() {
  ...
  if (buildCounterLogMetric < 3) {
    ...
    o.description = 'foo';
    o.filter = 'foo';
    o.labelExtractors = buildUnnamed4506();
...
void checkLogMetric(api.LogMetric o) {
  ...
  if (buildCounterLogMetric < 3) {
    ...
    checkUnnamed4506(o.labelExtractors!);
...
core.List<api.LogExclusion> buildUnnamed4507() {
  var o = <api.LogExclusion>[];
  o.add(buildLogExclusion());
  o.add(buildLogExclusion());
  return o;
...
void checkUnnamed4507(core.List<api.LogExclusion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogExclusion(o[0] as api.LogExclusion);
  checkLogExclusion(o[1] as api.LogExclusion);
}
...
core.List<api.LabelDescriptor> buildUnnamed4508() {
  var o = <api.LabelDescriptor>[];
...
void checkUnnamed4508(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MetricDescriptor buildMetricDescriptor() {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    o.metricKind = 'foo';
    o.monitoredResourceTypes = buildUnnamed4509();
    o.name = 'foo';
    o.type = 'foo';
    o.unit = 'foo';
    o.valueType = 'foo';
...
void checkMetricDescriptor(api.MetricDescriptor o) {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    checkUnnamed4509(o.monitoredResourceTypes!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed4510() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4510(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.LabelDescriptor> buildUnnamed4511() {
  var o = <api.LabelDescriptor>[];
  o.add(buildLabelDescriptor());
  o.add(buildLabelDescriptor());
  return o;
...
void checkUnnamed4511(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0] as api.LabelDescriptor);
  checkLabelDescriptor(o[1] as api.LabelDescriptor);
}
...
core.Map<core.String, core.Object> buildUnnamed4512() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed4512(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed4513() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4513(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.MonitoredResourceMetadata buildMonitoredResourceMetadata() {
  ...
  if (buildCounterMonitoredResourceMetadata < 3) {
    o.systemLabels = buildUnnamed4512();
    o.userLabels = buildUnnamed4513();
  }
  buildCounterMonitoredResourceMetadata--;
  return o;
}
...
void checkMonitoredResourceMetadata(api.MonitoredResourceMetadata o) {
  buildCounterMonitoredResourceMetadata++;
  if (buildCounterMonitoredResourceMetadata < 3) {
    checkUnnamed4512(o.systemLabels!);
    checkUnnamed4513(o.userLabels!);
  }
  buildCounterMonitoredResourceMetadata--;
}

core.List<api.LogLine> buildUnnamed4514() {
  var o = <api.LogLine>[];
  o.add(buildLogLine());
  o.add(buildLogLine());
  return o;
...
void checkUnnamed4514(core.List<api.LogLine> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogLine(o[0] as api.LogLine);
  checkLogLine(o[1] as api.LogLine);
}

core.List<api.SourceReference> buildUnnamed4515() {
...
void checkUnnamed4515(core.List<api.SourceReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RequestLog buildRequestLog() {
  ...
  if (buildCounterRequestLog < 3) {
    ...
    o.resource = 'foo';
    o.responseSize = 'foo';
    o.sourceReference = buildUnnamed4515();
    o.startTime = 'foo';
    o.status = 42;
    o.taskName = 'foo';
    o.taskQueueName = 'foo';
...
void checkRequestLog(api.RequestLog o) {
  ...
  if (buildCounterRequestLog < 3) {
    ...
    checkUnnamed4515(o.sourceReference!);
    unittest.expect(
      o.startTime!,
      unittest.equals('foo'),
    );
...
api.TailLogEntriesRequest buildTailLogEntriesRequest() {
  ...
  if (buildCounterTailLogEntriesRequest < 3) {
    o.bufferWindow = 'foo';
    o.filter = 'foo';
    o.resourceNames = buildUnnamed4516();
  }
  buildCounterTailLogEntriesRequest--;
  return o;
}
...
void checkTailLogEntriesRequest(api.TailLogEntriesRequest o) {
  ...
  if (buildCounterTailLogEntriesRequest < 3) {
    ...
    checkUnnamed4516(o.resourceNames!);
  }
  buildCounterTailLogEntriesRequest--;
}

core.List<api.LogEntry> buildUnnamed4517() {
  var o = <api.LogEntry>[];
  o.add(buildLogEntry());
  o.add(buildLogEntry());
  return o;
...
void checkUnnamed4517(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0] as api.LogEntry);
  checkLogEntry(o[1] as api.LogEntry);
}

core.List<api.SuppressionInfo> buildUnnamed4518() {
  var o = <api.SuppressionInfo>[];
...
void checkUnnamed4518(core.List<api.SuppressionInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TailLogEntriesResponse buildTailLogEntriesResponse() {
  ...
  if (buildCounterTailLogEntriesResponse < 3) {
    o.entries = buildUnnamed4517();
    o.suppressionInfo = buildUnnamed4518();
  }
  buildCounterTailLogEntriesResponse--;
  return o;
}
...
void checkTailLogEntriesResponse(api.TailLogEntriesResponse o) {
  buildCounterTailLogEntriesResponse++;
  if (buildCounterTailLogEntriesResponse < 3) {
    checkUnnamed4517(o.entries!);
    checkUnnamed4518(o.suppressionInfo!);
  }
  buildCounterTailLogEntriesResponse--;
}
...
core.List<api.LogEntry> buildUnnamed4519() {
  var o = <api.LogEntry>[];
  o.add(buildLogEntry());
  o.add(buildLogEntry());
  return o;
...
void checkUnnamed4519(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0] as api.LogEntry);
  checkLogEntry(o[1] as api.LogEntry);
}
...
void main() {
  ...
  unittest.group('resource-BillingAccountsLogsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_resourceNames = buildUnnamed4521();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-FoldersLogsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_resourceNames = buildUnnamed4522();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-LogsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_resourceNames = buildUnnamed4523();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-OrganizationsLogsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_resourceNames = buildUnnamed4524();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-ProjectsLogsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_resourceNames = buildUnnamed4525();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
