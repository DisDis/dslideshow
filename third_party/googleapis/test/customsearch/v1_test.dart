...
core.List<api.PromotionBodyLines> buildUnnamed5872() {
  var o = <api.PromotionBodyLines>[];
...
void checkUnnamed5872(core.List<api.PromotionBodyLines> o) {
...
core.List<api.ResultLabels> buildUnnamed5873() {
  var o = <api.ResultLabels>[];
...
void checkUnnamed5873(core.List<api.ResultLabels> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResultLabels(o[0] as api.ResultLabels);
  checkResultLabels(o[1] as api.ResultLabels);
}

core.Map<core.String, core.Object> buildUnnamed5874() {
...
void checkUnnamed5874(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Result buildResult() {
  ...
  if (buildCounterResult < 3) {
    ...
    o.kind = 'foo';
    o.labels = buildUnnamed5873();
    o.link = 'foo';
    o.mime = 'foo';
    o.pagemap = buildUnnamed5874();
    o.snippet = 'foo';
    o.title = 'foo';
  }
  buildCounterResult--;
...
core.List<api.Result> buildUnnamed5876() {
  var o = <api.Result>[];
  o.add(buildResult());
  o.add(buildResult());
  return o;
...
void checkUnnamed5876(core.List<api.Result> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResult(o[0] as api.Result);
  checkResult(o[1] as api.Result);
}

core.List<api.Promotion> buildUnnamed5877() {
  var o = <api.Promotion>[];
...
void checkUnnamed5877(core.List<api.Promotion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SearchQueriesNextPage> buildUnnamed5878() {
  var o = <api.SearchQueriesNextPage>[];
...
void checkUnnamed5878(core.List<api.SearchQueriesNextPage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SearchQueriesPreviousPage> buildUnnamed5879() {
  var o = <api.SearchQueriesPreviousPage>[];
...
void checkUnnamed5879(core.List<api.SearchQueriesPreviousPage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SearchQueriesRequest> buildUnnamed5880() {
  var o = <api.SearchQueriesRequest>[];
...
void checkUnnamed5880(core.List<api.SearchQueriesRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SearchQueries buildSearchQueries() {
  ...
  if (buildCounterSearchQueries < 3) {
    o.nextPage = buildUnnamed5878();
    o.previousPage = buildUnnamed5879();
    o.request = buildUnnamed5880();
  }
  buildCounterSearchQueries--;
  return o;
}
...
void checkSearchQueries(api.SearchQueries o) {
  buildCounterSearchQueries++;
  if (buildCounterSearchQueries < 3) {
    checkUnnamed5878(o.nextPage!);
    checkUnnamed5879(o.previousPage!);
    checkUnnamed5880(o.request!);
  }
  buildCounterSearchQueries--;
}
...
api.Search buildSearch() {
  ...
  if (buildCounterSearch < 3) {
    o.context = buildUnnamed5875();
    o.items = buildUnnamed5876();
    o.kind = 'foo';
    o.promotions = buildUnnamed5877();
...
void checkSearch(api.Search o) {
  buildCounterSearch++;
  if (buildCounterSearch < 3) {
    checkUnnamed5875(o.context!);
    checkUnnamed5876(o.items!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed5877(o.promotions!);
