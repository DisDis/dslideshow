...
checkUnnamed3220(core.List<api.Apk> o) {
...
checkUnnamed3221(core.List<api.Bundle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBundle(o[0]);
  checkBundle(o[1]);
}
...
checkUnnamed3225(core.List<api.ExternallyHostedApkUsesPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildExternallyHostedApk() {
  ...
  if (buildCounterExternallyHostedApk < 3) {
    ...
    o.certificateBase64s = buildUnnamed3222();
    ...
    o.maximumSdk = 42;
    o.minimumSdk = 42;
    o.nativeCodes = buildUnnamed3223();
    o.packageName = "foo";
    o.usesFeatures = buildUnnamed3224();
    o.usesPermissions = buildUnnamed3225();
    o.versionCode = 42;
    o.versionName = "foo";
  }
  buildCounterExternallyHostedApk--;
...
checkExternallyHostedApk(api.ExternallyHostedApk o) {
  ...
  if (buildCounterExternallyHostedApk < 3) {
    ...
    checkUnnamed3222(o.certificateBase64s);
    ...
    checkUnnamed3223(o.nativeCodes);
    unittest.expect(o.packageName, unittest.equals('foo'));
    checkUnnamed3224(o.usesFeatures);
    checkUnnamed3225(o.usesPermissions);
    unittest.expect(o.versionCode, unittest.equals(42));
...
checkUnnamed3226(core.List<api.Image> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImage(o[0]);
  checkImage(o[1]);
}
...
checkUnnamed3227(core.List<api.Image> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImage(o[0]);
  checkImage(o[1]);
}
...
checkUnnamed3228(core.Map<core.String, api.InAppProductListing> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3229(core.Map<core.String, api.Price> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrice(o["x"]);
  checkPrice(o["y"]);
}
...
buildInAppProduct() {
  ...
  if (buildCounterInAppProduct < 3) {
    ...
    o.gracePeriod = "foo";
    o.listings = buildUnnamed3228();
    o.packageName = "foo";
    o.prices = buildUnnamed3229();
    o.purchaseType = "foo";
...
checkInAppProduct(api.InAppProduct o) {
  ...
  if (buildCounterInAppProduct < 3) {
    ...
    checkUnnamed3228(o.listings);
    unittest.expect(o.packageName, unittest.equals('foo'));
    checkUnnamed3229(o.prices);
...
checkUnnamed3230(core.List<api.InAppProduct> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildInappproductsListResponse() {
  ...
  if (buildCounterInappproductsListResponse < 3) {
    o.inappproduct = buildUnnamed3230();
    o.kind = "foo";
...
checkInappproductsListResponse(api.InappproductsListResponse o) {
  buildCounterInappproductsListResponse++;
  if (buildCounterInappproductsListResponse < 3) {
    checkUnnamed3230(o.inappproduct);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed3231(core.List<api.Listing> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkListing(o[0]);
  checkListing(o[1]);
}
...
checkUnnamed3232(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed3233(core.List<api.Review> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReview(o[0]);
  checkReview(o[1]);
}
...
checkUnnamed3234(core.List<api.Prorate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProrate(o[0]);
  checkProrate(o[1]);
}
...
buildTesters() {
  ...
  if (buildCounterTesters < 3) {
    o.googleGroups = buildUnnamed3235();
    o.googlePlusCommunities = buildUnnamed3236();
  }
  buildCounterTesters--;
  return o;
}
...
checkTesters(api.Testers o) {
  buildCounterTesters++;
  if (buildCounterTesters < 3) {
    checkUnnamed3235(o.googleGroups);
    checkUnnamed3236(o.googlePlusCommunities);
  }
  buildCounterTesters--;
}
...
checkUnnamed3237(core.List<api.TrackRelease> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3238(core.List<api.LocalizedText> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTrackRelease() {
  ...
  if (buildCounterTrackRelease < 3) {
    o.name = "foo";
    o.releaseNotes = buildUnnamed3238();
    o.status = "foo";
    o.userFraction = 42.0;
    o.versionCodes = buildUnnamed3239();
  }
  buildCounterTrackRelease--;
  return o;
}
...
checkTrackRelease(api.TrackRelease o) {
  ...
  if (buildCounterTrackRelease < 3) {
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed3238(o.releaseNotes);
    unittest.expect(o.status, unittest.equals('foo'));
    unittest.expect(o.userFraction, unittest.equals(42.0));
    checkUnnamed3239(o.versionCodes);
  }
  buildCounterTrackRelease--;
}
...
checkUnnamed3240(core.List<api.Track> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrack(o[0]);
  checkTrack(o[1]);
}
...
checkUnnamed3241(core.List<api.VoidedPurchase> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVoidedPurchasesListResponse() {
  ...
  if (buildCounterVoidedPurchasesListResponse < 3) {
    o.pageInfo = buildPageInfo();
    o.tokenPagination = buildTokenPagination();
    o.voidedPurchases = buildUnnamed3241();
  }
  buildCounterVoidedPurchasesListResponse--;
  return o;
}
...
checkVoidedPurchasesListResponse(api.VoidedPurchasesListResponse o) {
  ...
  if (buildCounterVoidedPurchasesListResponse < 3) {
    checkPageInfo(o.pageInfo);
    checkTokenPagination(o.tokenPagination);
    checkUnnamed3241(o.voidedPurchases);
  }
  buildCounterVoidedPurchasesListResponse--;
}
