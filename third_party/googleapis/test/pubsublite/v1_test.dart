...
core.List<api.PartitionCursor> buildUnnamed5213() {
...
void checkUnnamed5213(core.List<api.PartitionCursor> o) {
...
api.ListPartitionCursorsResponse buildListPartitionCursorsResponse() {
  ...
  if (buildCounterListPartitionCursorsResponse < 3) {
    o.nextPageToken = 'foo';
    o.partitionCursors = buildUnnamed5213();
  }
  buildCounterListPartitionCursorsResponse--;
  return o;
}
...
void checkListPartitionCursorsResponse(api.ListPartitionCursorsResponse o) {
  ...
  if (buildCounterListPartitionCursorsResponse < 3) {
    ...
    checkUnnamed5213(o.partitionCursors!);
  }
  buildCounterListPartitionCursorsResponse--;
}

core.List<api.Subscription> buildUnnamed5214() {
...
void checkUnnamed5214(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListSubscriptionsResponse buildListSubscriptionsResponse() {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.subscriptions = buildUnnamed5214();
  }
  buildCounterListSubscriptionsResponse--;
  return o;
}
...
void checkListSubscriptionsResponse(api.ListSubscriptionsResponse o) {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    ...
    checkUnnamed5214(o.subscriptions!);
  }
  buildCounterListSubscriptionsResponse--;
}
...
api.ListTopicSubscriptionsResponse buildListTopicSubscriptionsResponse() {
  ...
  if (buildCounterListTopicSubscriptionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.subscriptions = buildUnnamed5215();
  }
  buildCounterListTopicSubscriptionsResponse--;
  return o;
}
...
void checkListTopicSubscriptionsResponse(api.ListTopicSubscriptionsResponse o) {
  ...
  if (buildCounterListTopicSubscriptionsResponse < 3) {
    ...
    checkUnnamed5215(o.subscriptions!);
  }
  buildCounterListTopicSubscriptionsResponse--;
}

core.List<api.Topic> buildUnnamed5216() {
  var o = <api.Topic>[];
  o.add(buildTopic());
  o.add(buildTopic());
  return o;
...
void checkUnnamed5216(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
