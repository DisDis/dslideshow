...
api.BatchModifyMessagesRequest buildBatchModifyMessagesRequest() {
  ...
  if (buildCounterBatchModifyMessagesRequest < 3) {
    o.addLabelIds = buildUnnamed2696();
    o.ids = buildUnnamed2697();
    o.removeLabelIds = buildUnnamed2698();
  }
  buildCounterBatchModifyMessagesRequest--;
  return o;
}
...
void checkBatchModifyMessagesRequest(api.BatchModifyMessagesRequest o) {
  buildCounterBatchModifyMessagesRequest++;
  if (buildCounterBatchModifyMessagesRequest < 3) {
    checkUnnamed2696(o.addLabelIds!);
    checkUnnamed2697(o.ids!);
    checkUnnamed2698(o.removeLabelIds!);
  }
  buildCounterBatchModifyMessagesRequest--;
}
...
api.FilterAction buildFilterAction() {
  ...
  if (buildCounterFilterAction < 3) {
    o.addLabelIds = buildUnnamed2699();
    o.forward = 'foo';
    o.removeLabelIds = buildUnnamed2700();
  }
  buildCounterFilterAction--;
  return o;
}
...
void checkFilterAction(api.FilterAction o) {
  buildCounterFilterAction++;
  if (buildCounterFilterAction < 3) {
    checkUnnamed2699(o.addLabelIds!);
    unittest.expect(
      o.forward!,
      unittest.equals('foo'),
    );
    checkUnnamed2700(o.removeLabelIds!);
  }
  buildCounterFilterAction--;
}
...
core.List<api.HistoryLabelAdded> buildUnnamed2701() {
...
void checkUnnamed2701(core.List<api.HistoryLabelAdded> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHistoryLabelAdded(o[0] as api.HistoryLabelAdded);
  checkHistoryLabelAdded(o[1] as api.HistoryLabelAdded);
}

core.List<api.HistoryLabelRemoved> buildUnnamed2702() {
...
void checkUnnamed2703(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessage(o[0] as api.Message);
  checkMessage(o[1] as api.Message);
}

core.List<api.HistoryMessageAdded> buildUnnamed2704() {
...
void checkUnnamed2705(core.List<api.HistoryMessageDeleted> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.History buildHistory() {
  ...
  if (buildCounterHistory < 3) {
    o.id = 'foo';
    o.labelsAdded = buildUnnamed2701();
    o.labelsRemoved = buildUnnamed2702();
    o.messages = buildUnnamed2703();
    o.messagesAdded = buildUnnamed2704();
    o.messagesDeleted = buildUnnamed2705();
  }
  buildCounterHistory--;
  return o;
}
...
void checkHistory(api.History o) {
  ...
  if (buildCounterHistory < 3) {
    ...
    checkUnnamed2701(o.labelsAdded!);
    checkUnnamed2702(o.labelsRemoved!);
    checkUnnamed2703(o.messages!);
    checkUnnamed2704(o.messagesAdded!);
    checkUnnamed2705(o.messagesDeleted!);
  }
  buildCounterHistory--;
}
...
core.List<api.Delegate> buildUnnamed2708() {
  var o = <api.Delegate>[];
  o.add(buildDelegate());
  o.add(buildDelegate());
  return o;
...
void checkUnnamed2708(core.List<api.Delegate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListDelegatesResponse(api.ListDelegatesResponse o) {
  buildCounterListDelegatesResponse++;
  if (buildCounterListDelegatesResponse < 3) {
    checkUnnamed2708(o.delegates!);
  }
  buildCounterListDelegatesResponse--;
}

core.List<api.Draft> buildUnnamed2709() {
  var o = <api.Draft>[];
  o.add(buildDraft());
  o.add(buildDraft());
  return o;
...
void checkUnnamed2709(core.List<api.Draft> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Filter> buildUnnamed2710() {
  var o = <api.Filter>[];
  o.add(buildFilter());
  o.add(buildFilter());
  return o;
...
void checkUnnamed2710(core.List<api.Filter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListFiltersResponse(api.ListFiltersResponse o) {
  buildCounterListFiltersResponse++;
  if (buildCounterListFiltersResponse < 3) {
    checkUnnamed2710(o.filter!);
  }
  buildCounterListFiltersResponse--;
}

core.List<api.ForwardingAddress> buildUnnamed2711() {
  var o = <api.ForwardingAddress>[];
...
void checkUnnamed2711(core.List<api.ForwardingAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListForwardingAddressesResponse buildListForwardingAddressesResponse() {
  ...
  if (buildCounterListForwardingAddressesResponse < 3) {
    o.forwardingAddresses = buildUnnamed2711();
  }
  buildCounterListForwardingAddressesResponse--;
  return o;
}
...
void checkListForwardingAddressesResponse(
  ...
  buildCounterListForwardingAddressesResponse++;
  if (buildCounterListForwardingAddressesResponse < 3) {
    checkUnnamed2711(o.forwardingAddresses!);
  }
  buildCounterListForwardingAddressesResponse--;
}

core.List<api.History> buildUnnamed2712() {
  var o = <api.History>[];
  o.add(buildHistory());
  o.add(buildHistory());
  return o;
...
void checkUnnamed2712(core.List<api.History> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Label> buildUnnamed2713() {
  var o = <api.Label>[];
  o.add(buildLabel());
  o.add(buildLabel());
  return o;
...
void checkUnnamed2713(core.List<api.Label> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListLabelsResponse(api.ListLabelsResponse o) {
  buildCounterListLabelsResponse++;
  if (buildCounterListLabelsResponse < 3) {
    checkUnnamed2713(o.labels!);
  }
  buildCounterListLabelsResponse--;
}

core.List<api.Message> buildUnnamed2714() {
  var o = <api.Message>[];
  o.add(buildMessage());
  o.add(buildMessage());
  return o;
...
void checkUnnamed2714(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessage(o[0] as api.Message);
  checkMessage(o[1] as api.Message);
}
...
core.List<api.SendAs> buildUnnamed2715() {
  var o = <api.SendAs>[];
  o.add(buildSendAs());
  o.add(buildSendAs());
  return o;
...
void checkUnnamed2715(core.List<api.SendAs> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListSendAsResponse(api.ListSendAsResponse o) {
  buildCounterListSendAsResponse++;
  if (buildCounterListSendAsResponse < 3) {
    checkUnnamed2715(o.sendAs!);
  }
  buildCounterListSendAsResponse--;
}

core.List<api.SmimeInfo> buildUnnamed2716() {
  var o = <api.SmimeInfo>[];
...
void checkUnnamed2716(core.List<api.SmimeInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListSmimeInfoResponse(api.ListSmimeInfoResponse o) {
  buildCounterListSmimeInfoResponse++;
  if (buildCounterListSmimeInfoResponse < 3) {
    checkUnnamed2716(o.smimeInfo!);
  }
  buildCounterListSmimeInfoResponse--;
}

core.List<api.Thread> buildUnnamed2717() {
  var o = <api.Thread>[];
  o.add(buildThread());
  o.add(buildThread());
  return o;
...
void checkUnnamed2717(core.List<api.Thread> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MessagePartHeader> buildUnnamed2719() {
...
void checkUnnamed2720(core.List<api.MessagePart> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MessagePart buildMessagePart() {
  ...
  if (buildCounterMessagePart < 3) {
    ...
    o.filename = 'foo';
    o.headers = buildUnnamed2719();
    o.mimeType = 'foo';
    o.partId = 'foo';
    o.parts = buildUnnamed2720();
  }
  buildCounterMessagePart--;
  return o;
}
...
api.ModifyMessageRequest buildModifyMessageRequest() {
  ...
  if (buildCounterModifyMessageRequest < 3) {
    o.addLabelIds = buildUnnamed2721();
    o.removeLabelIds = buildUnnamed2722();
  }
  buildCounterModifyMessageRequest--;
  return o;
}
...
void checkModifyMessageRequest(api.ModifyMessageRequest o) {
  buildCounterModifyMessageRequest++;
  if (buildCounterModifyMessageRequest < 3) {
    checkUnnamed2721(o.addLabelIds!);
    checkUnnamed2722(o.removeLabelIds!);
  }
  buildCounterModifyMessageRequest--;
}
...
api.ModifyThreadRequest buildModifyThreadRequest() {
  ...
  if (buildCounterModifyThreadRequest < 3) {
    o.addLabelIds = buildUnnamed2723();
    o.removeLabelIds = buildUnnamed2724();
  }
  buildCounterModifyThreadRequest--;
  return o;
}
...
void checkModifyThreadRequest(api.ModifyThreadRequest o) {
  buildCounterModifyThreadRequest++;
  if (buildCounterModifyThreadRequest < 3) {
    checkUnnamed2723(o.addLabelIds!);
    checkUnnamed2724(o.removeLabelIds!);
  }
  buildCounterModifyThreadRequest--;
}
...
core.List<api.Message> buildUnnamed2725() {
  var o = <api.Message>[];
  o.add(buildMessage());
  o.add(buildMessage());
  return o;
...
void checkUnnamed2725(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessage(o[0] as api.Message);
  checkMessage(o[1] as api.Message);
}
...
void main() {
  ...
  unittest.group('resource-UsersHistoryResource', () {
    unittest.test('method--list', () async {
      ...
      var arg_userId = 'foo';
      var arg_historyTypes = buildUnnamed2727();
      var arg_labelId = 'foo';
      var arg_maxResults = 42;
      var arg_pageToken = 'foo';
  ...
  unittest.group('resource-UsersMessagesResource', () {
    ...
    unittest.test('method--get', () async {
      ...
      var arg_id = 'foo';
      var arg_format = 'foo';
      var arg_metadataHeaders = buildUnnamed2728();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test('method--list', () async {
      ...
      var arg_userId = 'foo';
      var arg_includeSpamTrash = true;
      var arg_labelIds = buildUnnamed2729();
      var arg_maxResults = 42;
      var arg_pageToken = 'foo';
      var arg_q = 'foo';
      var arg_$fields = 'foo';
  ...
  unittest.group('resource-UsersThreadsResource', () {
    ...
    unittest.test('method--get', () async {
      ...
      var arg_id = 'foo';
      var arg_format = 'foo';
      var arg_metadataHeaders = buildUnnamed2730();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test('method--list', () async {
      ...
      var arg_userId = 'foo';
      var arg_includeSpamTrash = true;
      var arg_labelIds = buildUnnamed2731();
      var arg_maxResults = 42;
      var arg_pageToken = 'foo';
      var arg_q = 'foo';
      var arg_$fields = 'foo';
