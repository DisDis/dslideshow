...
checkUnnamed1612(core.Map<core.String, core.String> o) {
...
checkUnnamed1614(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
buildListMembershipsResponse() {
  ...
  if (buildCounterListMembershipsResponse < 3) {
    o.memberships = buildUnnamed1614();
    o.nextPageToken = "foo";
  }
  buildCounterListMembershipsResponse--;
  return o;
...
checkListMembershipsResponse(api.ListMembershipsResponse o) {
  buildCounterListMembershipsResponse++;
  if (buildCounterListMembershipsResponse < 3) {
    checkUnnamed1614(o.memberships);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListMembershipsResponse--;
}
...
checkUnnamed1615(core.List<api.MembershipRole> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1617(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1618(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
buildUnnamed1620() {
  ...
  o.add(buildUnnamed1619());
  o.add(buildUnnamed1619());
  return o;
}

checkUnnamed1620(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1619(o[0]);
  checkUnnamed1619(o[1]);
}
