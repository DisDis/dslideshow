...
checkUnnamed72(core.List<api.ContactGroupResponse> o) {
...
buildContactGroup() {
  ...
  if (buildCounterContactGroup < 3) {
    ...
    o.groupType = "foo";
    o.memberCount = 42;
    o.memberResourceNames = buildUnnamed73();
...
checkContactGroup(api.ContactGroup o) {
  ...
  if (buildCounterContactGroup < 3) {
    ...
    checkUnnamed73(o.memberResourceNames);
...
checkUnnamed74(core.List<api.PersonResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed75(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
checkUnnamed76(core.List<api.ContactGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListContactGroupsResponse() {
  ...
  if (buildCounterListContactGroupsResponse < 3) {
    o.contactGroups = buildUnnamed76();
    o.nextPageToken = "foo";
    o.nextSyncToken = "foo";
    o.totalItems = 42;
  }
...
checkListContactGroupsResponse(api.ListContactGroupsResponse o) {
  buildCounterListContactGroupsResponse++;
  if (buildCounterListContactGroupsResponse < 3) {
    checkUnnamed76(o.contactGroups);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    unittest.expect(o.nextSyncToken, unittest.equals('foo'));
    unittest.expect(o.totalItems, unittest.equals(42));
  }
...
buildModifyContactGroupMembersRequest() {
  ...
  if (buildCounterModifyContactGroupMembersRequest < 3) {
    o.resourceNamesToAdd = buildUnnamed77();
    o.resourceNamesToRemove = buildUnnamed78();
  }
  buildCounterModifyContactGroupMembersRequest--;
  return o;
}
...
checkModifyContactGroupMembersRequest(api.ModifyContactGroupMembersRequest o) {
  buildCounterModifyContactGroupMembersRequest++;
  if (buildCounterModifyContactGroupMembersRequest < 3) {
    checkUnnamed77(o.resourceNamesToAdd);
    checkUnnamed78(o.resourceNamesToRemove);
  }
  buildCounterModifyContactGroupMembersRequest--;
}
...
buildModifyContactGroupMembersResponse() {
  ...
  if (buildCounterModifyContactGroupMembersResponse < 3) {
    o.notFoundResourceNames = buildUnnamed79();
  }
  buildCounterModifyContactGroupMembersResponse--;
  return o;
}
...
checkModifyContactGroupMembersResponse(
  ...
  buildCounterModifyContactGroupMembersResponse++;
  if (buildCounterModifyContactGroupMembersResponse < 3) {
    checkUnnamed79(o.notFoundResourceNames);
  }
  buildCounterModifyContactGroupMembersResponse--;
}
...
checkUnnamed80(core.List<api.Address> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAddress(o[0]);
  checkAddress(o[1]);
}
...
checkUnnamed81(core.List<api.AgeRangeType> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed82(core.List<api.Biography> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBiography(o[0]);
  checkBiography(o[1]);
}
...
checkUnnamed83(core.List<api.Birthday> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBirthday(o[0]);
  checkBirthday(o[1]);
}
...
checkUnnamed84(core.List<api.BraggingRights> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed85(core.List<api.CoverPhoto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCoverPhoto(o[0]);
  checkCoverPhoto(o[1]);
}
...
checkUnnamed87(core.List<api.Event> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEvent(o[0]);
  checkEvent(o[1]);
}
...
checkUnnamed88(core.List<api.Gender> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGender(o[0]);
  checkGender(o[1]);
}
...
checkUnnamed89(core.List<api.ImClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImClient(o[0]);
  checkImClient(o[1]);
}
...
checkUnnamed90(core.List<api.Interest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInterest(o[0]);
  checkInterest(o[1]);
}
...
checkUnnamed91(core.List<api.Locale> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocale(o[0]);
  checkLocale(o[1]);
}
...
checkUnnamed92(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
checkUnnamed93(core.List<api.Name> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkName(o[0]);
  checkName(o[1]);
}
...
checkUnnamed94(core.List<api.Nickname> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNickname(o[0]);
  checkNickname(o[1]);
}
...
checkUnnamed95(core.List<api.Occupation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOccupation(o[0]);
  checkOccupation(o[1]);
}
...
checkUnnamed96(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed97(core.List<api.PhoneNumber> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed98(core.List<api.Photo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhoto(o[0]);
  checkPhoto(o[1]);
}
...
checkUnnamed99(core.List<api.Relation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelation(o[0]);
  checkRelation(o[1]);
}
...
checkUnnamed100(core.List<api.RelationshipInterest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed101(core.List<api.RelationshipStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed102(core.List<api.Residence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResidence(o[0]);
  checkResidence(o[1]);
}
...
checkUnnamed103(core.List<api.SipAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSipAddress(o[0]);
  checkSipAddress(o[1]);
}
...
checkUnnamed104(core.List<api.Skill> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSkill(o[0]);
  checkSkill(o[1]);
}
...
checkUnnamed105(core.List<api.Tagline> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagline(o[0]);
  checkTagline(o[1]);
}
...
checkUnnamed106(core.List<api.Url> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrl(o[0]);
  checkUrl(o[1]);
}
...
checkUnnamed107(core.List<api.UserDefined> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    ...
    o.ageRange = "foo";
    o.ageRanges = buildUnnamed81();
    o.biographies = buildUnnamed82();
    o.birthdays = buildUnnamed83();
    o.braggingRights = buildUnnamed84();
    o.coverPhotos = buildUnnamed85();
    o.emailAddresses = buildUnnamed86();
    o.etag = "foo";
    o.events = buildUnnamed87();
    o.genders = buildUnnamed88();
    o.imClients = buildUnnamed89();
    o.interests = buildUnnamed90();
    o.locales = buildUnnamed91();
    o.memberships = buildUnnamed92();
    o.metadata = buildPersonMetadata();
    o.names = buildUnnamed93();
    o.nicknames = buildUnnamed94();
    o.occupations = buildUnnamed95();
    o.organizations = buildUnnamed96();
    o.phoneNumbers = buildUnnamed97();
    o.photos = buildUnnamed98();
    o.relations = buildUnnamed99();
    o.relationshipInterests = buildUnnamed100();
    o.relationshipStatuses = buildUnnamed101();
    o.residences = buildUnnamed102();
    o.resourceName = "foo";
    o.sipAddresses = buildUnnamed103();
    o.skills = buildUnnamed104();
    o.taglines = buildUnnamed105();
    o.urls = buildUnnamed106();
    o.userDefined = buildUnnamed107();
  }
  buildCounterPerson--;
  return o;
}
...
checkPerson(api.Person o) {
  ...
  if (buildCounterPerson < 3) {
    ...
    unittest.expect(o.ageRange, unittest.equals('foo'));
    checkUnnamed81(o.ageRanges);
    checkUnnamed82(o.biographies);
    checkUnnamed83(o.birthdays);
    checkUnnamed84(o.braggingRights);
    checkUnnamed85(o.coverPhotos);
    checkUnnamed86(o.emailAddresses);
    unittest.expect(o.etag, unittest.equals('foo'));
    checkUnnamed87(o.events);
    checkUnnamed88(o.genders);
    checkUnnamed89(o.imClients);
    checkUnnamed90(o.interests);
    checkUnnamed91(o.locales);
    checkUnnamed92(o.memberships);
    checkPersonMetadata(o.metadata);
    checkUnnamed93(o.names);
    checkUnnamed94(o.nicknames);
    checkUnnamed95(o.occupations);
    checkUnnamed96(o.organizations);
    checkUnnamed97(o.phoneNumbers);
    checkUnnamed98(o.photos);
    checkUnnamed99(o.relations);
    checkUnnamed100(o.relationshipInterests);
    checkUnnamed101(o.relationshipStatuses);
    checkUnnamed102(o.residences);
    unittest.expect(o.resourceName, unittest.equals('foo'));
    checkUnnamed103(o.sipAddresses);
    checkUnnamed104(o.skills);
    checkUnnamed105(o.taglines);
    checkUnnamed106(o.urls);
    checkUnnamed107(o.userDefined);
  }
  buildCounterPerson--;
}
...
checkUnnamed110(core.List<api.Source> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSource(o[0]);
  checkSource(o[1]);
}
...
buildPersonMetadata() {
  ...
  if (buildCounterPersonMetadata < 3) {
    o.deleted = true;
    o.linkedPeopleResourceNames = buildUnnamed108();
    o.objectType = "foo";
    o.previousResourceNames = buildUnnamed109();
    o.sources = buildUnnamed110();
  }
  buildCounterPersonMetadata--;
  return o;
}
...
checkPersonMetadata(api.PersonMetadata o) {
  ...
  if (buildCounterPersonMetadata < 3) {
    unittest.expect(o.deleted, unittest.isTrue);
    checkUnnamed108(o.linkedPeopleResourceNames);
    unittest.expect(o.objectType, unittest.equals('foo'));
    checkUnnamed109(o.previousResourceNames);
    checkUnnamed110(o.sources);
  }
  buildCounterPersonMetadata--;
}
...
main() {
  ...
  unittest.group("resource-ContactGroupsResourceApi", () {
    unittest.test("method--batchGet", () {
      ...
      var arg_resourceNames = buildUnnamed114();
      var arg_$fields = "foo";
  ...
  unittest.group("resource-PeopleResourceApi", () {
    ...
    unittest.test("method--getBatchGet", () {
      ...
      var arg_personFields = "foo";
      var arg_requestMask_includeField = "foo";
      var arg_resourceNames = buildUnnamed115();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
