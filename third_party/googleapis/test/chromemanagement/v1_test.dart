...
core.List<api.GoogleChromeManagementV1BrowserVersion> buildUnnamed4526() {
  var o = <api.GoogleChromeManagementV1BrowserVersion>[];
...
void checkUnnamed4526(core.List<api.GoogleChromeManagementV1BrowserVersion> o) {
...
api.GoogleChromeManagementV1CountChromeVersionsResponse
  ...
  if (buildCounterGoogleChromeManagementV1CountChromeVersionsResponse < 3) {
    o.browserVersions = buildUnnamed4526();
    o.nextPageToken = 'foo';
    o.totalSize = 42;
  }
  buildCounterGoogleChromeManagementV1CountChromeVersionsResponse--;
...
void checkGoogleChromeManagementV1CountChromeVersionsResponse(
  ...
  buildCounterGoogleChromeManagementV1CountChromeVersionsResponse++;
  if (buildCounterGoogleChromeManagementV1CountChromeVersionsResponse < 3) {
    checkUnnamed4526(o.browserVersions!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleChromeManagementV1InstalledApp> buildUnnamed4527() {
...
void checkUnnamed4527(core.List<api.GoogleChromeManagementV1InstalledApp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleChromeManagementV1CountInstalledAppsResponse
  ...
  if (buildCounterGoogleChromeManagementV1CountInstalledAppsResponse < 3) {
    o.installedApps = buildUnnamed4527();
    o.nextPageToken = 'foo';
    o.totalSize = 42;
  }
  buildCounterGoogleChromeManagementV1CountInstalledAppsResponse--;
...
void checkGoogleChromeManagementV1CountInstalledAppsResponse(
  ...
  buildCounterGoogleChromeManagementV1CountInstalledAppsResponse++;
  if (buildCounterGoogleChromeManagementV1CountInstalledAppsResponse < 3) {
    checkUnnamed4527(o.installedApps!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleChromeManagementV1Device> buildUnnamed4528() {
  var o = <api.GoogleChromeManagementV1Device>[];
...
void checkUnnamed4528(core.List<api.GoogleChromeManagementV1Device> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleChromeManagementV1InstalledApp
  ...
  if (buildCounterGoogleChromeManagementV1InstalledApp < 3) {
    ...
    o.homepageUri = 'foo';
    o.osUserCount = 'foo';
    o.permissions = buildUnnamed4529();
  }
  buildCounterGoogleChromeManagementV1InstalledApp--;
  return o;
}
...
void checkGoogleChromeManagementV1InstalledApp(
  ...
  if (buildCounterGoogleChromeManagementV1InstalledApp < 3) {
    ...
    checkUnnamed4529(o.permissions!);
  }
  buildCounterGoogleChromeManagementV1InstalledApp--;
}
