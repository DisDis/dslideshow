...
core.List<api.Operation> buildUnnamed2967() {
  var o = <api.Operation>[];
...
void checkUnnamed2967(core.List<api.Operation> o) {
...
core.Map<core.String, core.Object> buildUnnamed2969() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2969(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed2968();
    o.name = 'foo';
    o.response = buildUnnamed2969();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed2968(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed2969(o.response!);
  }
  buildCounterOperation--;
}
