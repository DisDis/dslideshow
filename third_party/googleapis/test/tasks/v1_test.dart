...
core.List<api.TaskLinks> buildUnnamed5397() {
  var o = <api.TaskLinks>[];
...
void checkUnnamed5397(core.List<api.TaskLinks> o) {
...
core.List<api.TaskList> buildUnnamed5398() {
  var o = <api.TaskList>[];
  o.add(buildTaskList());
  o.add(buildTaskList());
  return o;
...
void checkUnnamed5398(core.List<api.TaskList> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Task> buildUnnamed5399() {
  var o = <api.Task>[];
  o.add(buildTask());
  o.add(buildTask());
  return o;
...
void checkUnnamed5399(core.List<api.Task> o) {
  unittest.expect(o, unittest.hasLength(2));
