...
core.List<api.CardAction> buildUnnamed5203() {
...
void checkUnnamed5203(core.List<api.CardAction> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCardAction(o[0] as api.CardAction);
  checkCardAction(o[1] as api.CardAction);
}

core.List<api.Section> buildUnnamed5204() {
  var o = <api.Section>[];
  o.add(buildSection());
  o.add(buildSection());
  return o;
...
void checkUnnamed5204(core.List<api.Section> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Card buildCard() {
  ...
  if (buildCounterCard < 3) {
    o.cardActions = buildUnnamed5203();
    o.header = buildCardHeader();
    o.name = 'foo';
    o.sections = buildUnnamed5204();
  }
  buildCounterCard--;
  return o;
}
...
void checkCard(api.Card o) {
  buildCounterCard++;
  if (buildCounterCard < 3) {
    checkUnnamed5203(o.cardActions!);
    checkCardHeader(o.header! as api.CardHeader);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed5204(o.sections!);
  }
  buildCounterCard--;
}
...
core.List<api.ActionParameter> buildUnnamed5205() {
  var o = <api.ActionParameter>[];
...
void checkUnnamed5205(core.List<api.ActionParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Membership> buildUnnamed5206() {
...
void checkUnnamed5206(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMembershipsResponse buildListMembershipsResponse() {
  ...
  if (buildCounterListMembershipsResponse < 3) {
    o.memberships = buildUnnamed5206();
    o.nextPageToken = 'foo';
  }
  buildCounterListMembershipsResponse--;
  return o;
...
void checkListMembershipsResponse(api.ListMembershipsResponse o) {
  buildCounterListMembershipsResponse++;
  if (buildCounterListMembershipsResponse < 3) {
    checkUnnamed5206(o.memberships!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Space> buildUnnamed5207() {
  var o = <api.Space>[];
  o.add(buildSpace());
  o.add(buildSpace());
  return o;
...
void checkUnnamed5207(core.List<api.Space> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Annotation> buildUnnamed5208() {
  var o = <api.Annotation>[];
...
void checkUnnamed5208(core.List<api.Annotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnnotation(o[0] as api.Annotation);
  checkAnnotation(o[1] as api.Annotation);
}

core.List<api.Attachment> buildUnnamed5209() {
  var o = <api.Attachment>[];
...
void checkUnnamed5209(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0] as api.Attachment);
  checkAttachment(o[1] as api.Attachment);
}

core.List<api.Card> buildUnnamed5210() {
  var o = <api.Card>[];
  o.add(buildCard());
  o.add(buildCard());
  return o;
...
void checkUnnamed5210(core.List<api.Card> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Message buildMessage() {
  ...
  if (buildCounterMessage < 3) {
    ...
    o.annotations = buildUnnamed5208();
    o.argumentText = 'foo';
    o.attachment = buildUnnamed5209();
    o.cards = buildUnnamed5210();
    o.createTime = 'foo';
    o.fallbackText = 'foo';
    o.name = 'foo';
    o.previewText = 'foo';
...
void checkMessage(api.Message o) {
  ...
  if (buildCounterMessage < 3) {
    ...
    checkUnnamed5208(o.annotations!);
    unittest.expect(
      o.argumentText!,
      unittest.equals('foo'),
    );
    checkUnnamed5209(o.attachment!);
    checkUnnamed5210(o.cards!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
...
core.List<api.WidgetMarkup> buildUnnamed5211() {
...
void checkUnnamed5211(core.List<api.WidgetMarkup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Button> buildUnnamed5212() {
  var o = <api.Button>[];
  o.add(buildButton());
  o.add(buildButton());
  return o;
...
void checkUnnamed5212(core.List<api.Button> o) {
  unittest.expect(o, unittest.hasLength(2));
