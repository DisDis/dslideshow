...
checkUnnamed2448(core.List<api.CardAction> o) {
...
checkUnnamed2449(core.List<api.Section> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSection(o[0]);
  checkSection(o[1]);
}
...
buildCard() {
  ...
  if (buildCounterCard < 3) {
    o.cardActions = buildUnnamed2448();
    o.header = buildCardHeader();
    o.name = "foo";
    o.sections = buildUnnamed2449();
  }
  buildCounterCard--;
  return o;
}
...
checkCard(api.Card o) {
  buildCounterCard++;
  if (buildCounterCard < 3) {
    checkUnnamed2448(o.cardActions);
    checkCardHeader(o.header);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed2449(o.sections);
  }
  buildCounterCard--;
}
...
checkUnnamed2450(core.List<api.ActionParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2452(core.List<api.Space> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpace(o[0]);
  checkSpace(o[1]);
}
...
checkUnnamed2453(core.List<api.Annotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnnotation(o[0]);
  checkAnnotation(o[1]);
}
...
checkUnnamed2454(core.List<api.Card> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCard(o[0]);
  checkCard(o[1]);
}
...
buildMessage() {
  ...
  if (buildCounterMessage < 3) {
    ...
    o.annotations = buildUnnamed2453();
    o.argumentText = "foo";
    o.cards = buildUnnamed2454();
    o.createTime = "foo";
    o.fallbackText = "foo";
    o.name = "foo";
    o.previewText = "foo";
...
checkMessage(api.Message o) {
  ...
  if (buildCounterMessage < 3) {
    ...
    checkUnnamed2453(o.annotations);
    unittest.expect(o.argumentText, unittest.equals('foo'));
    checkUnnamed2454(o.cards);
    unittest.expect(o.createTime, unittest.equals('foo'));
...
checkUnnamed2455(core.List<api.WidgetMarkup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2456(core.List<api.Button> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkButton(o[0]);
  checkButton(o[1]);
}
