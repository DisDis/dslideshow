...
core.List<api.Dataset> buildUnnamed5217() {
  var o = <api.Dataset>[];
  o.add(buildDataset());
  o.add(buildDataset());
  return o;
...
void checkUnnamed5217(core.List<api.Dataset> o) {
...
core.List<api.AggregateBy> buildUnnamed5218() {
  var o = <api.AggregateBy>[];
...
void checkUnnamed5218(core.List<api.AggregateBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AggregateRequest buildAggregateRequest() {
  ...
  if (buildCounterAggregateRequest < 3) {
    o.aggregateBy = buildUnnamed5218();
    ...
    o.endTimeMillis = 'foo';
    o.filteredDataQualityStandard = buildUnnamed5219();
    o.startTimeMillis = 'foo';
  }
  buildCounterAggregateRequest--;
  return o;
...
void checkAggregateRequest(api.AggregateRequest o) {
  buildCounterAggregateRequest++;
  if (buildCounterAggregateRequest < 3) {
    checkUnnamed5218(o.aggregateBy!);
    ...
    checkUnnamed5219(o.filteredDataQualityStandard!);
    unittest.expect(
      o.startTimeMillis!,
      unittest.equals('foo'),
    );
...
core.List<api.AggregateBucket> buildUnnamed5220() {
  var o = <api.AggregateBucket>[];
...
void checkUnnamed5220(core.List<api.AggregateBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Value> buildUnnamed5221() {
  var o = <api.Value>[];
  o.add(buildValue());
  o.add(buildValue());
  return o;
...
void checkUnnamed5221(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DataSource buildDataSource() {
  ...
  if (buildCounterDataSource < 3) {
    ...
    o.dataQualityStandard = buildUnnamed5222();
    o.dataStreamId = 'foo';
...
void checkDataSource(api.DataSource o) {
  ...
  if (buildCounterDataSource < 3) {
    ...
    checkUnnamed5222(o.dataQualityStandard!);
    unittest.expect(
      o.dataStreamId!,
      unittest.equals('foo'),
    );
...
core.List<api.DataTypeField> buildUnnamed5223() {
...
void checkUnnamed5223(core.List<api.DataTypeField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DataPoint> buildUnnamed5224() {
  var o = <api.DataPoint>[];
...
void checkUnnamed5224(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DataPoint> buildUnnamed5225() {
  var o = <api.DataPoint>[];
  o.add(buildDataPoint());
  o.add(buildDataPoint());
  return o;
...
void checkUnnamed5225(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0] as api.DataPoint);
  checkDataPoint(o[1] as api.DataPoint);
}

core.List<api.DataPoint> buildUnnamed5226() {
  var o = <api.DataPoint>[];
  o.add(buildDataPoint());
  o.add(buildDataPoint());
  return o;
...
void checkUnnamed5226(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0] as api.DataPoint);
  checkDataPoint(o[1] as api.DataPoint);
}
...
api.ListDataPointChangesResponse buildListDataPointChangesResponse() {
  ...
  if (buildCounterListDataPointChangesResponse < 3) {
    o.dataSourceId = 'foo';
    o.deletedDataPoint = buildUnnamed5225();
    o.insertedDataPoint = buildUnnamed5226();
    o.nextPageToken = 'foo';
  }
  buildCounterListDataPointChangesResponse--;
  return o;
...
void checkListDataPointChangesResponse(api.ListDataPointChangesResponse o) {
  ...
  if (buildCounterListDataPointChangesResponse < 3) {
    ...
    checkUnnamed5225(o.deletedDataPoint!);
    checkUnnamed5226(o.insertedDataPoint!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.DataSource> buildUnnamed5227() {
  var o = <api.DataSource>[];
...
void checkUnnamed5227(core.List<api.DataSource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListDataSourcesResponse(api.ListDataSourcesResponse o) {
  buildCounterListDataSourcesResponse++;
  if (buildCounterListDataSourcesResponse < 3) {
    checkUnnamed5227(o.dataSource!);
  }
  buildCounterListDataSourcesResponse--;
}

core.List<api.Session> buildUnnamed5228() {
  var o = <api.Session>[];
  o.add(buildSession());
  o.add(buildSession());
  return o;
...
void checkUnnamed5228(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0] as api.Session);
  checkSession(o[1] as api.Session);
}

core.List<api.Session> buildUnnamed5229() {
  var o = <api.Session>[];
  o.add(buildSession());
  o.add(buildSession());
  return o;
...
void checkUnnamed5229(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0] as api.Session);
  checkSession(o[1] as api.Session);
}
...
api.ListSessionsResponse buildListSessionsResponse() {
  ...
  if (buildCounterListSessionsResponse < 3) {
    o.deletedSession = buildUnnamed5228();
    o.hasMoreData = true;
    o.nextPageToken = 'foo';
    o.session = buildUnnamed5229();
  }
  buildCounterListSessionsResponse--;
  return o;
}
...
void checkListSessionsResponse(api.ListSessionsResponse o) {
  buildCounterListSessionsResponse++;
  if (buildCounterListSessionsResponse < 3) {
    checkUnnamed5228(o.deletedSession!);
    unittest.expect(o.hasMoreData!, unittest.isTrue);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed5229(o.session!);
  }
  buildCounterListSessionsResponse--;
}
...
core.List<api.ValueMapValEntry> buildUnnamed5230() {
...
void checkUnnamed5230(core.List<api.ValueMapValEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.int> buildUnnamed5232() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5232(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
void main() {
  ...
  unittest.group('resource-UsersDataSourcesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.FitnessApi(mock).users.dataSources;
      var arg_userId = 'foo';
      var arg_dataTypeName = buildUnnamed5231();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-UsersSessionsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.FitnessApi(mock).users.sessions;
      var arg_userId = 'foo';
      var arg_activityType = buildUnnamed5232();
      var arg_endTime = 'foo';
