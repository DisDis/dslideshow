...
core.List<api.ApplicationTransferParam> buildUnnamed3279() {
...
void checkUnnamed3279(core.List<api.ApplicationTransferParam> o) {
...
api.Application buildApplication() {
  ...
  if (buildCounterApplication < 3) {
    ...
    o.kind = 'foo';
    o.name = 'foo';
    o.transferParams = buildUnnamed3279();
  }
  buildCounterApplication--;
  return o;
}
...
void checkApplication(api.Application o) {
  ...
  if (buildCounterApplication < 3) {
    ...
    checkUnnamed3279(o.transferParams!);
  }
  buildCounterApplication--;
}

core.List<api.ApplicationTransferParam> buildUnnamed3280() {
  var o = <api.ApplicationTransferParam>[];
  o.add(buildApplicationTransferParam());
  o.add(buildApplicationTransferParam());
  return o;
...
void checkUnnamed3280(core.List<api.ApplicationTransferParam> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApplicationTransferParam(o[0] as api.ApplicationTransferParam);
  checkApplicationTransferParam(o[1] as api.ApplicationTransferParam);
}
...
api.ApplicationDataTransfer buildApplicationDataTransfer() {
  ...
  if (buildCounterApplicationDataTransfer < 3) {
    o.applicationId = 'foo';
    o.applicationTransferParams = buildUnnamed3280();
...
void checkApplicationDataTransfer(api.ApplicationDataTransfer o) {
  ...
  if (buildCounterApplicationDataTransfer < 3) {
    ...
    checkUnnamed3280(o.applicationTransferParams!);
    unittest.expect(
...
void checkApplicationTransferParam(api.ApplicationTransferParam o) {
  ...
  if (buildCounterApplicationTransferParam < 3) {
    ...
    checkUnnamed3281(o.value!);
  }
  buildCounterApplicationTransferParam--;
}

core.List<api.Application> buildUnnamed3282() {
  var o = <api.Application>[];
...
void checkUnnamed3282(core.List<api.Application> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApplicationsListResponse buildApplicationsListResponse() {
  ...
  if (buildCounterApplicationsListResponse < 3) {
    o.applications = buildUnnamed3282();
    o.etag = 'foo';
    o.kind = 'foo';
    o.nextPageToken = 'foo';
  }
...
void checkApplicationsListResponse(api.ApplicationsListResponse o) {
  buildCounterApplicationsListResponse++;
  if (buildCounterApplicationsListResponse < 3) {
    checkUnnamed3282(o.applications!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.List<api.ApplicationDataTransfer> buildUnnamed3283() {
  var o = <api.ApplicationDataTransfer>[];
...
void checkUnnamed3283(core.List<api.ApplicationDataTransfer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DataTransfer buildDataTransfer() {
  ...
  if (buildCounterDataTransfer < 3) {
    o.applicationDataTransfers = buildUnnamed3283();
    o.etag = 'foo';
    o.id = 'foo';
    o.kind = 'foo';
...
void checkDataTransfer(api.DataTransfer o) {
  buildCounterDataTransfer++;
  if (buildCounterDataTransfer < 3) {
    checkUnnamed3283(o.applicationDataTransfers!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.List<api.DataTransfer> buildUnnamed3284() {
  var o = <api.DataTransfer>[];
...
void checkUnnamed3284(core.List<api.DataTransfer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DataTransfersListResponse buildDataTransfersListResponse() {
  ...
  if (buildCounterDataTransfersListResponse < 3) {
    o.dataTransfers = buildUnnamed3284();
    o.etag = 'foo';
    o.kind = 'foo';
    o.nextPageToken = 'foo';
  }
...
void checkDataTransfersListResponse(api.DataTransfersListResponse o) {
  buildCounterDataTransfersListResponse++;
  if (buildCounterDataTransfersListResponse < 3) {
    checkUnnamed3284(o.dataTransfers!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
