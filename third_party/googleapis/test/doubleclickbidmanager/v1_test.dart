...
buildDownloadRequest() {
  ...
  if (buildCounterDownloadRequest < 3) {
    o.fileTypes = buildUnnamed2206();
    o.filterIds = buildUnnamed2207();
    o.filterType = "foo";
    o.version = "foo";
  }
  buildCounterDownloadRequest--;
...
checkDownloadRequest(api.DownloadRequest o) {
  buildCounterDownloadRequest++;
  if (buildCounterDownloadRequest < 3) {
    checkUnnamed2206(o.fileTypes);
    checkUnnamed2207(o.filterIds);
    unittest.expect(o.filterType, unittest.equals('foo'));
...
checkUnnamed2208(core.List<api.Query> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuery(o[0]);
  checkQuery(o[1]);
}
...
checkUnnamed2209(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReport(o[0]);
  checkReport(o[1]);
}
...
checkUnnamed2210(core.List<api.FilterPair> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterPair(o[0]);
  checkFilterPair(o[1]);
}
...
buildParameters() {
  ...
  if (buildCounterParameters < 3) {
    o.filters = buildUnnamed2210();
    o.groupBys = buildUnnamed2211();
    o.includeInviteData = true;
    o.metrics = buildUnnamed2212();
    o.type = "foo";
  }
  buildCounterParameters--;
  return o;
...
checkParameters(api.Parameters o) {
  buildCounterParameters++;
  if (buildCounterParameters < 3) {
    checkUnnamed2210(o.filters);
    checkUnnamed2211(o.groupBys);
    unittest.expect(o.includeInviteData, unittest.isTrue);
    checkUnnamed2212(o.metrics);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterParameters--;
}
...
buildQueryMetadata() {
  ...
  if (buildCounterQueryMetadata < 3) {
    ...
    o.shareEmailAddress = buildUnnamed2213();
    o.title = "foo";
  }
  buildCounterQueryMetadata--;
  return o;
...
checkQueryMetadata(api.QueryMetadata o) {
  ...
  if (buildCounterQueryMetadata < 3) {
    ...
    checkUnnamed2213(o.shareEmailAddress);
...
checkUnnamed2216(core.List<api.RowStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRowStatus(o[0]);
  checkRowStatus(o[1]);
}
...
buildUploadStatus() {
  ...
  if (buildCounterUploadStatus < 3) {
    o.errors = buildUnnamed2215();
    o.rowStatus = buildUnnamed2216();
  }
  buildCounterUploadStatus--;
  return o;
}
...
checkUploadStatus(api.UploadStatus o) {
  buildCounterUploadStatus++;
  if (buildCounterUploadStatus < 3) {
    checkUnnamed2215(o.errors);
    checkUnnamed2216(o.rowStatus);
  }
  buildCounterUploadStatus--;
}
