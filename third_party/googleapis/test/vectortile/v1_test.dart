...
core.List<core.int> buildUnnamed5982() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5982(core.List<core.int> o) {
...
core.List<core.int> buildUnnamed5983() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5983(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.int> buildUnnamed5984() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5984(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.Area buildArea() {
  ...
  if (buildCounterArea < 3) {
    ...
    o.internalEdges = buildUnnamed5982();
    o.loopBreaks = buildUnnamed5983();
    o.triangleIndices = buildUnnamed5984();
    o.type = 'foo';
...
void checkArea(api.Area o) {
  ...
  if (buildCounterArea < 3) {
    ...
    checkUnnamed5982(o.internalEdges!);
    checkUnnamed5983(o.loopBreaks!);
    checkUnnamed5984(o.triangleIndices!);
    unittest.expect(
      o.type!,
      unittest.equals('foo'),
    );
...
core.List<api.Relation> buildUnnamed5985() {
  var o = <api.Relation>[];
  o.add(buildRelation());
  o.add(buildRelation());
  return o;
...
void checkUnnamed5985(core.List<api.Relation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Feature> buildUnnamed5986() {
  var o = <api.Feature>[];
  o.add(buildFeature());
  o.add(buildFeature());
  return o;
...
void checkUnnamed5986(core.List<api.Feature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeature(o[0] as api.Feature);
  checkFeature(o[1] as api.Feature);
}

core.List<api.ProviderInfo> buildUnnamed5987() {
...
void checkUnnamed5987(core.List<api.ProviderInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FeatureTile buildFeatureTile() {
  ...
  if (buildCounterFeatureTile < 3) {
    ...
    o.features = buildUnnamed5986();
    o.name = 'foo';
    o.providers = buildUnnamed5987();
    o.status = 'foo';
    o.versionId = 'foo';
  }
  buildCounterFeatureTile--;
...
void checkFeatureTile(api.FeatureTile o) {
  ...
  if (buildCounterFeatureTile < 3) {
    ...
    checkUnnamed5986(o.features!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed5987(o.providers!);
    unittest.expect(
      o.status!,
      unittest.equals('foo'),
    );
...
core.List<api.Row> buildUnnamed5988() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed5988(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkFirstDerivativeElevationGrid(api.FirstDerivativeElevationGrid o) {
  ...
  if (buildCounterFirstDerivativeElevationGrid < 3) {
    ...
    checkUnnamed5988(o.rows!);
  }
  buildCounterFirstDerivativeElevationGrid--;
}

core.List<api.Area> buildUnnamed5989() {
  var o = <api.Area>[];
  o.add(buildArea());
  o.add(buildArea());
  return o;
...
void checkUnnamed5989(core.List<api.Area> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArea(o[0] as api.Area);
  checkArea(o[1] as api.Area);
}

core.List<api.ExtrudedArea> buildUnnamed5990() {
  var o = <api.ExtrudedArea>[];
...
void checkUnnamed5990(core.List<api.ExtrudedArea> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExtrudedArea(o[0] as api.ExtrudedArea);
  checkExtrudedArea(o[1] as api.ExtrudedArea);
}

core.List<api.Line> buildUnnamed5991() {
  var o = <api.Line>[];
  o.add(buildLine());
  o.add(buildLine());
  return o;
...
void checkUnnamed5991(core.List<api.Line> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLine(o[0] as api.Line);
  checkLine(o[1] as api.Line);
}

core.List<api.ModeledVolume> buildUnnamed5992() {
...
void checkUnnamed5992(core.List<api.ModeledVolume> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Geometry buildGeometry() {
  ...
  if (buildCounterGeometry < 3) {
    o.areas = buildUnnamed5989();
    o.extrudedAreas = buildUnnamed5990();
    o.lines = buildUnnamed5991();
    o.modeledVolumes = buildUnnamed5992();
  }
  buildCounterGeometry--;
  return o;
}
...
void checkGeometry(api.Geometry o) {
  buildCounterGeometry++;
  if (buildCounterGeometry < 3) {
    checkUnnamed5989(o.areas!);
    checkUnnamed5990(o.extrudedAreas!);
    checkUnnamed5991(o.lines!);
    checkUnnamed5992(o.modeledVolumes!);
  }
  buildCounterGeometry--;
}
...
core.List<api.TriangleStrip> buildUnnamed5993() {
...
void checkUnnamed5993(core.List<api.TriangleStrip> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.int> buildUnnamed5994() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5994(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.Row buildRow() {
  ...
  if (buildCounterRow < 3) {
    o.altitudeDiffs = buildUnnamed5994();
  }
  buildCounterRow--;
  return o;
}
...
void checkRow(api.Row o) {
  buildCounterRow++;
  if (buildCounterRow < 3) {
    checkUnnamed5994(o.altitudeDiffs!);
  }
  buildCounterRow--;
}
...
core.List<core.int> buildUnnamed5995() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5995(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.TriangleStrip buildTriangleStrip() {
  ...
  if (buildCounterTriangleStrip < 3) {
    o.vertexIndices = buildUnnamed5995();
  }
  buildCounterTriangleStrip--;
  return o;
}
...
void checkTriangleStrip(api.TriangleStrip o) {
  buildCounterTriangleStrip++;
  if (buildCounterTriangleStrip < 3) {
    checkUnnamed5995(o.vertexIndices!);
  }
  buildCounterTriangleStrip--;
}

core.List<core.int> buildUnnamed5996() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5996(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.int> buildUnnamed5997() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5997(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.Vertex2DList buildVertex2DList() {
  ...
  if (buildCounterVertex2DList < 3) {
    o.xOffsets = buildUnnamed5996();
    o.yOffsets = buildUnnamed5997();
  }
  buildCounterVertex2DList--;
  return o;
}
...
void checkVertex2DList(api.Vertex2DList o) {
  buildCounterVertex2DList++;
  if (buildCounterVertex2DList < 3) {
    checkUnnamed5996(o.xOffsets!);
    checkUnnamed5997(o.yOffsets!);
  }
  buildCounterVertex2DList--;
}

core.List<core.int> buildUnnamed5998() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5998(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.int> buildUnnamed5999() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5999(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.int> buildUnnamed6000() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed6000(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.Vertex3DList buildVertex3DList() {
  ...
  if (buildCounterVertex3DList < 3) {
    o.xOffsets = buildUnnamed5998();
    o.yOffsets = buildUnnamed5999();
    o.zOffsets = buildUnnamed6000();
  }
  buildCounterVertex3DList--;
  return o;
}
...
void checkVertex3DList(api.Vertex3DList o) {
  buildCounterVertex3DList++;
  if (buildCounterVertex3DList < 3) {
    checkUnnamed5998(o.xOffsets!);
    checkUnnamed5999(o.yOffsets!);
    checkUnnamed6000(o.zOffsets!);
  }
  buildCounterVertex3DList--;
}
...
void main() {
  ...
  unittest.group('resource-TerraintilesResource', () {
    unittest.test('method--get', () async {
      ...
      var arg_terrainFormats = buildUnnamed6001();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
