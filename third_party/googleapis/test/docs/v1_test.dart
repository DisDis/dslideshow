...
core.Map<core.String, api.SuggestedTextStyle> buildUnnamed5907() {
...
void checkUnnamed5907(core.Map<core.String, api.SuggestedTextStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AutoText buildAutoText() {
  ...
  if (buildCounterAutoText < 3) {
    o.suggestedDeletionIds = buildUnnamed5905();
    o.suggestedInsertionIds = buildUnnamed5906();
    o.suggestedTextStyleChanges = buildUnnamed5907();
...
void checkAutoText(api.AutoText o) {
  buildCounterAutoText++;
  if (buildCounterAutoText < 3) {
    checkUnnamed5905(o.suggestedDeletionIds!);
    checkUnnamed5906(o.suggestedInsertionIds!);
    checkUnnamed5907(o.suggestedTextStyleChanges!);
...
core.List<api.Request> buildUnnamed5908() {
  var o = <api.Request>[];
  o.add(buildRequest());
  o.add(buildRequest());
  return o;
...
void checkUnnamed5908(core.List<api.Request> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkBatchUpdateDocumentRequest(api.BatchUpdateDocumentRequest o) {
  buildCounterBatchUpdateDocumentRequest++;
  if (buildCounterBatchUpdateDocumentRequest < 3) {
    checkUnnamed5908(o.requests!);
    checkWriteControl(o.writeControl! as api.WriteControl);
  }
  buildCounterBatchUpdateDocumentRequest--;
}

core.List<api.Response> buildUnnamed5909() {
  var o = <api.Response>[];
  o.add(buildResponse());
  o.add(buildResponse());
  return o;
...
void checkUnnamed5909(core.List<api.Response> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkBatchUpdateDocumentResponse(api.BatchUpdateDocumentResponse o) {
  ...
  if (buildCounterBatchUpdateDocumentResponse < 3) {
    ...
    checkUnnamed5909(o.replies!);
    checkWriteControl(o.writeControl! as api.WriteControl);
  }
  buildCounterBatchUpdateDocumentResponse--;
}

core.List<api.StructuralElement> buildUnnamed5910() {
...
void checkUnnamed5910(core.List<api.StructuralElement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.SuggestedTextStyle> buildUnnamed5913() {
  var o = <core.String, api.SuggestedTextStyle>{};
  o['x'] = buildSuggestedTextStyle();
  o['y'] = buildSuggestedTextStyle();
  return o;
...
void checkUnnamed5913(core.Map<core.String, api.SuggestedTextStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSuggestedTextStyle(o['x']! as api.SuggestedTextStyle);
  checkSuggestedTextStyle(o['y']! as api.SuggestedTextStyle);
}
...
api.ColumnBreak buildColumnBreak() {
  ...
  if (buildCounterColumnBreak < 3) {
    o.suggestedDeletionIds = buildUnnamed5911();
    o.suggestedInsertionIds = buildUnnamed5912();
    o.suggestedTextStyleChanges = buildUnnamed5913();
    o.textStyle = buildTextStyle();
  }
  buildCounterColumnBreak--;
  return o;
...
void checkColumnBreak(api.ColumnBreak o) {
  buildCounterColumnBreak++;
  if (buildCounterColumnBreak < 3) {
    checkUnnamed5911(o.suggestedDeletionIds!);
    checkUnnamed5912(o.suggestedInsertionIds!);
    checkUnnamed5913(o.suggestedTextStyleChanges!);
    checkTextStyle(o.textStyle! as api.TextStyle);
  }
  buildCounterColumnBreak--;
}
...
core.Map<core.String, api.Footer> buildUnnamed5914() {
...
void checkUnnamed5914(core.Map<core.String, api.Footer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFooter(o['x']! as api.Footer);
  checkFooter(o['y']! as api.Footer);
}

core.Map<core.String, api.Footnote> buildUnnamed5915() {
...
void checkUnnamed5915(core.Map<core.String, api.Footnote> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFootnote(o['x']! as api.Footnote);
  checkFootnote(o['y']! as api.Footnote);
}

core.Map<core.String, api.Header> buildUnnamed5916() {
...
void checkUnnamed5916(core.Map<core.String, api.Header> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHeader(o['x']! as api.Header);
  checkHeader(o['y']! as api.Header);
}

core.Map<core.String, api.InlineObject> buildUnnamed5917() {
...
void checkUnnamed5917(core.Map<core.String, api.InlineObject> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInlineObject(o['x']! as api.InlineObject);
  checkInlineObject(o['y']! as api.InlineObject);
}

core.Map<core.String, api.List> buildUnnamed5918() {
...
void checkUnnamed5918(core.Map<core.String, api.List> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkList(o['x']! as api.List);
  checkList(o['y']! as api.List);
}

core.Map<core.String, api.NamedRanges> buildUnnamed5919() {
...
void checkUnnamed5919(core.Map<core.String, api.NamedRanges> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNamedRanges(o['x']! as api.NamedRanges);
  checkNamedRanges(o['y']! as api.NamedRanges);
}

core.Map<core.String, api.PositionedObject> buildUnnamed5920() {
...
void checkUnnamed5920(core.Map<core.String, api.PositionedObject> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPositionedObject(o['x']! as api.PositionedObject);
  checkPositionedObject(o['y']! as api.PositionedObject);
}

core.Map<core.String, api.SuggestedDocumentStyle> buildUnnamed5921() {
...
void checkUnnamed5921(core.Map<core.String, api.SuggestedDocumentStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.SuggestedNamedStyles> buildUnnamed5922() {
...
void checkUnnamed5922(core.Map<core.String, api.SuggestedNamedStyles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Document buildDocument() {
  ...
  if (buildCounterDocument < 3) {
    ...
    o.footers = buildUnnamed5914();
    o.footnotes = buildUnnamed5915();
    o.headers = buildUnnamed5916();
    o.inlineObjects = buildUnnamed5917();
    o.lists = buildUnnamed5918();
    o.namedRanges = buildUnnamed5919();
    o.namedStyles = buildNamedStyles();
    o.positionedObjects = buildUnnamed5920();
    o.revisionId = 'foo';
    o.suggestedDocumentStyleChanges = buildUnnamed5921();
    o.suggestedNamedStylesChanges = buildUnnamed5922();
...
void checkDocument(api.Document o) {
  ...
  if (buildCounterDocument < 3) {
    ...
    checkUnnamed5914(o.footers!);
    checkUnnamed5915(o.footnotes!);
    checkUnnamed5916(o.headers!);
    checkUnnamed5917(o.inlineObjects!);
    checkUnnamed5918(o.lists!);
    checkUnnamed5919(o.namedRanges!);
    checkNamedStyles(o.namedStyles! as api.NamedStyles);
    checkUnnamed5920(o.positionedObjects!);
    unittest.expect(
      o.revisionId!,
      unittest.equals('foo'),
    );
    checkUnnamed5921(o.suggestedDocumentStyleChanges!);
    checkUnnamed5922(o.suggestedNamedStylesChanges!);
    unittest.expect(
...
api.Equation buildEquation() {
  ...
  if (buildCounterEquation < 3) {
    o.suggestedDeletionIds = buildUnnamed5923();
    o.suggestedInsertionIds = buildUnnamed5924();
  }
  buildCounterEquation--;
  return o;
}
...
void checkEquation(api.Equation o) {
  buildCounterEquation++;
  if (buildCounterEquation < 3) {
    checkUnnamed5923(o.suggestedDeletionIds!);
    checkUnnamed5924(o.suggestedInsertionIds!);
  }
  buildCounterEquation--;
}

core.List<api.StructuralElement> buildUnnamed5925() {
  var o = <api.StructuralElement>[];
  o.add(buildStructuralElement());
  o.add(buildStructuralElement());
  return o;
...
void checkUnnamed5925(core.List<api.StructuralElement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStructuralElement(o[0] as api.StructuralElement);
  checkStructuralElement(o[1] as api.StructuralElement);
}
...
core.List<api.StructuralElement> buildUnnamed5926() {
  var o = <api.StructuralElement>[];
  o.add(buildStructuralElement());
  o.add(buildStructuralElement());
  return o;
...
void checkUnnamed5926(core.List<api.StructuralElement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStructuralElement(o[0] as api.StructuralElement);
  checkStructuralElement(o[1] as api.StructuralElement);
}
...
core.Map<core.String, api.SuggestedTextStyle> buildUnnamed5929() {
  var o = <core.String, api.SuggestedTextStyle>{};
  o['x'] = buildSuggestedTextStyle();
  o['y'] = buildSuggestedTextStyle();
  return o;
...
void checkUnnamed5929(core.Map<core.String, api.SuggestedTextStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSuggestedTextStyle(o['x']! as api.SuggestedTextStyle);
  checkSuggestedTextStyle(o['y']! as api.SuggestedTextStyle);
}
...
api.FootnoteReference buildFootnoteReference() {
  ...
  if (buildCounterFootnoteReference < 3) {
    ...
    o.suggestedDeletionIds = buildUnnamed5927();
    o.suggestedInsertionIds = buildUnnamed5928();
    o.suggestedTextStyleChanges = buildUnnamed5929();
    o.textStyle = buildTextStyle();
  }
  buildCounterFootnoteReference--;
  return o;
...
void checkFootnoteReference(api.FootnoteReference o) {
  ...
  if (buildCounterFootnoteReference < 3) {
    ...
    checkUnnamed5927(o.suggestedDeletionIds!);
    checkUnnamed5928(o.suggestedInsertionIds!);
    checkUnnamed5929(o.suggestedTextStyleChanges!);
    checkTextStyle(o.textStyle! as api.TextStyle);
  }
  buildCounterFootnoteReference--;
}

core.List<api.StructuralElement> buildUnnamed5930() {
  var o = <api.StructuralElement>[];
  o.add(buildStructuralElement());
  o.add(buildStructuralElement());
  return o;
...
void checkUnnamed5930(core.List<api.StructuralElement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStructuralElement(o[0] as api.StructuralElement);
  checkStructuralElement(o[1] as api.StructuralElement);
}
...
core.Map<core.String, api.SuggestedTextStyle> buildUnnamed5933() {
  var o = <core.String, api.SuggestedTextStyle>{};
  o['x'] = buildSuggestedTextStyle();
  o['y'] = buildSuggestedTextStyle();
  return o;
...
void checkUnnamed5933(core.Map<core.String, api.SuggestedTextStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSuggestedTextStyle(o['x']! as api.SuggestedTextStyle);
  checkSuggestedTextStyle(o['y']! as api.SuggestedTextStyle);
}
...
api.HorizontalRule buildHorizontalRule() {
  ...
  if (buildCounterHorizontalRule < 3) {
    o.suggestedDeletionIds = buildUnnamed5931();
    o.suggestedInsertionIds = buildUnnamed5932();
    o.suggestedTextStyleChanges = buildUnnamed5933();
    o.textStyle = buildTextStyle();
  }
  buildCounterHorizontalRule--;
  return o;
...
void checkHorizontalRule(api.HorizontalRule o) {
  buildCounterHorizontalRule++;
  if (buildCounterHorizontalRule < 3) {
    checkUnnamed5931(o.suggestedDeletionIds!);
    checkUnnamed5932(o.suggestedInsertionIds!);
    checkUnnamed5933(o.suggestedTextStyleChanges!);
    checkTextStyle(o.textStyle! as api.TextStyle);
  }
  buildCounterHorizontalRule--;
}
...
core.Map<core.String, api.SuggestedInlineObjectProperties> buildUnnamed5935() {
...
api.InlineObject buildInlineObject() {
  ...
  if (buildCounterInlineObject < 3) {
    ...
    o.objectId = 'foo';
    o.suggestedDeletionIds = buildUnnamed5934();
    o.suggestedInlineObjectPropertiesChanges = buildUnnamed5935();
...
void checkInlineObject(api.InlineObject o) {
  ...
  if (buildCounterInlineObject < 3) {
    ...
    checkUnnamed5934(o.suggestedDeletionIds!);
    checkUnnamed5935(o.suggestedInlineObjectPropertiesChanges!);
    unittest.expect(
...
core.Map<core.String, api.SuggestedTextStyle> buildUnnamed5938() {
  var o = <core.String, api.SuggestedTextStyle>{};
  o['x'] = buildSuggestedTextStyle();
  o['y'] = buildSuggestedTextStyle();
  return o;
...
void checkUnnamed5938(core.Map<core.String, api.SuggestedTextStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSuggestedTextStyle(o['x']! as api.SuggestedTextStyle);
  checkSuggestedTextStyle(o['y']! as api.SuggestedTextStyle);
}
...
api.InlineObjectElement buildInlineObjectElement() {
  ...
  if (buildCounterInlineObjectElement < 3) {
    ...
    o.suggestedDeletionIds = buildUnnamed5936();
    o.suggestedInsertionIds = buildUnnamed5937();
    o.suggestedTextStyleChanges = buildUnnamed5938();
    o.textStyle = buildTextStyle();
  }
  buildCounterInlineObjectElement--;
  return o;
...
void checkInlineObjectElement(api.InlineObjectElement o) {
  ...
  if (buildCounterInlineObjectElement < 3) {
    ...
    checkUnnamed5936(o.suggestedDeletionIds!);
    checkUnnamed5937(o.suggestedInsertionIds!);
    checkUnnamed5938(o.suggestedTextStyleChanges!);
    checkTextStyle(o.textStyle! as api.TextStyle);
  }
  buildCounterInlineObjectElement--;
}
...
core.List<core.String> buildUnnamed5939() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed5939(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.Map<core.String, api.SuggestedListProperties> buildUnnamed5940() {
...
void checkUnnamed5940(core.Map<core.String, api.SuggestedListProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.List buildList() {
  ...
  if (buildCounterList < 3) {
    ...
    o.suggestedDeletionIds = buildUnnamed5939();
    o.suggestedInsertionId = 'foo';
    o.suggestedListPropertiesChanges = buildUnnamed5940();
  }
  buildCounterList--;
  return o;
}
...
void checkList(api.List o) {
  ...
  if (buildCounterList < 3) {
    ...
    checkUnnamed5939(o.suggestedDeletionIds!);
    unittest.expect(
      o.suggestedInsertionId!,
      unittest.equals('foo'),
    );
    checkUnnamed5940(o.suggestedListPropertiesChanges!);
  }
  buildCounterList--;
}

core.List<api.NestingLevel> buildUnnamed5941() {
...
void checkUnnamed5941(core.List<api.NestingLevel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListProperties buildListProperties() {
  ...
  if (buildCounterListProperties < 3) {
    o.nestingLevels = buildUnnamed5941();
  }
  buildCounterListProperties--;
  return o;
}
...
void checkListProperties(api.ListProperties o) {
  buildCounterListProperties++;
  if (buildCounterListProperties < 3) {
    checkUnnamed5941(o.nestingLevels!);
  }
  buildCounterListProperties--;
}

core.List<api.NestingLevelSuggestionState> buildUnnamed5942() {
...
void checkUnnamed5942(core.List<api.NestingLevelSuggestionState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListPropertiesSuggestionState buildListPropertiesSuggestionState() {
  ...
  if (buildCounterListPropertiesSuggestionState < 3) {
    o.nestingLevelsSuggestionStates = buildUnnamed5942();
  }
  buildCounterListPropertiesSuggestionState--;
  return o;
}
...
void checkListPropertiesSuggestionState(api.ListPropertiesSuggestionState o) {
  buildCounterListPropertiesSuggestionState++;
  if (buildCounterListPropertiesSuggestionState < 3) {
    checkUnnamed5942(o.nestingLevelsSuggestionStates!);
  }
  buildCounterListPropertiesSuggestionState--;
}
...
core.List<api.Range> buildUnnamed5943() {
  var o = <api.Range>[];
  o.add(buildRange());
  o.add(buildRange());
  return o;
...
void checkUnnamed5943(core.List<api.Range> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkNamedRange(api.NamedRange o) {
  ...
  if (buildCounterNamedRange < 3) {
    ...
    checkUnnamed5943(o.ranges!);
  }
  buildCounterNamedRange--;
}

core.List<api.NamedRange> buildUnnamed5944() {
  var o = <api.NamedRange>[];
...
void checkUnnamed5944(core.List<api.NamedRange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NamedRanges buildNamedRanges() {
  ...
  if (buildCounterNamedRanges < 3) {
    o.name = 'foo';
    o.namedRanges = buildUnnamed5944();
  }
  buildCounterNamedRanges--;
  return o;
}
...
void checkNamedRanges(api.NamedRanges o) {
  ...
  if (buildCounterNamedRanges < 3) {
    ...
    checkUnnamed5944(o.namedRanges!);
  }
  buildCounterNamedRanges--;
}
...
core.List<api.NamedStyle> buildUnnamed5945() {
  var o = <api.NamedStyle>[];
...
void checkUnnamed5945(core.List<api.NamedStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkNamedStyles(api.NamedStyles o) {
  buildCounterNamedStyles++;
  if (buildCounterNamedStyles < 3) {
    checkUnnamed5945(o.styles!);
  }
  buildCounterNamedStyles--;
}

core.List<api.NamedStyleSuggestionState> buildUnnamed5946() {
  var o = <api.NamedStyleSuggestionState>[];
...
void checkUnnamed5946(core.List<api.NamedStyleSuggestionState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NamedStylesSuggestionState buildNamedStylesSuggestionState() {
  ...
  if (buildCounterNamedStylesSuggestionState < 3) {
    o.stylesSuggestionStates = buildUnnamed5946();
  }
  buildCounterNamedStylesSuggestionState--;
  return o;
}
...
void checkNamedStylesSuggestionState(api.NamedStylesSuggestionState o) {
  buildCounterNamedStylesSuggestionState++;
  if (buildCounterNamedStylesSuggestionState < 3) {
    checkUnnamed5946(o.stylesSuggestionStates!);
  }
  buildCounterNamedStylesSuggestionState--;
}
...
core.Map<core.String, api.SuggestedTextStyle> buildUnnamed5950() {
  var o = <core.String, api.SuggestedTextStyle>{};
  o['x'] = buildSuggestedTextStyle();
  o['y'] = buildSuggestedTextStyle();
  return o;
...
void checkUnnamed5950(core.Map<core.String, api.SuggestedTextStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSuggestedTextStyle(o['x']! as api.SuggestedTextStyle);
  checkSuggestedTextStyle(o['y']! as api.SuggestedTextStyle);
}
...
api.PageBreak buildPageBreak() {
  ...
  if (buildCounterPageBreak < 3) {
    o.suggestedDeletionIds = buildUnnamed5948();
    o.suggestedInsertionIds = buildUnnamed5949();
    o.suggestedTextStyleChanges = buildUnnamed5950();
    o.textStyle = buildTextStyle();
  }
  buildCounterPageBreak--;
  return o;
...
void checkPageBreak(api.PageBreak o) {
  buildCounterPageBreak++;
  if (buildCounterPageBreak < 3) {
    checkUnnamed5948(o.suggestedDeletionIds!);
    checkUnnamed5949(o.suggestedInsertionIds!);
    checkUnnamed5950(o.suggestedTextStyleChanges!);
    checkTextStyle(o.textStyle! as api.TextStyle);
  }
  buildCounterPageBreak--;
}

core.List<api.ParagraphElement> buildUnnamed5951() {
...
void checkUnnamed5951(core.List<api.ParagraphElement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.SuggestedBullet> buildUnnamed5953() {
...
void checkUnnamed5953(core.Map<core.String, api.SuggestedBullet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSuggestedBullet(o['x']! as api.SuggestedBullet);
  checkSuggestedBullet(o['y']! as api.SuggestedBullet);
}

core.Map<core.String, api.SuggestedParagraphStyle> buildUnnamed5954() {
...
void checkUnnamed5954(core.Map<core.String, api.SuggestedParagraphStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.ObjectReferences> buildUnnamed5955() {
...
void checkUnnamed5955(core.Map<core.String, api.ObjectReferences> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Paragraph buildParagraph() {
  ...
  if (buildCounterParagraph < 3) {
    ...
    o.elements = buildUnnamed5951();
    o.paragraphStyle = buildParagraphStyle();
    o.positionedObjectIds = buildUnnamed5952();
    o.suggestedBulletChanges = buildUnnamed5953();
    o.suggestedParagraphStyleChanges = buildUnnamed5954();
    o.suggestedPositionedObjectIds = buildUnnamed5955();
  }
  buildCounterParagraph--;
  return o;
}
...
void checkParagraph(api.Paragraph o) {
  ...
  if (buildCounterParagraph < 3) {
    ...
    checkUnnamed5951(o.elements!);
    checkParagraphStyle(o.paragraphStyle! as api.ParagraphStyle);
    checkUnnamed5952(o.positionedObjectIds!);
    checkUnnamed5953(o.suggestedBulletChanges!);
    checkUnnamed5954(o.suggestedParagraphStyleChanges!);
    checkUnnamed5955(o.suggestedPositionedObjectIds!);
  }
  buildCounterParagraph--;
}
...
core.List<api.TabStop> buildUnnamed5956() {
  var o = <api.TabStop>[];
  o.add(buildTabStop());
  o.add(buildTabStop());
  return o;
...
void checkUnnamed5956(core.List<api.TabStop> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PositionedObject buildPositionedObject() {
  ...
  if (buildCounterPositionedObject < 3) {
    ...
    o.suggestedDeletionIds = buildUnnamed5957();
    o.suggestedInsertionId = 'foo';
    o.suggestedPositionedObjectPropertiesChanges = buildUnnamed5958();
  }
  buildCounterPositionedObject--;
  return o;
}
...
void checkPositionedObject(api.PositionedObject o) {
  ...
  if (buildCounterPositionedObject < 3) {
    ...
    checkUnnamed5957(o.suggestedDeletionIds!);
    unittest.expect(
      o.suggestedInsertionId!,
      unittest.equals('foo'),
    );
    checkUnnamed5958(o.suggestedPositionedObjectPropertiesChanges!);
  }
  buildCounterPositionedObject--;
}
...
api.SectionBreak buildSectionBreak() {
  ...
  if (buildCounterSectionBreak < 3) {
    ...
    o.suggestedDeletionIds = buildUnnamed5959();
    o.suggestedInsertionIds = buildUnnamed5960();
  }
  buildCounterSectionBreak--;
  return o;
}
...
void checkSectionBreak(api.SectionBreak o) {
  ...
  if (buildCounterSectionBreak < 3) {
    ...
    checkUnnamed5959(o.suggestedDeletionIds!);
    checkUnnamed5960(o.suggestedInsertionIds!);
  }
  buildCounterSectionBreak--;
}
...
core.List<api.SectionColumnProperties> buildUnnamed5961() {
  var o = <api.SectionColumnProperties>[];
...
void checkUnnamed5961(core.List<api.SectionColumnProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SectionStyle buildSectionStyle() {
  ...
  if (buildCounterSectionStyle < 3) {
    o.columnProperties = buildUnnamed5961();
...
void checkSectionStyle(api.SectionStyle o) {
  buildCounterSectionStyle++;
  if (buildCounterSectionStyle < 3) {
    checkUnnamed5961(o.columnProperties!);
    unittest.expect(
...
core.List<api.TableRow> buildUnnamed5964() {
  var o = <api.TableRow>[];
  o.add(buildTableRow());
  o.add(buildTableRow());
  return o;
...
void checkUnnamed5964(core.List<api.TableRow> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Table buildTable() {
  ...
  if (buildCounterTable < 3) {
    o.columns = 42;
    o.rows = 42;
    o.suggestedDeletionIds = buildUnnamed5962();
    o.suggestedInsertionIds = buildUnnamed5963();
    o.tableRows = buildUnnamed5964();
...
void checkTable(api.Table o) {
  ...
  if (buildCounterTable < 3) {
    ...
    checkUnnamed5962(o.suggestedDeletionIds!);
    checkUnnamed5963(o.suggestedInsertionIds!);
    checkUnnamed5964(o.tableRows!);
    checkTableStyle(o.tableStyle! as api.TableStyle);
  }
  buildCounterTable--;
}

core.List<api.StructuralElement> buildUnnamed5965() {
  var o = <api.StructuralElement>[];
  o.add(buildStructuralElement());
  o.add(buildStructuralElement());
  return o;
...
void checkUnnamed5965(core.List<api.StructuralElement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStructuralElement(o[0] as api.StructuralElement);
  checkStructuralElement(o[1] as api.StructuralElement);
}
...
core.List<core.String> buildUnnamed5967() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed5967(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.Map<core.String, api.SuggestedTableCellStyle> buildUnnamed5968() {
...
void checkUnnamed5968(core.Map<core.String, api.SuggestedTableCellStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TableCell buildTableCell() {
  ...
  if (buildCounterTableCell < 3) {
    o.content = buildUnnamed5965();
    o.endIndex = 42;
    o.startIndex = 42;
    o.suggestedDeletionIds = buildUnnamed5966();
    o.suggestedInsertionIds = buildUnnamed5967();
    o.suggestedTableCellStyleChanges = buildUnnamed5968();
    o.tableCellStyle = buildTableCellStyle();
  }
  buildCounterTableCell--;
  return o;
...
void checkTableCell(api.TableCell o) {
  ...
  if (buildCounterTableCell < 3) {
    ...
    checkUnnamed5966(o.suggestedDeletionIds!);
    checkUnnamed5967(o.suggestedInsertionIds!);
    checkUnnamed5968(o.suggestedTableCellStyleChanges!);
    checkTableCellStyle(o.tableCellStyle! as api.TableCellStyle);
  }
  buildCounterTableCell--;
}
...
core.List<api.StructuralElement> buildUnnamed5969() {
  var o = <api.StructuralElement>[];
  o.add(buildStructuralElement());
  o.add(buildStructuralElement());
  return o;
...
void checkUnnamed5969(core.List<api.StructuralElement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStructuralElement(o[0] as api.StructuralElement);
  checkStructuralElement(o[1] as api.StructuralElement);
}
...
api.TableOfContents buildTableOfContents() {
  ...
  if (buildCounterTableOfContents < 3) {
    o.content = buildUnnamed5969();
    o.suggestedDeletionIds = buildUnnamed5970();
    o.suggestedInsertionIds = buildUnnamed5971();
  }
  buildCounterTableOfContents--;
  return o;
}
...
void checkTableOfContents(api.TableOfContents o) {
  buildCounterTableOfContents++;
  if (buildCounterTableOfContents < 3) {
    checkUnnamed5969(o.content!);
    checkUnnamed5970(o.suggestedDeletionIds!);
    checkUnnamed5971(o.suggestedInsertionIds!);
  }
  buildCounterTableOfContents--;
}
...
core.Map<core.String, api.SuggestedTableRowStyle> buildUnnamed5974() {
...
void checkUnnamed5974(core.Map<core.String, api.SuggestedTableRowStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.TableCell> buildUnnamed5975() {
  var o = <api.TableCell>[];
...
void checkUnnamed5975(core.List<api.TableCell> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TableRow buildTableRow() {
  ...
  if (buildCounterTableRow < 3) {
    o.endIndex = 42;
    o.startIndex = 42;
    o.suggestedDeletionIds = buildUnnamed5972();
    o.suggestedInsertionIds = buildUnnamed5973();
    o.suggestedTableRowStyleChanges = buildUnnamed5974();
    o.tableCells = buildUnnamed5975();
    o.tableRowStyle = buildTableRowStyle();
  }
  buildCounterTableRow--;
  return o;
...
void checkTableRow(api.TableRow o) {
  ...
  if (buildCounterTableRow < 3) {
    ...
    checkUnnamed5972(o.suggestedDeletionIds!);
    checkUnnamed5973(o.suggestedInsertionIds!);
    checkUnnamed5974(o.suggestedTableRowStyleChanges!);
    checkUnnamed5975(o.tableCells!);
    checkTableRowStyle(o.tableRowStyle! as api.TableRowStyle);
  }
  buildCounterTableRow--;
}
...
core.List<api.TableColumnProperties> buildUnnamed5976() {
  var o = <api.TableColumnProperties>[];
...
void checkUnnamed5976(core.List<api.TableColumnProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TableStyle buildTableStyle() {
  ...
  if (buildCounterTableStyle < 3) {
    o.tableColumnProperties = buildUnnamed5976();
  }
  buildCounterTableStyle--;
  return o;
}
...
void checkTableStyle(api.TableStyle o) {
  buildCounterTableStyle++;
  if (buildCounterTableStyle < 3) {
    checkUnnamed5976(o.tableColumnProperties!);
  }
  buildCounterTableStyle--;
}
...
core.Map<core.String, api.SuggestedTextStyle> buildUnnamed5979() {
  var o = <core.String, api.SuggestedTextStyle>{};
  o['x'] = buildSuggestedTextStyle();
  o['y'] = buildSuggestedTextStyle();
  return o;
...
void checkUnnamed5979(core.Map<core.String, api.SuggestedTextStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSuggestedTextStyle(o['x']! as api.SuggestedTextStyle);
  checkSuggestedTextStyle(o['y']! as api.SuggestedTextStyle);
}
...
api.TextRun buildTextRun() {
  ...
  if (buildCounterTextRun < 3) {
    o.content = 'foo';
    o.suggestedDeletionIds = buildUnnamed5977();
    o.suggestedInsertionIds = buildUnnamed5978();
    o.suggestedTextStyleChanges = buildUnnamed5979();
    o.textStyle = buildTextStyle();
  }
  buildCounterTextRun--;
  return o;
...
void checkTextRun(api.TextRun o) {
  ...
  if (buildCounterTextRun < 3) {
    ...
    checkUnnamed5977(o.suggestedDeletionIds!);
    checkUnnamed5978(o.suggestedInsertionIds!);
    checkUnnamed5979(o.suggestedTextStyleChanges!);
    checkTextStyle(o.textStyle! as api.TextStyle);
  }
  buildCounterTextRun--;
}
...
core.List<core.int> buildUnnamed5980() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5980(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.UpdateTableColumnPropertiesRequest
  ...
  if (buildCounterUpdateTableColumnPropertiesRequest < 3) {
    o.columnIndices = buildUnnamed5980();
    o.fields = 'foo';
...
void checkUpdateTableColumnPropertiesRequest(
  ...
  buildCounterUpdateTableColumnPropertiesRequest++;
  if (buildCounterUpdateTableColumnPropertiesRequest < 3) {
    checkUnnamed5980(o.columnIndices!);
    unittest.expect(
      o.fields!,
      unittest.equals('foo'),
    );
...
core.List<core.int> buildUnnamed5981() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed5981(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
