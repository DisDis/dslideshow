...
import 'package:config_app/features/gallery/presentation/pages/gallery_main_page.dart';
...
class GalleryPages {
  final String value;
  const GalleryPages._(this.value);
  static const main = GalleryPages._("/gallery");
}
