...
class WifiTabEvent with _$WifiTabEvent {
  ...
  const factory WifiTabEvent.rescan() = RescanWifiTabEvent;
  const factory WifiTabEvent.load() = LoadWifiTabEvent;
  // ignore: non_constant_identifier_names
  const factory WifiTabEvent.add(String name, String SSID, String psk) =
      AddWifiTabEvent;
  const factory WifiTabEvent.remove(String connectionId) = RemoveWifiTabEvent;
  const factory WifiTabEvent.enable(String connectionId, bool value) =
      EnableWifiTabEvent;
}
