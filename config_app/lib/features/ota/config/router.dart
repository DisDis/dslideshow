...
import 'package:config_app/features/ota/presentation/pages/ota_main_page.dart';
...
class OtaPages {
  final String value;
  const OtaPages._(this.value);
  static const main = OtaPages._("/ota");
}
