...
mixin _$EchoCommand {
  ...
  $EchoCommandCopyWith<EchoCommand> get copyWith =>
      _$EchoCommandCopyWithImpl<EchoCommand>(this as EchoCommand, _$identity);
...
abstract mixin class $EchoCommandCopyWith<$Res> {
  factory $EchoCommandCopyWith(
          EchoCommand value, $Res Function(EchoCommand) _then) =
      _$EchoCommandCopyWithImpl;
  @useResult
  $Res call({int id, String? text, String type});
}

/// @nodoc
class _$EchoCommandCopyWithImpl<$Res> implements $EchoCommandCopyWith<$Res> {
...
class _EchoCommand implements EchoCommand {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EchoCommandCopyWith<_EchoCommand> get copyWith =>
      __$EchoCommandCopyWithImpl<_EchoCommand>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EchoCommandToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$EchoCommandCopyWith<$Res>
    implements $EchoCommandCopyWith<$Res> {
  factory _$EchoCommandCopyWith(
          _EchoCommand value, $Res Function(_EchoCommand) _then) =
      __$EchoCommandCopyWithImpl;
  @override
  @useResult
  $Res call({int id, String? text, String type});
}
...
/// @nodoc
class __$EchoCommandCopyWithImpl<$Res> implements _$EchoCommandCopyWith<$Res> {
...
mixin _$EchoCommandResult {
  ...
  $EchoCommandResultCopyWith<EchoCommandResult> get copyWith =>
      _$EchoCommandResultCopyWithImpl<EchoCommandResult>(
          this as EchoCommandResult, _$identity);
...
abstract mixin class $EchoCommandResultCopyWith<$Res> {
  factory $EchoCommandResultCopyWith(
          EchoCommandResult value, $Res Function(EchoCommandResult) _then) =
      _$EchoCommandResultCopyWithImpl;
  @useResult
...
class _EchoCommandResult implements EchoCommandResult {
  ...
  factory _EchoCommandResult.fromJson(Map<String, dynamic> json) =>
      _$EchoCommandResultFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EchoCommandResultCopyWith<_EchoCommandResult> get copyWith =>
      __$EchoCommandResultCopyWithImpl<_EchoCommandResult>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EchoCommandResultToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$EchoCommandResultCopyWith<$Res>
    implements $EchoCommandResultCopyWith<$Res> {
  factory _$EchoCommandResultCopyWith(
          _EchoCommandResult value, $Res Function(_EchoCommandResult) _then) =
      __$EchoCommandResultCopyWithImpl;
  @override
  @useResult
  $Res call({int id, String? resultText});
}
