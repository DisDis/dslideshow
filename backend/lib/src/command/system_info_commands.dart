...
@freezed
sealed class GetSystemInfoCommand
    with _$GetSystemInfoCommand
  ...
  factory GetSystemInfoCommand.fromJson(Map<String, dynamic> json) =>
      _$GetSystemInfoCommandFromJson(json);
}

@freezed
sealed class GetSystemInfoCommandResult
    with _$GetSystemInfoCommandResult
  ...
  factory GetSystemInfoCommandResult.fromJson(Map<String, dynamic> json) =>
