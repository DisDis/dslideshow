...
void main() {
  group('WiFiService', () {
    test('parse scanOutput #1', () {
      final testData = """N-USE  BSSID              SSID               MODE   CHAN  RATE        SIGNAL  BARS  SECURITY  
...
""";
      ...
      expect(
          ...
          equals(<WiFiNetworkInfo>[
            WiFiNetworkInfo(BSSID: '4C:BB:4F:DC:2C:55', SSID: 'Jazzir', signal: 90, channel: 9, rate: 270, security: 'WPA2'),
            WiFiNetworkInfo(BSSID: '4C:BC:4F:DC:3C:55', SSID: 'Jazzir_5G', signal: 72, channel: 40, rate: 270, security: 'WPA2'),
            WiFiNetworkInfo(BSSID: 'F0:BB:74:62:48:A9', SSID: 'Jazzir', signal: 70, channel: 9, rate: 270, security: 'WPA2'),
            WiFiNetworkInfo(BSSID: '52:FF:20:8F:34:1D', SSID: 'GuestNetw WiFi', signal: 67, channel: 149, rate: 270, security: 'WPA2'),
          ]));
    });
    ...
    test('parse parseConnectionsOutput #1 - empty', () {
      ...
      final _config = new WiFiConfig.fromJson(<String, dynamic>{});
      final _wifiService = WiFiService(_config);
      expect(_wifiService.parseScanOutput(testData), equals(<WiFiConnectionInfo>[]));
    });

    test('parse parseConnectionsOutput #2', () {
      final testData = """NAME               UUID                                  TYPE      DEVICE          
...
Asus Restore       90287d45-9281-4710-8a34-286132876e80  ethernet  --""";
      ...
      expect(
          ...
          equals(<WiFiConnectionInfo>[
            WiFiConnectionInfo(name: 'Jazzir_5G', UUID: 'bde254af-21bc-4edd-864c-1e01012aac72', type: 'wifi', device: 'wlo1'),
            WiFiConnectionInfo(name: 'lo', UUID: '9c102455-4a20-4f23-bd88-aecee06469b6', type: 'loopback', device: 'lo'),
            WiFiConnectionInfo(name: 'docker0', UUID: '13594913-743b-4b39-9c3b-6ef9bfdcadec', type: 'bridge', device: 'docker0'),
            WiFiConnectionInfo(name: 'AC:0B:FB:73:C6:04', UUID: 'a8fe3917-c305-4147-b3c2-4304545c4a0b', type: 'wifi', device: '--'),
            WiFiConnectionInfo(name: 'Air', UUID: '7e32b73f-c4de-4696-9517-b37c8d1921b4', type: 'wifi', device: '--'),
            WiFiConnectionInfo(name: 'Asus Restore', UUID: '90287d45-9281-4710-8a34-286132876e80', type: 'ethernet', device: '--'),
          ]));
    });
  });
}
