...
class Key {
   ...
   */
  factory Key(Type type, [Object annotationInput]) {
    ...
    var annotation = _toType(annotationInput);
  ...
  static Type _toType(Object obj) {
...
/// shortcut function
Key key(Type type, [Object annotation]) => new Key(type, annotation);
