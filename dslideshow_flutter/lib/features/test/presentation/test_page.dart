...
class _ConfigPageState extends State<TestPage> {
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    ...
                    bloc.add(
                      SlideshowChangeStorageStatusEvent(
                        StorageStatusEnum.values.elementAt(
                          rnd.nextInt(StorageStatusEnum.values.length),
                        ),
                      ),
                    );
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    final SlideshowStatusBloc bloc = injector();
                    bloc.add(
                      SlideshowStatusEvent.changeInternetConnection(
                        rnd.nextBool(),
                      ),
                    );
                  },
            ...
            ElevatedButton(
              onPressed: () {
                context.read<RouteBloc>().add(
                  ChangePageEvent(RoutePage.slideshow),
                );
              },
