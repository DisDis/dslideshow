...
class AccordionEffect with TranslateEffect implements MediaSliderItemEffect {
  ...
  @override
  Widget transform(BuildContext context, Widget page, bool isCurrentPage /*int index, int currentPage*/, double pageDelta /*, int itemCount*/, double screenW,
      double screenH) {
...
class BackgroundToForegroundEffect with TranslateEffect implements MediaSliderItemEffect {
  ...
  Widget transform(BuildContext context, Widget page, bool isCurrentPage /*int index, int currentPage*/, double pageDelta /*, int itemCount*/, double screenW,
    ...
    if (!isCurrentPage /*index == currentPage + 1 || currentPage == itemCount - 1 && index == 0*/) {
      ...
      return Transform(transformHitTests: false, transform: translateCurrent(Matrix4.identity(), pageDelta, screenW, screenH), child: page);
    }
  }
}
...
class DefaultEffect with TranslateEffect implements MediaSliderItemEffect {
  ...
  Widget transform(BuildContext context, Widget page, bool isCurrentPage /*int index, int currentPage*/, double pageDelta /*, int itemCount*/, double screenW,
    ...
    return Transform(
        transformHitTests: false,
        transform:
            isCurrentPage ? translateCurrent(Matrix4.identity(), pageDelta, screenW, screenH) : translateNext(Matrix4.identity(), pageDelta, screenW, screenH),
        child: page);
  }
}
...
class FadeEffect implements MediaSliderItemEffect {
  @override
  Widget transform(BuildContext context, Widget page, bool isCurrentPage, double pageDelta, double screenW, double screenH) {
